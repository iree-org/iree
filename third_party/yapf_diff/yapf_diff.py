...
Example usage:
  ...
  git diff -U0 HEAD^ | yapf_format_diff.py
...
def main():
  ...
  parser.add_argument('-p',
                      ...
                      'set to 0 if passing `--no-prefix` to `git diff` or '
                      'using svn')
  ...
  parser.add_argument('-sort-includes',
                      action='store_true',
                      default=False,
                      help='let the formatter sort include blocks')
  ...
  parser.add_argument('-binary',
                      default='yapf',
                      help='location of binary to use for formatting')
