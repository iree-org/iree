...
// Fork of iree/compiler/Utils/OptionUtils: Please keep in sync until this
// can be better factored for sharing.

#ifndef OPENXLA_PARTITIONER_SUPPORT_OPTION_UTILS_H
#define OPENXLA_PARTITIONER_SUPPORT_OPTION_UTILS_H
...
namespace openxla::partitioner::support {
...
// namespace):
//   OPENXLA_PARTITIONER_DEFINE_COMPILER_OPTION_FLAGS(DerivedTy);
...
#define OPENXLA_PARTITIONER_DEFINE_COMPILER_OPTION_FLAGS(DerivedTy)   \
  template <>                                                         \
  DerivedTy &                                                         \
  openxla::partitioner::support::OptionsFromFlags<DerivedTy>::get() { \
    struct InitializedTy : DerivedTy {                                \
      InitializedTy() {                                               \
        openxla::partitioner::support::OptionsBinder binder =         \
            openxla::partitioner::support::OptionsBinder::global();   \
...
#endif  // OPENXLA_PARTITIONER_SUPPORT_OPTION_UTILS_H
