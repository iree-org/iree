...
#define MCA_io_romio321_COMPLETE_CONFIGURE_FLAGS " FROM_OMPI=yes CC='gcc' CFLAGS='-DNDEBUG -g -O2 -ffile-prefix-map=/build/openmpi=. -fstack-protector-strong -Wformat -Werror=format-security -O3 -finline-functions -fno-strict-aliasing -mcx16  -D__EXTENSIONS__' CPPFLAGS='-Wdate-time -D_FORTIFY_SOURCE=2    -I/usr/local/include -I/usr/local/include' FFLAGS='-g -O2 -ffile-prefix-map=/build/openmpi=. -fstack-protector-strong' LDFLAGS='-Wl,-z,relro   ' --enable-shared --disable-static  --prefix=/usr --disable-aio --disable-weak-symbols --enable-strict --disable-f77 --disable-f90"
