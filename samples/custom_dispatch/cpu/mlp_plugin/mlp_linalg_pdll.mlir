// RUN: iree-compile --iree-preprocessing-pdll-spec-filename=%p/mlp_all_specs.pdll %s --compile-to=preprocessing | FileCheck %s

// RUN: iree-compile --iree-preprocessing-pdll-spec-filename=%p/mlp_all_specs.pdll %s | \
