...
// function that also prints to stdout. This function is invoked
// as a microkernel function using the `iree_codegen.generic.ukernel` operation
// in `system_ukernel.mlir`. The function `ukernel_example` there is
// compiled to `llvm-cpu` which in turn calls the `simple_mul_workgroup`
// function defined here. This is borrowed from `system_plugin.c`. See there for
// more details about the plugin mechanism itself.
...
iree_hal_executable_plugin_query(
  ...
  static const iree_hal_executable_plugin_header_t header = {
      ...
      .description =
          ...
          "(custom_dispatch/cpu/plugin/system_ukernel.c)",
      .features = 0,
