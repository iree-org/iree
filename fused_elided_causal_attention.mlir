module @module {
  ...
  func.func @prefill_bs4(%arg0: !torch.vtensor<[4,64,32,128],f16>, %arg1: !torch.vtensor<[4,64,32,128],f16>, %arg2: !torch.vtensor<[4,64,32,128],f16>, %arg3: !torch.vtensor<[4],si64>, %arg4: !torch.vtensor<[4,4],si64>, %arg5: !torch.tensor<[256,4194304],f16>) -> !torch.vtensor<[4,64,4096],f16> attributes {torch.assume_strict_symbolic_shapes} {
    ...
    %41:2 = torch.operator "torch.aten._scaled_dot_product_flash_attention_for_cpu"(%38, %39, %40, %float0.000000e00, %false_56, %none, %none_57) : (!torch.vtensor<[4,32,64,128],f16>, !torch.vtensor<[4,32,64,128],f16>, !torch.vtensor<[4,32,64,128],f16>, !torch.float, !torch.bool, !torch.none, !torch.none) -> (!torch.vtensor<[4,32,64,128],f16>, !torch.vtensor<[4,32,64],f32>) 
    %int1_58 = torch.constant.int 1
    %int2_59 = torch.constant.int 2
    %42 = torch.aten.transpose.int %41#0, %int1_58, %int2_59 : !torch.vtensor<[4,32,64,128],f16>, !torch.int, !torch.int -> !torch.vtensor<[4,64,32,128],f16>
    %int4_60 = torch.constant.int 4
    %int64_61 = torch.constant.int 64
    %int-1_62 = torch.constant.int -1
    %43 = torch.prim.ListConstruct %int4_60, %int64_61, %int-1_62 : (!torch.int, !torch.int, !torch.int) -> !torch.list<int>
...
//     %174:2 = torch.operator "torch.aten._scaled_dot_product_flash_attention_for_cpu"(%167, %170, %173, %float0.000000e00, %false_274, %none_275, %none_276) : (!torch.vtensor<[4,32,1,128],f16>, !torch.vtensor<[4,32,64,128],f16>, !torch.vtensor<[4,32,64,128],f16>, !torch.float, !torch.bool, !torch.none, !torch.none) -> (!torch.vtensor<[4,32,1,128],f16>, !torch.vtensor<[4,32,1],f32>) 
//     %int1_277 = torch.constant.int 1
//     %int2_278 = torch.constant.int 2
//     %175 = torch.aten.transpose.int %174#0, %int1_277, %int2_278 : !torch.vtensor<[4,32,1,128],f16>, !torch.int, !torch.int -> !torch.vtensor<[4,1,32,128],f16>
//     %int4_279 = torch.constant.int 4
//     %int1_280 = torch.constant.int 1
//     %int-1_281 = torch.constant.int -1
//     %176 = torch.prim.ListConstruct %int4_279, %int1_280, %int-1_281 : (!torch.int, !torch.int, !torch.int) -> !torch.list<int>
