...
NAME_FORMAT = r"{}_BATCH${{BATCH_SIZE}}"
SOURCE_URL_FORMAT = f"{GCS_ARTIFACT_ROOT_DIR}" r"/{}/batch_${{BATCH_SIZE}}/stablehlo.mlirbc"
...
RESNET50_FP32_JAX_3X224X224XF32_BATCHES = model_utils.generate_batch_models(
    id_template=ID_FORMAT.format(
        unique_ids.MODEL_RESNET50_FP32_JAX_3X224X224XF32),
    name_template=NAME_FORMAT.format("RESNET50_FP32_JAX_3X224X224XF32"),
    tags=RESNET50_TAGS,
...
BERT_LARGE_FP32_JAX_384XI32_BATCHES = model_utils.generate_batch_models(
    id_template=ID_FORMAT.format(unique_ids.MODEL_BERT_LARGE_FP32_JAX_384XI32),
    name_template=NAME_FORMAT.format("BERT_LARGE_JAX_384XI32"),
...
T5_LARGE_FP32_JAX_512XI32_BATCHES = model_utils.generate_batch_models(
    id_template=ID_FORMAT.format(unique_ids.MODEL_T5_LARGE_FP32_JAX_512XI32),
    name_template=NAME_FORMAT.format("T5_LARGE_FP32_JAX_512XI32"),
    tags=T5_TAGS,
    source_type=common_definitions.ModelSourceType.EXPORTED_STABLEHLO_MLIR,
