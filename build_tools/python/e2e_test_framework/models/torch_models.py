...
BERT_LARGE_FP32_URL = r"https://storage.googleapis.com/iree-model-artifacts/pytorch/torch_models_20230401.795_1680469670/BERT_LARGE/batch_${BATCH_SIZE}/linalg.mlir"
BERT_LARGE_FP16_URL = r"https://storage.googleapis.com/iree-model-artifacts/pytorch/torch_models_20230522.846_1684830698/BERT_LARGE_FP16/batch_${BATCH_SIZE}/linalg.mlir"
RESNET50_FP32_URL = r"https://storage.googleapis.com/iree-model-artifacts/pytorch/torch_models_20230401.795_1680469670/RESNET50/batch_${BATCH_SIZE}/linalg.mlir"
RESNET50_FP16_URL = r"https://storage.googleapis.com/iree-model-artifacts/pytorch/torch_models_20230522.846_1684830698/RESNET50_FP16/batch_${BATCH_SIZE}/linalg.mlir"
...
BERT_LARGE_384_FP32_TORCH_BATCHES = model_utils.generate_batch_models(
    id_template=ID_FORMAT.format(unique_ids.MODEL_BERT_LARGE_384_FP32_TORCH),
    name_template=NAME_FORMAT.format("BertLargePT"),
    tags=["fp32", "transformer", "seqlen384"],
    source_type=common_definitions.ModelSourceType.EXPORTED_LINALG_MLIR,
    source_url_template=BERT_LARGE_FP32_URL,
    entry_function="forward",
    input_type_templates=[r"${BATCH_SIZE}x384xi64", r"${BATCH_SIZE}x384xi64"],
    batch_sizes=[1, 16, 24, 32, 48, 64, 512, 1024, 1280])

# FP16 Versions
BERT_LARGE_384_FP16_TORCH_BATCHES = model_utils.generate_batch_models(
    id_template=ID_FORMAT.format(unique_ids.MODEL_BERT_LARGE_384_FP16_TORCH),
    name_template=NAME_FORMAT.format("BertLargefp16PT"),
...
RESNET50_3X224X224_FP32_TORCH_BATCHES = model_utils.generate_batch_models(
    id_template=ID_FORMAT.format(
        unique_ids.MODEL_RESNET50_3X224X224_FP32_TORCH),
    name_template=NAME_FORMAT.format("Resnet50PT"),
    tags=["fp32", "cnn"],
    source_type=common_definitions.ModelSourceType.EXPORTED_LINALG_MLIR,
    source_url_template=RESNET50_FP32_URL,
    entry_function="forward",
    input_type_templates=[r"${BATCH_SIZE}x3x224x224xf32"],
    batch_sizes=[1, 8, 64, 128, 256, 2048])

# FP16 Versions
RESNET50_3X224X224_FP16_TORCH_BATCHES = model_utils.generate_batch_models(
    id_template=ID_FORMAT.format(
        unique_ids.MODEL_RESNET50_3X224X224_FP16_TORCH),
    name_template=NAME_FORMAT.format("Resnet50fp16PT"),
    tags=["fp32", "cnn"],
    source_type=common_definitions.ModelSourceType.EXPORTED_LINALG_MLIR,
    source_url_template=RESNET50_FP16_URL,
    entry_function="forward",
    input_type_templates=[r"${BATCH_SIZE}x3x224x224xf16"],
    batch_sizes=[1, 8, 64, 128, 256, 2048])
