...
"""Defines VMFBExecutionConfig for benchmarks."""

from e2e_test_framework.definitions import iree_definitions
from e2e_test_framework import unique_ids
import benchmarks.iree.utils

ELF_LOCAL_SYNC_CONFIG = iree_definitions.VMFBExecutionConfig(
    ...
    tool=benchmarks.iree.utils.MODULE_BENCHMARK_TOOL)

ELF_CUDA_CONFIG = iree_definitions.VMFBExecutionConfig(
...
VULKAN_CONFIG = iree_definitions.VMFBExecutionConfig(
...
VULKAN_BATCH_SIZE_16_CONFIG = iree_definitions.VMFBExecutionConfig(
...
VULKAN_BATCH_SIZE_32_CONFIG = iree_definitions.VMFBExecutionConfig(
...
def get_elf_local_task_config(thread_num: int):
  return iree_definitions.VMFBExecutionConfig(
