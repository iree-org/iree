...
from definitions.common_definitions import ArchitectureInfo, ModelSourceType
from definitions.iree_definitions import IreeCompileConfig, IreeCompileTarget
from definitions import iree_benchmarks
...
def main():
  ...
  for model in models:
    ...
    model_url = urlparse(model.source_url)
