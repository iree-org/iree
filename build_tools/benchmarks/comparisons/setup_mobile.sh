...
# Prerequisites:
#   Manual installations of the Android NDK and ADB are needed. See https://www.iree.dev/building-from-source/android/#install-android-ndk-and-adb for instructions.
