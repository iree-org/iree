...
GITHUB_RUNNER_VERSION="${GITHUB_RUNNER_VERSION:-2.314.1}"
GITHUB_RUNNER_X64_ARCHIVE_DIGEST="${GITHUB_RUNNER_X64_ARCHIVE_DIGEST:-6c726a118bbe02cd32e222f890e1e476567bf299353a96886ba75b423c1137b5}"
GITHUB_RUNNER_ARM64_ARCHIVE_DIGEST="${GITHUB_RUNNER_ARM64_ARCHIVE_DIGEST:-3d27b1340086115a118e28628a11ae727ecc6b857430c4b1b6cbe64f1f3b6789}"
