...
if [[ "${OSTYPE}" == "linux-gnu" ]]; then
  RISCV_CLANG_TOOLCHAIN_FILE_NAME="toolchain_iree_20231009.tar.gz"
  RISCV_CLANG_TOOLCHAIN_FILE_SHA="c747b018f4b9dc99536f66581be3b2836cb90c1a56b072a2e1d9190efc90188a"
