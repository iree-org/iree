...
# have no use for.
IREE_EXPERIMENTAL_COMPILER_DYNAMIC_PLUGINS="${IREE_EXPERIMENTAL_COMPILER_DYNAMIC_PLUGINS:-OFF}"
...
declare -a CMAKE_ARGS=(
  ...
  "-DIREE_EXPERIMENTAL_COMPILER_DYNAMIC_PLUGINS=${IREE_EXPERIMENTAL_COMPILER_DYNAMIC_PLUGINS}"
)
