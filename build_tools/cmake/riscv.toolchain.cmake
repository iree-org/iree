...
set(RISCV_TOOLCHAIN_PREFIX "" CACHE STRING "RISC-V compiler prefix")
...
set(CMAKE_AR "${RISCV_TOOLCHAIN_ROOT}/bin/${RISCV_TOOLCHAIN_PREFIX}ar")
set(CMAKE_RANLIB "${RISCV_TOOLCHAIN_ROOT}/bin/${RISCV_TOOLCHAIN_PREFIX}ranlib")
set(CMAKE_STRIP "${RISCV_TOOLCHAIN_ROOT}/bin/${RISCV_TOOLCHAIN_PREFIX}strip")
...
elseif(RISCV_CPU STREQUAL "generic-riscv_64")
  ...
  set(CMAKE_SYSTEM_LIBRARY_PATH "${RISCV_TOOLCHAIN_ROOT}/riscv64-unknown-elf/lib/")
