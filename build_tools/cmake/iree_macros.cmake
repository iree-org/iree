...
function(iree_select_compiler_opts OPTS)
  cmake_parse_arguments(
    ...
    ""
    ""
    "CLANG;CLANG_CL;MSVC;GCC;CLANG_OR_GCC;MSVC_OR_CLANG_CL"
  )
  if("${CMAKE_CXX_COMPILER_ID}" STREQUAL "GNU")
    list(APPEND ${OPTS} ${_IREE_SELECTS_GCC})
    list(APPEND ${OPTS} ${_IREE_SELECTS_CLANG_OR_GCC})
  elseif("${CMAKE_CXX_COMPILER_ID}" MATCHES "Clang")
    if(MSVC)
      list(APPEND ${OPTS} ${_IREE_SELECTS_CLANG_CL})
      list(APPEND ${OPTS} ${_IREE_SELECTS_MSVC_OR_CLANG_CL})
    else()
      list(APPEND ${OPTS} ${_IREE_SELECTS_CLANG})
      list(APPEND ${OPTS} ${_IREE_SELECTS_CLANG_OR_GCC})
    endif()
  elseif("${CMAKE_CXX_COMPILER_ID}" STREQUAL "MSVC")
    list(APPEND ${OPTS} ${_IREE_SELECTS_MSVC})
    list(APPEND ${OPTS} ${_IREE_SELECTS_MSVC_OR_CLANG_CL})
  else()
