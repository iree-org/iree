...
BUILD_LEGACY_BENCHMARKS="${BUILD_LEGACY_BENCHMARKS:-ON}"
BUILD_EXPERIMENTAL_PYTHON_GENERATED_BENCHMARKS="${BUILD_EXPERIMENTAL_PYTHON_GENERATED_BENCHMARKS:-OFF}"
...
"${CMAKE_BIN}" -B "${BUILD_BENCHMARKS_DIR}" \
  ...
  -DIREE_BUILD_BENCHMARKS="${BUILD_LEGACY_BENCHMARKS}" \
  -DIREE_BUILD_EXPERIMENTAL_PYTHON_GENERATED_BENCHMARKS="${BUILD_EXPERIMENTAL_PYTHON_GENERATED_BENCHMARKS}" \
