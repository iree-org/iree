...
function(iree_import_binary)
  ...
  file(REAL_PATH "${_BINARY_PATH}" _BINARY_PATH EXPAND_TILDE)

  if(NOT EXISTS ${_BINARY_PATH})
    message(FATAL_ERROR "Could not find '${_FULL_BINARY_NAME}' under '${IREE_HOST_BINARY_ROOT}/bin'. "
