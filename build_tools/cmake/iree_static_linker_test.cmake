...
# Helper to process module input configs to be used in the c template.
# Example:
#   FUNCTION_INPUTS "1x28x28x1xf32"
#     INPUT_NUM  1
#     INPUT_DIM_ARR {4}
#     INPUT_SIZE_ARR {768}
#     INPUT_SHAPE_ARR of {{1, 28, 28, 1},}
#   FUNCTION_INPUTS "4xf32,f32"
#     INPUT_NUM  2
#     INPUT_DIM_ARR {1, 1}
#     INPUT_SIZE_ARR {4, 1}
#     INPUT_SHAPE_ARR of {{4}, {1},}
function(parse_function_inputs
  INPUT_NUM INPUT_DIM_MAX INPUT_DIM_ARR
  INPUT_SIZE_ARR INPUT_SHAPE_ARR INPUT_TYPE HAL_TYPE
  FUNCTION_INPUTS)
  string(REPLACE "," ";"  _INPUTS_LIST "${FUNCTION_INPUTS}")
  ...
  if("${_INPUT_FORMAT}" STREQUAL "f32")
    set(_INPUT_TYPE "float")
    set(_HAL_TYPE "IREE_HAL_ELEMENT_TYPE_FLOAT_32")
  elseif("${_INPUT_FORMAT}" STREQUAL "i32")
    set(_INPUT_TYPE "int32_t")
    set(_HAL_TYPE "IREE_HAL_ELEMENT_TYPE_SINT_32")
  elseif("${_INPUT_FORMAT}" STREQUAL "i16")
    set(_INPUT_TYPE "int16_t")
    set(_HAL_TYPE "IREE_HAL_ELEMENT_TYPE_SINT_16")
  elseif("${_INPUT_FORMAT}" STREQUAL "i8")
    set(_INPUT_TYPE "int8_t")
    set(_HAL_TYPE "IREE_HAL_ELEMENT_TYPE_SINT_8")
  elseif("${_INPUT_FORMAT}" STREQUAL "ui8")
    set(_INPUT_TYPE "uint8_t")
    set(_HAL_TYPE "IREE_HAL_ELEMENT_TYPE_UINT_8")
  else()
    message(SEND_ERROR "Unsupported format ${_INPUT_FORMAT}")
  endif()

  set(${INPUT_NUM} "${_INPUT_NUM}" PARENT_SCOPE)
  set(${INPUT_DIM_MAX} "${_INPUT_DIM_MAX}" PARENT_SCOPE)
  set(${INPUT_DIM_ARR} "\{${_INPUT_DIM_STR}\}" PARENT_SCOPE)
  set(${INPUT_SIZE_ARR} "\{${_INPUT_SIZE_STR}\}" PARENT_SCOPE)
  set(${INPUT_SHAPE_ARR} "\{${_INPUT_SHAPE_STR}\}" PARENT_SCOPE)
  set(${INPUT_TYPE} ${_INPUT_TYPE} PARENT_SCOPE)
  set(${HAL_TYPE} ${_HAL_TYPE} PARENT_SCOPE)
endfunction()
...
function(iree_static_linker_test)
  ...
  cmake_parse_arguments(
    _RULE
    "EMITC"
    "NAME;SRC;STATIC_LIB_PREFIX;ENTRY_FUNCTION"
  ...
  parse_function_inputs(
    IREE_INPUT_NUM IREE_INPUT_DIM_MAX IREE_INPUT_DIM_ARR
    IREE_INPUT_SIZE_ARR IREE_INPUT_SHAPE_ARR IREE_INPUT_TYPE IREE_HAL_TYPE
    ${_RULE_FUNCTION_INPUTS}
  )
...
# iree_vmvx_linker_test
# Creates a test test for the statically linked libraries generated by the
# vmvx compiler target backend and executed using the local-sync runtime
# HAL driver.
#
# Parameters:
#   NAME: Name of the target
...
#       "--iree-input-type=mhlo"
#   )
function(iree_vmvx_linker_test)
  if(NOT IREE_BUILD_TESTS)
    return()
  endif()
  ...
  if(NOT IREE_HAL_EXECUTABLE_LOADER_VMVX_MODULE OR NOT IREE_HAL_DRIVER_LOCAL_SYNC)
    return()
  endif()
  ...
  cmake_parse_arguments(
    _RULE
    "EMITC"
    "NAME;SRC;ENTRY_FUNCTION"
    "COMPILER_FLAGS;LABELS;FUNCTION_INPUTS"
    ${ARGN}
  )
