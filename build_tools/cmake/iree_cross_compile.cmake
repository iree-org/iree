...
function(iree_create_configuration CONFIG_NAME)
  ...
  iree_to_bool(_CONFIG_BUILD_EXPERIMENTAL_JAVA_BINDINGS "${IREE_${CONFIG_NAME}_BUILD_EXPERIMENTAL_JAVA_BINDINGS}")
  ...
  add_custom_command(OUTPUT ${IREE_${CONFIG_NAME}_BINARY_ROOT}/CMakeCache.txt
    COMMAND "${CMAKE_COMMAND}" "${CMAKE_CURRENT_SOURCE_DIR}"
        ...
        -DIREE_BUILD_EXPERIMENTAL_JAVA_BINDINGS=${_CONFIG_BUILD_EXPERIMENTAL_JAVA_BINDINGS}
