...
function(iree_cc_library)
  ...
  if(NOT IREE_CC_LIB_TESTONLY OR IREE_RUN_TESTS)
    ...
    if(NOT IREE_CC_LIB_IS_INTERFACE)
      ...
      target_sources(${_NAME} PRIVATE ${IREE_CC_LIB_SRCS} ${IREE_CC_LIB_HDRS})
      ...
      target_compile_definitions(${_NAME} PUBLIC ${IREE_CC_LIB_DEFINES})
      ...
      # When being installed, we lose the iree_ prefix.  We want to put it back
      # to have properly named lib files.  This is a no-op when we are not being
      # installed.
      set_target_properties(${_NAME} PROPERTIES
        OUTPUT_NAME "iree_${_NAME}"
      )
    else()
    ...
    add_library(iree::${IREE_CC_LIB_NAME} ALIAS ${_NAME})
  endif()
endfunction()
