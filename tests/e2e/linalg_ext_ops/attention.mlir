func.func @attention1x3x4() {
  ...
  check.expect_almost_eq_const(
      ...
      dense<[[[0.5530, 0.6530, 0.7530, 0.8530],
              ...
              [0.7011, 0.8011, 0.9011, 1.0011]]]> : tensor<1x3x4xf32>, 1.0e-4
  ) : tensor<1x3x4xf32>
  return
}
...
func.func @attention1x4x4_i1_mask_all_ones() {
  ...
  check.expect_almost_eq_const(
      ...
      dense<[[[0.798884, 0.898884, 0.998884, 1.09888],
              ...
              [1.13295, 1.23295, 1.33295, 1.43295]]]> : tensor<1x4x4xf32>, 1.0e-4
  ) : tensor<1x4x4xf32>
  return
}
...
func.func @softcap_attention1x3x4() {
  ...
  check.expect_almost_eq_const(
      ...
      dense<[[[0.331149, 0.576043, 0.380060, 0.6879],
              ...
              [0.442426, 0.125056, 0.329748, 0.735554]]]> : tensor<1x3x4xf32>, 1.0e-4
  ) : tensor<1x3x4xf32>
  return
}
...
func.func @attention1x4x4() {
  ...
  check.expect_almost_eq_const(
      ...
      dense<[[[0.7989, 0.8989, 0.9989, 1.0989],
              ...
              [1.1329, 1.2329, 1.3329, 1.4329]]]> : tensor<1x4x4xf32>, 1.0e-4
  ) : tensor<1x4x4xf32>
  return
}
  ...
  check.expect_almost_eq_const(
      ...
      dense<[[[-1.2804, -0.7607, -0.7648, -1.3364],
             ...
             [[ 0.1917, -0.4658,  0.0510,  0.2561],
              ...
              [ 0.9522, -0.7023, -0.0358, -0.3303]]]> : tensor<3x3x4xf32>, 1.0e-4
  ) : tensor<3x3x4xf32>
  return
}
