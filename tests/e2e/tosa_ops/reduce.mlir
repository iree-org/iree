func.func @reduce_max_float() {
  ...
  check.expect_almost_eq_const(%result, dense<[[3.0, 4.0]]> : tensor<1x2xf32>, 1.0e-4) : tensor<1x2xf32>
  return
}
...
func.func @reduce_min_float() {
  ...
  check.expect_almost_eq_const(%result, dense<[[1.0, 0.0]]> : tensor<1x2xf32>, 1.0e-4) : tensor<1x2xf32>
  return
}
...
func.func @reduce_prod_float() {
  ...
  check.expect_almost_eq_const(%result, dense<[[4.0, 10.0, 18.0]]> : tensor<1x3xf32>, 1.0e-4) : tensor<1x3xf32>
  return
}
...
func.func @reduce_sum_float() {
  ...
  check.expect_almost_eq_const(%result, dense<[[5.0, 7.0, 9.0]]> : tensor<1x3xf32>, 1.0e-4) : tensor<1x3xf32>
  return
}
...
func.func @reduce_sum_float_axis_1() {
  ...
  check.expect_almost_eq_const(%result, dense<[[6.0], [15.0]]> : tensor<2x1xf32>, 1.0e-4) : tensor<2x1xf32>
  return
}
