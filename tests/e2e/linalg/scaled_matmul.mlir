func.func @scaled_matmul_1x1() {
  ...
  %A = arith.scaling_truncf %lhs, A_scales : tensor<1x1x32xf32> to tensor<1x1x32xf4E2M1FN>
  %B = arith.scaling_truncf %rhs, B_scales : tensor<1x1x32xf32> to tensor<1x1x32xf4E2M1FN>
...
func.func @scaled_matmul_1024x1024() {
  ...
  %A = arith.scaling_truncf %lhs, A_scales : tensor<1024x32x32xf32> to tensor<1024x32x32xf4E2M1FN>
  %B = arith.scaling_truncf %rhs, B_scales : tensor<1024x32x32xf32> to tensor<1024x32x32xf4E2M1FN>
  %cst = arith.constant 0.000000e+00 : f32
...
func.func @scaled_matmul_128x128() {
  ...
  %A = arith.scaling_truncf %lhs, A_scales : tensor<128x4x32xf32> to tensor<128x4x32xf4E2M1FN>
  %B = arith.scaling_truncf %rhs, B_scales : tensor<128x4x32xf32> to tensor<128x4x32xf4E2M1FN>
  %cst = arith.constant 0.000000e+00 : f32
...
func.func @scaled_matmul_128x256() {
  ...
  %A = arith.scaling_truncf %lhs, A_scales : tensor<128x4x32xf32> to tensor<128x4x32xf4E2M1FN>
  %B = arith.scaling_truncf %rhs, B_scales : tensor<256x4x32xf32> to tensor<256x4x32xf4E2M1FN>
  %cst = arith.constant 0.000000e+00 : f32
  ...
  check.expect_almost_eq_const(%D, dense<128.0> : tensor<128x256xf32>) : tensor<128x256xf32>
  return
}
