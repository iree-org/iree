...
def generate_function(
    ...
    func_definition = func_definition + (
        ...
        f"  %result1 = {op_name} {{\n"
        f"      indexing_maps = [affine_map<(batch, m, k1, k2, n) -> (batch, m, k1)>,\n"
        f"                       affine_map<(batch, m, k1, k2, n) -> (batch, k2, k1)>,\n"
        f"                       affine_map<(batch, m, k1, k2, n) -> (batch, k2, n)>,\n"
        f"                       affine_map<(batch, m, k1, k2, n) -> (batch, m, n)>]\n}}"
