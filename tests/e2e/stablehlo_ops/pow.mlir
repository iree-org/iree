func.func @tensor() {
  ...
  check.expect_almost_eq_const(%result, dense<[1.0, 8.0, 27.0, 64.0]> : tensor<4xf32>, 1.0e-4) : tensor<4xf32>
  return
}
...
func.func @scalar() {
  ...
  check.expect_almost_eq_const(%result, dense<256.0> : tensor<f32>, 1.0e-4) : tensor<f32>
  return
}
