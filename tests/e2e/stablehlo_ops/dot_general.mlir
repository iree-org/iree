func.func @dot_general_lower() {
  ...
  check.expect_almost_eq_const(%res, dense<[[[0.23, 0.31, 0.39]]]> : tensor<1x1x3xf32>, 1.0e-4) : tensor<1x1x3xf32>
  return
}
...
func.func @dot_general_lower_swapped() {
  ...
  check.expect_almost_eq_const(%res, dense<[[[0.23]],[[0.31]],[[0.39]]]> : tensor<3x1x1xf32>, 1.0e-4) : tensor<3x1x1xf32>
  return
}
...
func.func @dot_general_trivial_batching_dimension() {
  ...
  check.expect_almost_eq_const(%res, dense<[[[0.6, 1.2, 1.8, 2.4],[1.5, 3.0, 4.5, 6.0]]]> : tensor<1x2x4xf32>, 1.0e-4) : tensor<1x2x4xf32>
  return
}
...
func.func @dot_general_nontrivial_batching_dimension() {
  ...
  check.expect_almost_eq_const(%res, dense<[
      [
          ...
          [6.0, 12.0, 18.0, 24.0],
          [15.0, 30.0, 45.0, 60.0]]]> : tensor<2x2x4xf32>, 1.0e-4) : tensor<2x2x4xf32>
  return
}
...
func.func @large_dot_general() {
  ...
  check.expect_almost_eq_const(%res, dense<51.2> : tensor<4x8x16xf32>, 1.0e-4) : tensor<4x8x16xf32>
  return
}
...
func.func @dot_general_nontrivial_batching_multiple_parallel_dimension() {
  ...
  ]> : tensor<2x2x3x2xf32>, 1.0e-4) : tensor<2x2x3x2xf32>
  return
}
