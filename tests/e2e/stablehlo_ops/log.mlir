func.func @tensor() {
  ...
  check.expect_almost_eq_const(%result, dense<[0.0, 0.693147, 1.09861, 1.38629]> : tensor<4xf32>, 1.0e-4) : tensor<4xf32>
  return
}
...
func.func @scalar() {
  ...
  check.expect_almost_eq_const(%result, dense<1.3863> : tensor<f32>, 1.0e-4) : tensor<f32>
  return
}
...
func.func @double() {
  ...
  check.expect_almost_eq_const(%result, dense<1.3863> : tensor<f64>, 1.0e-4) : tensor<f64>
  return
}
