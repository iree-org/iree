func.func @tensor() {
  ...
  check.expect_almost_eq_const(%result, dense<[0.0, 0.8415, 0.9975, 0.9093]> : tensor<4xf32>, 1.0e-4) : tensor<4xf32>
  return
}
...
func.func @scalar() {
  ...
  check.expect_almost_eq_const(%result, dense<0.14112> : tensor<f32>, 1.0e-4) : tensor<f32>
  return
}
