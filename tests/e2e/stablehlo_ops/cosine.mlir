func.func @tensor() {
  ...
  check.expect_almost_eq_const(%result, dense<[1.0, 0.5403, 0.0707, -0.4161]> : tensor<4xf32>, 1.0e-4) : tensor<4xf32>
  return
}
...
func.func @scalar() {
  ...
  check.expect_almost_eq_const(%result, dense<-0.99> : tensor<f32>, 1.0e-4) : tensor<f32>
  return
}
