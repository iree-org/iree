func.func @tensor() {
  ...
  check.expect_almost_eq_const(%result, dense<[1.0, 0.707107, 0.57735, 0.5]> : tensor<4xf32>, 1.0e-4) : tensor<4xf32>
  return
}
...
func.func @scalar() {
  ...
  check.expect_almost_eq_const(%result, dense<0.25> : tensor<f32>, 1.0e-4) : tensor<f32>
  return
}
