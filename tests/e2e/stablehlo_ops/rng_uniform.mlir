...
func.func @rng_uniform_1d() {
    ...
    check.expect_almost_eq_const(%res, dense<[
        ...
        ]> : tensor<10xf32>, 1.0e-4) : tensor<10xf32>
    return
}
...
func.func @rng_uniform_2d() {
    ...
    check.expect_almost_eq_const(%res, dense<[
        ...
        [-3.03671, 2.10193, 7.24057]]> : tensor<3x3xf32>, 1.0e-4) : tensor<3x3xf32>
    return
}
...
func.func @rng_uniform_3d() {
    ...
    check.expect_almost_eq_const(%res, dense<[
        ...
        [[-6.91349, -1.77484], [8.29239, -6.56897]]]> : tensor<2x2x2xf32>, 1.0e-4) : tensor<2x2x2xf32>
    return
}
