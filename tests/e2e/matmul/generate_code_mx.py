...
def generate_call_mx(
    ...
    op += (
        ...
        f"    %va = vector.broadcast %a : f4E2M1FN to vector<2xf4E2M1FN>\n"
        f"    %vs = vector.broadcast %s : f8E8M0FNU to vector<2xf8E8M0FNU>\n"
        f"    %vr = arith.scaling_extf %va, %vs : vector<2xf4E2M1FN>, vector<2xf8E8M0FNU> to vector<2xf32>\n"
        f"    %r = vector.extract %vr[0] : f32 from vector<2xf32>\n"
