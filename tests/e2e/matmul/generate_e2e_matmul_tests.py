...
def get_rocm_test_compilation_infos(
    ...
    if intrinsic == "MFMA":
        schedules = [
            ...
            MMASchedule("MFMA_F32_16x16x32_F16", 1, 1, 1, 1, 1),
            MMASchedule("MFMA_F32_16x16x32_F16", 4, 2, 1, 2, 4),
            MMASchedule("MFMA_F32_32x32x16_F16", 1, 1, 1, 1, 1),
            MMASchedule("MFMA_F32_32x32x16_F16", 4, 2, 1, 2, 4),
        ]
    elif intrinsic == "WMMA":
        schedules = [
    ...
    for schedule in schedules:
        ...
        if schedule.intrinsic == "MFMA_F32_16x16x4_F32":
            ...
            schedule.intrinsic == "MFMA_F32_16x16x32_F16"
            ...
            schedule.intrinsic == "MFMA_F32_32x32x16_F16"
