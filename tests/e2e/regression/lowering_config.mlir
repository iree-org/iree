...
#compilation1 = #iree_codegen.compilation_info<
    ...
    translation_info = <CPUDoubleTilingPadExpert>,
    workgroup_size = []>
// TODO(#13330): Enable the test afte fixing the bug.
...
#conv_compilation0 = #iree_codegen.compilation_info<
    lowering_config = <tile_sizes = [[1, 7, 7, 64, 0, 0, 0], [6, 1, 7, 32, 0, 0, 0], [0, 0, 0, 0, 1, 3, 4]]>,
    translation_info = <CPUConvTileAndDecomposeExpert>,
    workgroup_size = []>
// Remove W
#conv_compilation1 = #iree_codegen.compilation_info<
    lowering_config = <tile_sizes = [[1, 7, 7, 64, 0, 0, 0], [6, 7, 1, 32, 0, 0, 0], [0, 0, 0, 0, 3, 1, 4]]>,
    translation_info = <CPUConvTileAndDecomposeExpert>,
    workgroup_size = []>
func.func @conv() {
