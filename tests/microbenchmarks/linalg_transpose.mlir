...
func.func @transpose_10() -> tensor<1024x512xf32> {
  ...
  %output = tensor.empty(1024, 512) : tensor<1024x512xf32>
  %6 = linalg.generic {
...
func.func @transpose_021() -> tensor<64x128x96xf32> {
  ...
  %output = tensor.empty(64, 128, 96) : tensor<64x128x96xf32>
  %6 = linalg.generic {
...
func.func @transpose_201() -> tensor<128x64x96xf32> {
  ...
  %input = util.global.load.indirect %input_ptr : !util.ptr<tensor<64x96x128xf32>> -> tensor<64x96x128xf32>
  %output = tensor.empty(128, 64, 96) : tensor<128x64x96xf32>
  %6 = linalg.generic {
...
func.func @transpose_210() -> tensor<128x96x64xf32> {
  ...
  %input = util.global.load.indirect %input_ptr : !util.ptr<tensor<64x96x128xf32>> -> tensor<64x96x128xf32>
  %output = tensor.empty(128, 96, 64) : tensor<128x96x64xf32>
  %6 = linalg.generic {
...
func.func @transpose_120() -> tensor<96x128x64xf32> {
  ...
  %input = util.global.load.indirect %input_ptr : !util.ptr<tensor<64x96x128xf32>> -> tensor<64x96x128xf32>
  %output = tensor.empty(96, 128, 64) : tensor<96x128x64xf32>
  %6 = linalg.generic {
...
func.func @transpose_102() -> tensor<96x64x128xf32> {
  ...
  %input = util.global.load.indirect %input_ptr : !util.ptr<tensor<64x96x128xf32>> -> tensor<64x96x128xf32>
  %output = tensor.empty(96, 64, 128) : tensor<96x64x128xf32>
  %6 = linalg.generic {
