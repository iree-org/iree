...
^bb1(%variant_op: !pdl.operation):
  ...
  %fill0, %fill1 = transform.split_handle %fill : (!pdl.operation) -> (!pdl.operation, !pdl.operation)
  %matmul0, %matmul1 = transform.split_handle %matmul : (!pdl.operation) -> (!pdl.operation, !pdl.operation)
  ...
  transform.structured.fuse_into_containing_op %fill1 into %forall_grid
