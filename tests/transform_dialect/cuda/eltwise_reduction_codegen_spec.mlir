...
^bb1(%variant_op: !pdl.operation):
  ...
  transform.structured.fuse_into_containing_op %not_combiner into %forall_grid_2 : (!pdl.operation, !pdl.operation) -> !pdl.operation
  ...
  %func_3 = transform.structured.vectorize %func_1 : (!pdl.operation) -> !pdl.operation
