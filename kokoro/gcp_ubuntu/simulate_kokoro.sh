...
# Usage:
#   ./kokoro/gcp_ubuntu/simulate_kokoro.sh kokoro/gcp_ubuntu/bazel/core/build.sh
#
...
#   ./kokoro/gcp_ubuntu/simulate_kokoro.sh kokoro/gcp_ubuntu/bazel/core/build.sh "$PWD/.git"
