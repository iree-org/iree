...
//
// Each scenario describes a set of hardware lanes (physical execution resources),
// semaphores (the clock axes for frontier propagation), and operations (the work
// graph). Operations are scheduled onto hardware lanes and ordered by semaphore
// waits/signals. Hardware sharing is a scheduling constraint; semaphores are the
// ONLY causal ordering mechanism.
//
// Scenario format:
...
export const scenarios = [
  ...
  // -------------------------------------------------------------------------
  {
    ...
    operations: [
      { id: 'fill',     hardware: 'gpu0', label: 'Fill',     duration: 2, wait: {},       signal: { q: 1 } },
      { id: 'matmul',   hardware: 'gpu0', label: 'MatMul',   duration: 3, wait: { q: 1 }, signal: { q: 2 } },
      { id: 'readback', hardware: 'gpu0', label: 'Readback', duration: 1, wait: { q: 2 }, signal: { q: 3 } },
    ],
    annotations: [
      { tick: 0, text:
  ...
  // -------------------------------------------------------------------------
  {
    ...
    operations: [
      { id: 'matmul',     hardware: 'gpu', label: 'MatMul',     duration: 4, wait: {},       signal: { A: 1 } },
      { id: 'activation', hardware: 'gpu', label: 'Activation', duration: 2, wait: { A: 1 }, signal: { A: 2 } },
      { id: 'copy',       hardware: 'gpu', label: 'Copy',       duration: 3, wait: { A: 1 }, signal: { B: 1 } },
      { id: 'process',    hardware: 'gpu', label: 'Process',    duration: 2, wait: { B: 1 }, signal: { B: 2 } },
    ],
    annotations: [
      { tick: 0, text:
  ...
  // -------------------------------------------------------------------------
  {
    ...
    operations: [
      { id: 'setup',    hardware: 'gpu', label: 'Setup',    duration: 2, wait: {},             signal: { s: 1 } },
      { id: 'branch_a', hardware: 'gpu', label: 'Branch A', duration: 3, wait: { s: 1 },       signal: { a: 1 } },
      { id: 'branch_b', hardware: 'gpu', label: 'Branch B', duration: 4, wait: { s: 1 },       signal: { b: 1 } },
      { id: 'merge',    hardware: 'gpu', label: 'Merge',    duration: 2, wait: { a: 1, b: 1 }, signal: { s: 2 } },
    ],
    annotations: [
      { tick: 0, text:
        'Setup begins the work graph on GPU 0.' },
      { tick: 2, text:
  ...
  // -------------------------------------------------------------------------
  {
    ...
    operations: [
      { id: 'a1', hardware: 'gpu', label: 'A:Step 1', duration: 2, wait: {},       signal: { A: 1 } },
      { id: 'a2', hardware: 'gpu', label: 'A:Step 2', duration: 2, wait: { A: 1 }, signal: { A: 2 } },
      { id: 'b1', hardware: 'gpu', label: 'B:Step 1', duration: 2, wait: {},       signal: { B: 1 } },
      { id: 'b2', hardware: 'gpu', label: 'B:Step 2', duration: 2, wait: { B: 1 }, signal: { B: 2 } },
    ],
    annotations: [
      { tick: 0, text:
  ...
  // -------------------------------------------------------------------------
  {
    ...
    operations: [
      { id: 'p1', hardware: 'prod', label: 'P:Chunk 1', duration: 2, wait: {},             signal: { P: 1 } },
      { id: 'p2', hardware: 'prod', label: 'P:Chunk 2', duration: 2, wait: { P: 1 },       signal: { P: 2 } },
      { id: 'p3', hardware: 'prod', label: 'P:Chunk 3', duration: 2, wait: { P: 2 },       signal: { P: 3 } },
      { id: 'c1', hardware: 'cons', label: 'C:Chunk 1', duration: 3, wait: { P: 1 },       signal: { C: 1 } },
      { id: 'c2', hardware: 'cons', label: 'C:Chunk 2', duration: 3, wait: { P: 2, C: 1 }, signal: { C: 2 } },
      { id: 'c3', hardware: 'cons', label: 'C:Chunk 3', duration: 3, wait: { P: 3, C: 2 }, signal: { C: 3 } },
    ],
    annotations: [
      { tick: 0, text:
  ...
  // -------------------------------------------------------------------------
  {
    ...
    operations: [
      { id: 'step1', hardware: 'gpu', label: 'Step 1',     duration: 2, wait: {},              signal: { s: 1 } },
      { id: 'step2', hardware: 'gpu', label: 'Step 2',     duration: 2, wait: { s: 1 },        signal: { s: 2 } },
      { id: 'step3', hardware: 'gpu', label: 'Step 3',     duration: 2, wait: { s: 2 },        signal: { s: 3 } },
      { id: 'setup', hardware: 'gpu', label: 'Slow Setup', duration: 8, wait: {},              signal: { g: 1 } },
      { id: 'join',  hardware: 'gpu', label: 'LateJoin',   duration: 2, wait: { s: 1, g: 1 }, signal: { g: 2 } },
    ],
    annotations: [
      { tick: 0, text:
  ...
  // -------------------------------------------------------------------------
  {
    ...
    operations: [
      ...
      { id: 'a_tok',     hardware: 'cpu',  label: 'A:Tokenize', duration: 2, wait: {},               signal: { A: 1 } },
      { id: 'a_compute', hardware: 'gpu0', label: 'A:Compute',  duration: 4, wait: { A: 1 },         signal: { A: 2 } },
      // Workload B: tokenize on CPU, fan out to local+remote, reduce, output.
      { id: 'b_tok',     hardware: 'cpu',  label: 'B:Tokenize', duration: 2, wait: {},               signal: { B: 1 } },
      { id: 'b_send',    hardware: 'nic',  label: 'B:Send',     duration: 2, wait: { B: 1 },         signal: { R: 1 } },
      { id: 'b_local',   hardware: 'gpu0', label: 'B:Local',    duration: 3, wait: { A: 2, B: 1 },   signal: { B: 2 } },
      { id: 'b_remote',  hardware: 'gpu1', label: 'B:Remote',   duration: 3, wait: { R: 1 },         signal: { R: 2 } },
      { id: 'b_reduce',  hardware: 'gpu0', label: 'B:Reduce',   duration: 2, wait: { B: 2, R: 2 },   signal: { B: 3 } },
      { id: 'b_output',  hardware: 'cpu',  label: 'B:Output',   duration: 1, wait: { B: 3 },         signal: { B: 4 } },
    ],
    annotations: [
      { tick: 0, text:
  ...
  // -------------------------------------------------------------------------
  {
    ...
    operations: [
      { id: 'prefill',   hardware: 'main',  label: 'Prefill',    duration: 4, wait: {},                signal: { K: 1 } },
      { id: 'draft_r1',  hardware: 'draft', label: 'Draft:R1',   duration: 2, wait: { K: 1 },          signal: { D: 1 } },
      { id: 'verify_r1', hardware: 'main',  label: 'Verify:R1',  duration: 2, wait: { D: 1 },          signal: { V: 1 } },
      { id: 'draft_r2',  hardware: 'draft', label: 'Draft:R2',   duration: 2, wait: { D: 1 },          signal: { D: 2 } },
      { id: 'verify_r2', hardware: 'main',  label: 'Verify:R2',  duration: 2, wait: { D: 2, V: 1 },    signal: { V: 2 } },
      { id: 'output',    hardware: 'main',  label: 'Output',     duration: 1, wait: { V: 2 },          signal: { K: 2 } },
    ],
    annotations: [
      { tick: 0, text:
  ...
  // -------------------------------------------------------------------------
  {
    ...
    operations: [
      { id: 'a_prefill', hardware: 'gpu',  label: 'A:Prefill', duration: 2, wait: {},              signal: { A: 1 } },
      { id: 'a_decode',  hardware: 'gpu',  label: 'A:Decode',  duration: 2, wait: { A: 1 },        signal: { A: 2 } },
      { id: 'evict',     hardware: 'nvme', label: 'Evict',     duration: 2, wait: { A: 2 },        signal: { P: 1 } },
      { id: 'b_prefill', hardware: 'gpu',  label: 'B:Prefill', duration: 2, wait: { P: 1 },        signal: { B: 1 } },
      { id: 'b_decode',  hardware: 'gpu',  label: 'B:Decode',  duration: 2, wait: { B: 1 },        signal: { B: 2 } },
      { id: 'load',      hardware: 'nvme', label: 'Load',      duration: 2, wait: { P: 1, B: 2 },  signal: { P: 2 } },
      { id: 'a_resume',  hardware: 'gpu',  label: 'A:Resume',  duration: 2, wait: { P: 2 },        signal: { A: 3 } },
    ],
    annotations: [
      { tick: 0, text:
  ...
  // -------------------------------------------------------------------------
  {
    ...
    operations: [
      { id: 'tokenize',   hardware: 'cpu',    label: 'Tokenize',   duration: 1, wait: {},             signal: { T: 1 } },
      { id: 'upload',     hardware: 'nic',    label: 'Upload',     duration: 1, wait: {},             signal: { N: 1 } },
      { id: 'embed',      hardware: 'local',  label: 'Embed',      duration: 3, wait: { T: 1 },       signal: { T: 2 } },
      { id: 'vit',        hardware: 'remote', label: 'ViT',        duration: 3, wait: { N: 1 },       signal: { V: 1 } },
      { id: 'download',   hardware: 'nic',    label: 'Download',   duration: 1, wait: { V: 1 },       signal: { V: 2 } },
      { id: 'cross_attn', hardware: 'local',  label: 'CrossAttn',  duration: 2, wait: { T: 2, V: 2 }, signal: { F: 1 } },
      { id: 'generate',   hardware: 'local',  label: 'Generate',   duration: 2, wait: { F: 1 },       signal: { F: 2 } },
    ],
    annotations: [
      { tick: 0, text:
  ...
  // -------------------------------------------------------------------------
  {
    ...
    operations: [
      { id: 'audio',   hardware: 'cpu',  label: 'Audio Prep',    duration: 1, wait: {},       signal: { A: 1 } },
      { id: 'whisper', hardware: 'apu',  label: 'Whisper',       duration: 3, wait: { A: 1 }, signal: { W: 1 } },
      { id: 'dma',     hardware: 'pcie', label: 'DMA Transfer',  duration: 1, wait: { W: 1 }, signal: { D: 1 } },
      { id: 'prefill', hardware: 'dgpu', label: 'Phi-3 Prefill', duration: 2, wait: { D: 1 }, signal: { P: 1 } },
      { id: 'decode',  hardware: 'dgpu', label: 'Phi-3 Decode',  duration: 3, wait: { P: 1 }, signal: { P: 2 } },
      { id: 'embed',   hardware: 'npu',  label: 'BGE Embed',     duration: 4, wait: {},       signal: { E: 1 } },
    ],
    annotations: [
      { tick: 0, text:
      ...
      { tick: 5, text:
        'DMA completes. Phi-3 Prefill starts on the dGPU with frontier ' +
  ...
  // -------------------------------------------------------------------------
  {
    ...
    operations: [
      { id: 'tokenize', hardware: 'cpu',  label: 'Tokenize',      duration: 1, wait: {},       signal: { T: 1 } },
      { id: 'embed',    hardware: 'gpu0', label: 'BGE Embed',     duration: 2, wait: { T: 1 }, signal: { B: 1 } },
      { id: 'search',   hardware: 'cpu',  label: 'Vector Search', duration: 2, wait: { B: 1 }, signal: { V: 1 } },
      { id: 'rerank',   hardware: 'gpu1', label: 'Rerank',        duration: 2, wait: { V: 1 }, signal: { K: 1 } },
      { id: 'generate', hardware: 'gpu0', label: 'Generate',      duration: 3, wait: { K: 1 }, signal: { G: 1 } },
    ],
    annotations: [
      { tick: 0, text:
        'A RAG query arrives. Tokenization runs on the CPU. The entire ' +
  ...
  // -------------------------------------------------------------------------
  {
    ...
    operations: [
      { id: 'audio_in',   hardware: 'cpu', label: 'Audio Prep',  duration: 1, wait: {},                     signal: { A: 1 } },
      { id: 'image_in',   hardware: 'cpu', label: 'Image Prep',  duration: 1, wait: {},                     signal: { I: 1 } },
      { id: 'whisper',    hardware: 'gpu', label: 'Whisper',      duration: 2, wait: { A: 1 },              signal: { W: 1 } },
      { id: 'clip',       hardware: 'gpu', label: 'CLIP',         duration: 2, wait: { I: 1 },              signal: { V: 1 } },
      { id: 'llama',      hardware: 'gpu', label: 'Llama-70B',    duration: 3, wait: { W: 1, V: 1 },       signal: { L: 1 } },
      { id: 'code_llama', hardware: 'gpu', label: 'Code-Llama',   duration: 2, wait: { L: 1 },             signal: { K: 1 } },
      { id: 'tts',        hardware: 'gpu', label: 'TTS',          duration: 2, wait: { L: 1 },             signal: { T: 1 } },
      { id: 'sdxl',       hardware: 'gpu', label: 'SDXL',         duration: 2, wait: { K: 1 },             signal: { S: 1 } },
      { id: 'assemble',   hardware: 'cpu', label: 'Assemble',     duration: 1, wait: { K: 1, S: 1, T: 1 }, signal: { R: 1 } },
    ],
    annotations: [
      { tick: 0, text:
      ...
      { tick: 7, text:
        'Llama-70B completes. Two models fork in parallel: Code-Llama ' +
  ...
  // -------------------------------------------------------------------------
  {
    ...
    operations: [
      { id: 'vad',        hardware: 'cpu', label: 'VAD',        duration: 1, wait: {},       signal: { D: 1 } },
      { id: 'encode',     hardware: 'gpu', label: 'Encode',     duration: 2, wait: { D: 1 }, signal: { E: 1 } },
      { id: 'decode',     hardware: 'gpu', label: 'Decode',     duration: 2, wait: { E: 1 }, signal: { S: 1 } },
      { id: 'translate',  hardware: 'gpu', label: 'Translate',  duration: 3, wait: { S: 1 }, signal: { L: 1 } },
      { id: 'synthesize', hardware: 'gpu', label: 'Synthesize', duration: 2, wait: { L: 1 }, signal: { T: 1 } },
      { id: 'playback',   hardware: 'cpu', label: 'Playback',   duration: 1, wait: { T: 1 }, signal: { P: 1 } },
    ],
    annotations: [
      { tick: 0, text:
