...
Curated op and model tests | SHARK-TestSuite [`e2eshark/onnx`](https://github.com/nod-ai/AMDSHARK-TestSuite/tree/main/e2eamdshark/onnx) and [`alt_e2eshark/onnx_tests`](https://github.com/nod-ai/AMDSHARK-TestSuite/tree/main/alt_e2eamdshark/onnx_tests)
...
[ONNX Op Support tracking issue](https://github.com/nod-ai/AMDSHARK-ModelDev/issues/215)
...
1. The operator is not implemented, or the implementation is missing a case.
   Search for a matching issue in one of these places:
     ...
     * <https://github.com/nod-ai/AMDSHARK-ModelDev/issues>
