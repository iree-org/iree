...
module {
  ...
  func @dot(%arg0: !hal.buffer {iree.reflection = {}}, %arg1: !shapex.ranked_shape<[?,?]> {iree.reflection = {}}, %arg2: !hal.buffer {iree.reflection = {}}, %arg3: !shapex.ranked_shape<[?,?]> {iree.reflection = {}}) -> (!hal.buffer {iree.reflection = {}}, !shapex.ranked_shape<[?,?]> {iree.reflection = {}}) attributes {iree.module.export, iree.reflection = {f = "I19!B7!d-1d-1B7!d-1d-1R10!B7!d-1d-1", fv = "1"}} {
    ...
    #hal.device.match.id<"vmla">(%arg4 = %6 : index, %arg5 = %cmd : !hal.command_buffer, %arg6 = %exe : !hal.executable) {
      %c1 = constant 1 : index
      hal.command_buffer.dispatch %arg5, %arg6, entry_point = 0, workgroup_xyz = [%c1, %c1, %c1]
      hal.return
    }
...
func @dot(%arg0: !hal.buffer {iree.reflection = {}}, %arg1: index {iree.reflection = {}}, %arg2: index, %arg3: !hal.buffer {iree.reflection = {}}, %arg4: index {iree.reflection = {}}, %arg5: index) -> (!hal.buffer {iree.reflection = {}}, index {iree.reflection = {}}, index) attributes {iree.module.export, iree.reflection = {f = "I19!B7!d-1d-1B7!d-1d-1R10!B7!d-1d-1", fv = "1"}} {
  ...
  hal.device.switch(%dev : !hal.device)
    #hal.device.match.id<"vmla">(%arg6 = %8 : index, %arg7 = %cmd : !hal.command_buffer, %arg8 = %exe : !hal.executable) {
    %c1 = constant 1 : index
    hal.command_buffer.dispatch %arg7, %arg8, entry_point = 0, workgroup_xyz = [%c1, %c1, %c1]
    hal.return
  }
  %memory_barrier = hal.make_memory_barrier "DispatchWrite", "DispatchRead" : tuple<i32, i32>
  hal.command_buffer.execution_barrier %cmd, "Dispatch|CommandRetire", "CommandIssue|Dispatch", memory_barriers=[%memory_barrier]
...
func @dot(%arg0: !hal.buffer {iree.reflection = {}}, %arg1: index {iree.reflection = {}}, %arg2: index, %arg3: !hal.buffer {iree.reflection = {}}, %arg4: index {iree.reflection = {}}, %arg5: index) -> (!hal.buffer {iree.reflection = {}}, index {iree.reflection = {}}, index) attributes {iree.module.export, iree.reflection = {f = "I19!B7!d-1d-1B7!d-1d-1R10!B7!d-1d-1", fv = "1"}} {
  ...
  %dev = hal.ex.shared_device : !hal.device
  %allocator = hal.device.allocator %dev : !hal.allocator
  %sz = hal.allocator.compute_size %allocator, shape = [%arg1, %arg5], element_type = 50331680
  %buffer = hal.allocator.allocate %allocator, "HostVisible|DeviceVisible|DeviceLocal", "Constant|Transfer|Mapping|Dispatch", %sz : !hal.buffer
  hal.ex.defer_release %buffer : !hal.buffer
  %cmd = hal.command_buffer.create %dev, "OneShot", "Transfer|Dispatch" : !hal.command_buffer
  hal.command_buffer.begin %cmd
  %exe = hal.executable.lookup %dev, @dot_ex_dispatch_0 : !hal.executable
  %executable_layout = hal.executable_layout.lookup %dev, set_layouts = [[#hal.descriptor_set_layout_binding<0, "StorageBuffer", "Read">, #hal.descriptor_set_layout_binding<1, "StorageBuffer", "Read">, #hal.descriptor_set_layout_binding<2, "StorageBuffer", "Write|Discard">]], push_constants = 6 : !hal.executable_layout
  %1 = index_cast %arg1 : index to i32
  %2 = index_cast %arg5 : index to i32
  %3 = index_cast %arg4 : index to i32
  %4 = index_cast %arg5 : index to i32
  %5 = index_cast %arg1 : index to i32
  %6 = index_cast %arg2 : index to i32
  hal.command_buffer.push_constants %cmd, %executable_layout, offset = 0, values = [%1, %2, %3, %4, %5, %6] : i32
  %allocator_0 = hal.buffer.allocator %arg3 : !hal.allocator
  %sz_1 = hal.allocator.compute_size %allocator_0, shape = [%arg4, %arg5], element_type = 50331680
  %allocator_2 = hal.buffer.allocator %arg0 : !hal.allocator
  %sz_3 = hal.allocator.compute_size %allocator_2, shape = [%arg1, %arg2], element_type = 50331680
  %sz_4 = hal.allocator.compute_size %allocator, shape = [%arg1, %arg5], element_type = 50331680
  hal.command_buffer.push_descriptor_set %cmd, %executable_layout, set=0, bindings=[0 = (%arg3, %c0, %sz_1), 1 = (%arg0, %c0, %sz_3), 2 = (%buffer, %c0, %sz_4)]
  hal.device.switch(%dev : !hal.device)
    #hal.device.match.id<"vmla">(%arg6 = %0 : index, %arg7 = %cmd : !hal.command_buffer, %arg8 = %exe : !hal.executable) {
    %c1 = constant 1 : index
    hal.command_buffer.dispatch %arg7, %arg8, entry_point = 0, workgroup_xyz = [%c1, %c1, %c1]
    hal.return
  }
...
func @dot(%arg0: !hal.buffer {iree.reflection = {}}, %arg1: index {iree.reflection = {}}, %arg2: index, %arg3: !hal.buffer {iree.reflection = {}}, %arg4: index {iree.reflection = {}}, %arg5: index) -> (!hal.buffer {iree.reflection = {}}, index {iree.reflection = {}}, index) attributes {iree.module.export, iree.reflection = {f = "I19!B7!d-1d-1B7!d-1d-1R10!B7!d-1d-1", fv = "1"}} {
  ...
  hal.command_buffer.push_constants %cmd, %executable_layout, offset = 0, values = [%1, %2, %3, %2, %1, %4] : i32
  %allocator_0 = hal.buffer.allocator %arg3 : !hal.allocator
  %sz_1 = hal.allocator.compute_size %allocator_0, shape = [%arg4, %arg5], element_type = 50331680
  %allocator_2 = hal.buffer.allocator %arg0 : !hal.allocator
  %sz_3 = hal.allocator.compute_size %allocator_2, shape = [%arg1, %arg2], element_type = 50331680
  hal.command_buffer.push_descriptor_set %cmd, %executable_layout, set=0, bindings=[0 = (%arg3, %c0, %sz_1), 1 = (%arg0, %c0, %sz_3), 2 = (%buffer, %c0, %sz)]
  hal.device.switch(%dev : !hal.device)
    #hal.device.match.id<"vmla">(%arg6 = %0 : index, %arg7 = %cmd : !hal.command_buffer, %arg8 = %exe : !hal.executable) {
    %c1 = constant 1 : index
    hal.command_buffer.dispatch %arg7, %arg8, entry_point = 0, workgroup_xyz = [%c1, %c1, %c1]
...
module {
  ...
  func @dot$sync(%arg0: !hal.buffer_view, %arg1: !hal.buffer_view) -> !hal.buffer_view attributes {iree.abi.stub, iree.module.export = "dot", iree.reflection = {f = "I19!B7!d-1d-1B7!d-1d-1R10!B7!d-1d-1", fv = "1"}} {
    ...
    %2 = hal.buffer_view.dim %arg1, 0 : index
    %3 = hal.buffer_view.dim %arg1, 1 : index
    %4:3 = call @dot(%buffer, %0, %1, %buffer_0, %2, %3) : (!hal.buffer, index, index, !hal.buffer, index, index) -> (!hal.buffer, index, index)
...
module {
  ...
  func @dot(%arg0: !hal.buffer {iree.reflection = {}}, %arg1: index {iree.reflection = {}}, %arg2: index, %arg3: !hal.buffer {iree.reflection = {}}, %arg4: index {iree.reflection = {}}, %arg5: index) -> (!hal.buffer {iree.reflection = {}}, index {iree.reflection = {}}, index) attributes {iree.module.export = "dot$raw"} {
    ...
    %allocator_2 = hal.buffer.allocator %arg0 : !hal.allocator
    %sz_3 = hal.allocator.compute_size %allocator_2, shape = [%arg1, %arg2], element_type = 50331680
    hal.command_buffer.push_descriptor_set %cmd, %2, set=0, bindings=[0 = (%arg3, %c0, %sz_1), 1 = (%arg0, %c0, %sz_3), 2 = (%buffer, %c0, %sz)]
    hal.device.switch(%dev : !hal.device)
    #hal.device.match.id<"vmla">(%arg6 = %0 : index, %arg7 = %cmd : !hal.command_buffer, %arg8 = %1 : !hal.executable) {
      %c1 = constant 1 : index
      hal.command_buffer.dispatch %arg7, %arg8, entry_point = 0, workgroup_xyz = [%c1, %c1, %c1]
      hal.return
    }
...
func @dot(%arg0: !hal.buffer {iree.reflection = {}}, %arg1: index {iree.reflection = {}}, %arg2: index, %arg3: !hal.buffer {iree.reflection = {}}, %arg4: index {iree.reflection = {}}, %arg5: index) -> (!hal.buffer {iree.reflection = {}}, index {iree.reflection = {}}, index) attributes {iree.module.export = "dot$raw"} {
  ...
  %sz_3 = hal.allocator.compute_size %allocator_2, shape = [%arg1, %arg2], element_type = 50331680
  hal.command_buffer.push_descriptor_set %cmd, %2, set=0, bindings=[0 = (%arg3, %c0, %sz_1), 1 = (%arg0, %c0, %sz_3), 2 = (%buffer, %c0, %sz)]
  %7 = hal.device.match.id %dev, pattern = ["vmla"] : (!hal.device) -> i1
  cond_br %7, ^bb1, ^bb2
^bb1:  // pred: ^bb0
  %c1 = constant 1 : index
...
module {
  ...
  func @dot(%arg0: !hal.buffer {iree.reflection = {}}, %arg1: index {iree.reflection = {}}, %arg2: index, %arg3: !hal.buffer {iree.reflection = {}}, %arg4: index {iree.reflection = {}}, %arg5: index) -> (!hal.buffer {iree.reflection = {}}, index {iree.reflection = {}}, index) attributes {iree.module.export = "dot$raw"} {
    ...
    %sz_3 = hal.allocator.compute_size %allocator_2, shape = [%arg1, %arg2], element_type = 50331680
    hal.command_buffer.push_descriptor_set %cmd, %2, set=0, bindings=[0 = (%arg3, %c0, %sz_1), 1 = (%arg0, %c0, %sz_3), 2 = (%buffer, %c0, %sz)]
    %7 = hal.variable.load @_device_match_id_0 : i1
    cond_br %7, ^bb1, ^bb2
  ^bb1:  // pred: ^bb0
    %c1 = constant 1 : index
    hal.command_buffer.dispatch %cmd, %1, entry_point = 0, workgroup_xyz = [%c1, %c1, %c1]
...
func @dot(%arg0: !hal.buffer {iree.reflection = {}}, %arg1: index {iree.reflection = {}}, %arg2: index, %arg3: !hal.buffer {iree.reflection = {}}, %arg4: index {iree.reflection = {}}, %arg5: index) -> (!hal.buffer {iree.reflection = {}}, index {iree.reflection = {}}, index) attributes {iree.module.export = "dot$raw"} {
  ...
  %3 = index_cast %arg5 : index to i32
  %4 = index_cast %arg4 : index to i32
  %5 = index_cast %arg2 : index to i32
  hal.command_buffer.push_constants %cmd, %1, offset = 0, values = [%2, %3, %4, %3, %2, %5] : i32
  %allocator_0 = hal.buffer.allocator %arg3 : !hal.allocator
  %sz_1 = hal.allocator.compute_size %allocator_0, shape = [%arg4, %arg5], element_type = 50331680
  %allocator_2 = hal.buffer.allocator %arg0 : !hal.allocator
  %sz_3 = hal.allocator.compute_size %allocator_2, shape = [%arg1, %arg2], element_type = 50331680
  hal.command_buffer.push_descriptor_set %cmd, %1, set=0, bindings=[0 = (%arg3, %c0, %sz_1), 1 = (%arg0, %c0, %sz_3), 2 = (%buffer, %c0, %sz)]
...
module {
  vm.module @module {
    ...
    vm.func @dot(%arg0: !vm.ref<!hal.buffer>, %arg1: i32, %arg2: i32, %arg3: !vm.ref<!hal.buffer>, %arg4: i32, %arg5: i32) -> (!vm.ref<!hal.buffer>, i32, i32) {
      ...
      %0 = vm.call.variadic @hal.allocator.compute_size(%ref_0, [%arg1, %arg5], %c50331680) : (!vm.ref<!hal.allocator>, i32 ..., i32) -> i32
      ...
      %ref_5 = vm.call @hal.buffer.allocator(%arg3) : (!vm.ref<!hal.buffer>) -> !vm.ref<!hal.allocator>
      %c50331680_6 = vm.const.i32 50331680 : i32
      %1 = vm.call.variadic @hal.allocator.compute_size(%ref_5, [%arg4, %arg5], %c50331680_6) : (!vm.ref<!hal.allocator>, i32 ..., i32) -> i32
      %ref_7 = vm.call @hal.buffer.allocator(%arg0) : (!vm.ref<!hal.buffer>) -> !vm.ref<!hal.allocator>
      %c50331680_8 = vm.const.i32 50331680 : i32
      %2 = vm.call.variadic @hal.allocator.compute_size(%ref_7, [%arg1, %arg2], %c50331680_8) : (!vm.ref<!hal.allocator>, i32 ..., i32) -> i32
      %zero_9 = vm.const.i32.zero : i32
      %zero_10 = vm.const.i32.zero : i32
      %c1_11 = vm.const.i32 1 : i32
      %c2 = vm.const.i32 2 : i32
      vm.call.variadic @hal.command_buffer.push_descriptor_set(%ref_3, %_executable_layout_0, %zero_9, [%zero_10, %c1_11, %c2], [%arg3, %arg0, %ref_1], [%zero, %zero, %zero], [%1, %2, %0]) : (!vm.ref<!hal.command_buffer>, !vm.ref<!hal.executable_layout>, i32, i32 ..., !vm.ref<!hal.buffer> ..., i32 ..., i32 ...)
    ...
    ^bb1:  // pred: ^bb0
      ...
      vm.call @hal.command_buffer.dispatch(%ref_3, %_executable_dot_ex_dispatch_0, %zero_12, %c1, %c1, %c1) : (!vm.ref<!hal.command_buffer>, !vm.ref<!hal.executable>, i32, i32, i32, i32) -> ()
    ...
    vm.func @dot$sync(%arg0: !vm.ref<!hal.buffer_view>, %arg1: !vm.ref<!hal.buffer_view>) -> !vm.ref<!hal.buffer_view> attributes {iree.reflection = {f = "I19!B7!d-1d-1B7!d-1d-1R10!B7!d-1d-1", fv = "1"}} {
      ...
      %zero_1 = vm.const.i32.zero : i32
      %2 = vm.call @hal.buffer_view.dim(%arg1, %zero_1) : (!vm.ref<!hal.buffer_view>, i32) -> i32
      %c1_2 = vm.const.i32 1 : i32
      %3 = vm.call @hal.buffer_view.dim(%arg1, %c1_2) : (!vm.ref<!hal.buffer_view>, i32) -> i32
      %ref_3:3 = vm.call @dot(%ref, %0, %1, %ref_0, %2, %3) : (!vm.ref<!hal.buffer>, i32, i32, !vm.ref<!hal.buffer>, i32, i32) -> (!vm.ref<!hal.buffer>, i32, i32)
      %c50331680 = vm.const.i32 50331680 : i32
...
module {
  vm.module @module {
    ...
    vm.func @dot(%arg0: !vm.ref<!hal.buffer>, %arg1: i32, %arg2: i32, %arg3: !vm.ref<!hal.buffer>, %arg4: i32, %arg5: i32) -> (!vm.ref<!hal.buffer>, i32, i32) {
      ...
      %ref_3 = vm.call @hal.buffer.allocator(%arg3) : (!vm.ref<!hal.buffer>) -> !vm.ref<!hal.allocator>
      %1 = vm.call.variadic @hal.allocator.compute_size(%ref_3, [%arg4, %arg5], %c50331680) : (!vm.ref<!hal.allocator>, i32 ..., i32) -> i32
      %ref_4 = vm.call @hal.buffer.allocator(%arg0) : (!vm.ref<!hal.buffer>) -> !vm.ref<!hal.allocator>
      %2 = vm.call.variadic @hal.allocator.compute_size(%ref_4, [%arg1, %arg2], %c50331680) : (!vm.ref<!hal.allocator>, i32 ..., i32) -> i32
      vm.call.variadic @hal.command_buffer.push_descriptor_set(%ref_2, %_executable_layout_0, %zero, [%zero, %c1, %c2], [%arg3, %arg0, %ref_1], [%zero, %zero, %zero], [%1, %2, %0]) : (!vm.ref<!hal.command_buffer>, !vm.ref<!hal.executable_layout>, i32, i32 ..., !vm.ref<!hal.buffer> ..., i32 ..., i32 ...)
      %_device_match_id_0 = vm.global.load.i32 @_device_match_id_0 : i32
      vm.cond_br %_device_match_id_0, ^bb1, ^bb2
    ^bb1:  // pred: ^bb0
    ...
    vm.func @dot$sync(%arg0: !vm.ref<!hal.buffer_view>, %arg1: !vm.ref<!hal.buffer_view>) -> !vm.ref<!hal.buffer_view> attributes {iree.reflection = {f = "I19!B7!d-1d-1B7!d-1d-1R10!B7!d-1d-1", fv = "1"}} {
      ...
      %1 = vm.call @hal.buffer_view.dim(%arg0, %c1) : (!vm.ref<!hal.buffer_view>, i32) -> i32
      %ref_0 = vm.call @hal.buffer_view.buffer(%arg1) : (!vm.ref<!hal.buffer_view>) -> !vm.ref<!hal.buffer>
      %2 = vm.call @hal.buffer_view.dim(%arg1, %zero) : (!vm.ref<!hal.buffer_view>, i32) -> i32
      %3 = vm.call @hal.buffer_view.dim(%arg1, %c1) : (!vm.ref<!hal.buffer_view>, i32) -> i32
      ...
      %4 = vm.call.variadic @hal.allocator.compute_size(%ref_2, [%0, %3], %c50331680) : (!vm.ref<!hal.allocator>, i32 ..., i32) -> i32
      %ref_3 = vm.call @hal.allocator.allocate(%ref_2, %c50, %c15, %4) : (!vm.ref<!hal.allocator>, i32, i32, i32) -> !vm.ref<!hal.buffer>
      ...
      %_executable_dot_ex_dispatch_0 = vm.global.load.ref @_executable_dot_ex_dispatch_0 : !vm.ref<!hal.executable>
      %_executable_layout_0 = vm.global.load.ref @_executable_layout_0 : !vm.ref<!hal.executable_layout>
      vm.call.variadic @hal.command_buffer.push_constants(%ref_4, %_executable_layout_0, %zero, [%0, %3, %2, %3, %0, %1]) : (!vm.ref<!hal.command_buffer>, !vm.ref<!hal.executable_layout>, i32, i32 ...)
      %ref_5 = vm.call @hal.buffer.allocator(%ref_0) : (!vm.ref<!hal.buffer>) -> !vm.ref<!hal.allocator>
      %5 = vm.call.variadic @hal.allocator.compute_size(%ref_5, [%2, %3], %c50331680) : (!vm.ref<!hal.allocator>, i32 ..., i32) -> i32
      %ref_6 = vm.call @hal.buffer.allocator(%ref) : (!vm.ref<!hal.buffer>) -> !vm.ref<!hal.allocator>
      %6 = vm.call.variadic @hal.allocator.compute_size(%ref_6, [%0, %1], %c50331680) : (!vm.ref<!hal.allocator>, i32 ..., i32) -> i32
      vm.call.variadic @hal.command_buffer.push_descriptor_set(%ref_4, %_executable_layout_0, %zero, [%zero, %c1, %c2], [%ref_0, %ref, %ref_3], [%zero, %zero, %zero], [%5, %6, %4]) : (!vm.ref<!hal.command_buffer>, !vm.ref<!hal.executable_layout>, i32, i32 ..., !vm.ref<!hal.buffer> ..., i32 ..., i32 ...)
      %_device_match_id_0 = vm.global.load.i32 @_device_match_id_0 : i32
      vm.cond_br %_device_match_id_0, ^bb1, ^bb2
    ^bb1:  // pred: ^bb0
      ...
      %ref_7 = vm.call.variadic @hal.buffer_view.create(%ref_3, [%0, %3], %c50331680) : (!vm.ref<!hal.buffer>, i32 ..., i32) -> !vm.ref<!hal.buffer_view>
    ...
    ^bb1:  // pred: ^bb0
      ...
      %ref_1 = vm.call @hal.ex.shared_device() : () -> !vm.ref<!hal.device>
      %ref_2 = vm.call @hal.device.allocator(%ref_1) : (!vm.ref<!hal.device>) -> !vm.ref<!hal.allocator>
      %5 = vm.call.variadic @hal.allocator.compute_size(%ref_2, [%1, %4], %c50331680) : (!vm.ref<!hal.allocator>, i32 ..., i32) -> i32
      %ref_3 = vm.call @hal.allocator.allocate(%ref_2, %c50, %c15, %5) : (!vm.ref<!hal.allocator>, i32, i32, i32) -> !vm.ref<!hal.buffer>
      vm.call @hal.ex.defer_release(%ref_3) : (!vm.ref<!hal.buffer>) -> ()
      %ref_4 = vm.call @hal.command_buffer.create(%ref_1, %c1, %c3) : (!vm.ref<!hal.device>, i32, i32) -> !vm.ref<!hal.command_buffer>
      vm.call @hal.command_buffer.begin(%ref_4) : (!vm.ref<!hal.command_buffer>) -> ()
      %_executable_dot_ex_dispatch_0 = vm.global.load.ref @_executable_dot_ex_dispatch_0 : !vm.ref<!hal.executable>
      %_executable_layout_0 = vm.global.load.ref @_executable_layout_0 : !vm.ref<!hal.executable_layout>
      vm.call.variadic @hal.command_buffer.push_constants(%ref_4, %_executable_layout_0, %zero, [%1, %4, %3, %4, %1, %2]) : (!vm.ref<!hal.command_buffer>, !vm.ref<!hal.executable_layout>, i32, i32 ...)
      %ref_5 = vm.call @hal.buffer.allocator(%ref_0) : (!vm.ref<!hal.buffer>) -> !vm.ref<!hal.allocator>
      %6 = vm.call.variadic @hal.allocator.compute_size(%ref_5, [%3, %4], %c50331680) : (!vm.ref<!hal.allocator>, i32 ..., i32) -> i32
      %ref_6 = vm.call @hal.buffer.allocator(%ref) : (!vm.ref<!hal.buffer>) -> !vm.ref<!hal.allocator>
      %7 = vm.call.variadic @hal.allocator.compute_size(%ref_6, [%1, %2], %c50331680) : (!vm.ref<!hal.allocator>, i32 ..., i32) -> i32
      vm.call.variadic @hal.command_buffer.push_descriptor_set(%ref_4, %_executable_layout_0, %zero, [%zero, %c1, %c2], [%ref_0, %ref, %ref_3], [%zero, %zero, %zero], [%6, %7, %5]) : (!vm.ref<!hal.command_buffer>, !vm.ref<!hal.executable_layout>, i32, i32 ..., !vm.ref<!hal.buffer> ..., i32 ..., i32 ...)
      %_device_match_id_0 = vm.global.load.i32 @_device_match_id_0 : i32
      vm.cond_br %_device_match_id_0, ^bb3, ^bb4
    ^bb2(%8: i32):  // pred: ^bb0
      vm.fail %8, "semaphore wait failed"
    ^bb3:  // pred: ^bb1
      vm.call @hal.command_buffer.dispatch(%ref_4, %_executable_dot_ex_dispatch_0, %zero, %c1, %c1, %c1) : (!vm.ref<!hal.command_buffer>, !vm.ref<!hal.executable>, i32, i32, i32, i32) -> ()
      vm.call.variadic @hal.command_buffer.execution_barrier(%ref_4, %c20, %c5, [%c8], []) : (!vm.ref<!hal.command_buffer>, i32, i32, i32 ..., i32 ...)
      vm.call @hal.command_buffer.end(%ref_4) : (!vm.ref<!hal.command_buffer>) -> ()
      vm.call @hal.ex.submit_and_wait(%ref_1, %ref_4) : (!vm.ref<!hal.device>, !vm.ref<!hal.command_buffer>) -> ()
      %ref_7 = vm.call.variadic @hal.buffer_view.create(%ref_3, [%1, %4], %c50331680) : (!vm.ref<!hal.buffer>, i32 ..., i32) -> !vm.ref<!hal.buffer_view>
      vm.call @hal.semaphore.signal(%arg4, %arg5) : (!vm.ref<!hal.semaphore>, i32) -> ()
      vm.return %ref_7 : !vm.ref<!hal.buffer_view>
    ^bb4:  // pred: ^bb1
      vm.fail %c2, "unreachable location reached"
