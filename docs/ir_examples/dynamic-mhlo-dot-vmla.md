...
module {
  ...
  func @dot(%arg0: !hal.buffer {iree.reflection = {}}, %arg1: index {iree.reflection = {}}, %arg2: index, %arg3: !hal.buffer {iree.reflection = {}}, %arg4: index {iree.reflection = {}}, %arg5: index) -> (!hal.buffer {iree.reflection = {}}, index {iree.reflection = {}}, index) attributes {iree.module.export = "dot$raw"} {
    ...
    #hal.device.match.id<"vmla">(%arg6 = %0 : index, %arg7 = %cmd : !hal.command_buffer) {
      %c1 = constant 1 : index
      %5 = hal.command_buffer.device %arg7 : !hal.device
      %exe = hal.executable.lookup %5, @dot_ex_dispatch_0 : !hal.executable
...
module {
  ...
  func @dot(%arg0: !hal.buffer {iree.reflection = {}}, %arg1: index {iree.reflection = {}}, %arg2: index, %arg3: !hal.buffer {iree.reflection = {}}, %arg4: index {iree.reflection = {}}, %arg5: index) -> (!hal.buffer {iree.reflection = {}}, index {iree.reflection = {}}, index) attributes {iree.module.export = "dot$raw"} {
    ...
    #hal.device.match.id<"vmla">(%arg6 = %0 : index, %arg7 = %cmd : !hal.command_buffer) {
      %c1 = constant 1 : index
      %6 = hal.command_buffer.device %arg7 : !hal.device
      %7 = hal.variable.load @_executable_dot_ex_dispatch_0 : !hal.executable
      hal.command_buffer.dispatch %arg7, %7, entry_point = 0, workgroup_xyz = [%c1, %c1, %c1]
      hal.return
    }
    %memory_barrier = hal.make_memory_barrier "DispatchWrite", "DispatchRead" : tuple<i32, i32>
    hal.command_buffer.execution_barrier %cmd, "Dispatch|CommandRetire", "CommandIssue|Dispatch", memory_barriers=[%memory_barrier]
...
func @dot(%arg0: !hal.buffer {iree.reflection = {}}, %arg1: index {iree.reflection = {}}, %arg2: index, %arg3: !hal.buffer {iree.reflection = {}}, %arg4: index {iree.reflection = {}}, %arg5: index) -> (!hal.buffer {iree.reflection = {}}, index {iree.reflection = {}}, index) attributes {iree.module.export = "dot$raw"} {
  ...
  %sz_3 = hal.allocator.compute_size %allocator_2, shape = [%arg1, %arg2], element_type = 50331680
  hal.command_buffer.push_descriptor_set %cmd, %1, set=0, bindings=[0 = (%arg3, %c0, %sz_1), 1 = (%arg0, %c0, %sz_3), 2 = (%buffer, %c0, %sz)]
  %6 = hal.device.match.id %dev, pattern = ["vmla"] : (!hal.device) -> i1
  cond_br %6, ^bb1, ^bb2
^bb1:  // pred: ^bb0
  %c1 = constant 1 : index
  %7 = hal.command_buffer.device %cmd : !hal.device
  %8 = hal.variable.load @_executable_dot_ex_dispatch_0 : !hal.executable
  hal.command_buffer.dispatch %cmd, %8, entry_point = 0, workgroup_xyz = [%c1, %c1, %c1]
  br ^bb3
^bb2:  // pred: ^bb0
  iree.unreachable
^bb3:  // pred: ^bb1
...
func @dot(%arg0: !hal.buffer {iree.reflection = {}}, %arg1: index {iree.reflection = {}}, %arg2: index, %arg3: !hal.buffer {iree.reflection = {}}, %arg4: index {iree.reflection = {}}, %arg5: index) -> (!hal.buffer {iree.reflection = {}}, index {iree.reflection = {}}, index) attributes {iree.module.export = "dot$raw"} {
  ...
  %3 = index_cast %arg4 : index to i32
  %4 = index_cast %arg2 : index to i32
  hal.command_buffer.push_constants %cmd, %0, offset = 0, values = [%1, %2, %3, %2, %1, %4] : i32
  %allocator_0 = hal.buffer.allocator %arg3 : !hal.allocator
  %sz_1 = hal.allocator.compute_size %allocator_0, shape = [%arg4, %arg5], element_type = 50331680
  %allocator_2 = hal.buffer.allocator %arg0 : !hal.allocator
  %sz_3 = hal.allocator.compute_size %allocator_2, shape = [%arg1, %arg2], element_type = 50331680
  hal.command_buffer.push_descriptor_set %cmd, %0, set=0, bindings=[0 = (%arg3, %c0, %sz_1), 1 = (%arg0, %c0, %sz_3), 2 = (%buffer, %c0, %sz)]
  %5 = hal.variable.load @_device_match_id_0 : i1
  cond_br %5, ^bb1, ^bb2
^bb1:  // pred: ^bb0
  %6 = hal.variable.load @_executable_dot_ex_dispatch_0 : !hal.executable
  hal.command_buffer.dispatch %cmd, %6, entry_point = 0, workgroup_xyz = [%c1, %c1, %c1]
  %memory_barrier = hal.make_memory_barrier "DispatchWrite", "DispatchRead" : tuple<i32, i32>
  hal.command_buffer.execution_barrier %cmd, "Dispatch|CommandRetire", "CommandIssue|Dispatch", memory_barriers=[%memory_barrier]
  hal.command_buffer.end %cmd
  hal.ex.submit_and_wait %dev, %cmd
...
module {
  vm.module @module {
    ...
    ^bb1:  // pred: ^bb0
      ...
      %5 = vm.call.variadic @hal.allocator.compute_size(%ref_4, [%1, %4], %c50331680) : (!vm.ref<!hal.allocator>, i32 ..., i32) -> i32
      %ref_5 = vm.call @hal.allocator.allocate(%ref_4, %c50, %c15, %5) : (!vm.ref<!hal.allocator>, i32, i32, i32) -> !vm.ref<!hal.buffer>
      ...
      %_executable_layout_0 = vm.global.load.ref @_executable_layout_0 : !vm.ref<!hal.executable_layout>
      vm.call.variadic @hal.command_buffer.push_constants(%ref_6, %_executable_layout_0, %zero, [%1, %4, %3, %4, %1, %2]) : (!vm.ref<!hal.command_buffer>, !vm.ref<!hal.executable_layout>, i32, i32 ...)
      %ref_7 = vm.call @hal.buffer.allocator(%ref_2) : (!vm.ref<!hal.buffer>) -> !vm.ref<!hal.allocator>
      %6 = vm.call.variadic @hal.allocator.compute_size(%ref_7, [%3, %4], %c50331680) : (!vm.ref<!hal.allocator>, i32 ..., i32) -> i32
      %ref_8 = vm.call @hal.buffer.allocator(%ref_1) : (!vm.ref<!hal.buffer>) -> !vm.ref<!hal.allocator>
      %7 = vm.call.variadic @hal.allocator.compute_size(%ref_8, [%1, %2], %c50331680) : (!vm.ref<!hal.allocator>, i32 ..., i32) -> i32
      vm.call.variadic @hal.command_buffer.push_descriptor_set(%ref_6, %_executable_layout_0, %zero, [%zero, %c1, %c2], [%ref_2, %ref_1, %ref_5], [%zero, %zero, %zero], [%6, %7, %5]) : (!vm.ref<!hal.command_buffer>, !vm.ref<!hal.executable_layout>, i32, i32 ..., !vm.ref<!hal.buffer> ..., i32 ..., i32 ...)
      %_device_match_id_0 = vm.global.load.i32 @_device_match_id_0 : i32
      vm.cond_br %_device_match_id_0, ^bb3, ^bb4
    ^bb2(%8: i32):  // 2 preds: ^bb0, ^bb3
      vm.fail %8, "semaphore wait failed"
    ^bb3:  // pred: ^bb1
      %_executable_dot_ex_dispatch_0 = vm.global.load.ref @_executable_dot_ex_dispatch_0 : !vm.ref<!hal.executable>
      ...
      %ref_9 = vm.call.variadic @hal.buffer_view.create(%ref_5, [%1, %4], %c50331680) : (!vm.ref<!hal.buffer>, i32 ..., i32) -> !vm.ref<!hal.buffer_view>
      vm.call @hal.semaphore.signal(%ref_0, %c1) : (!vm.ref<!hal.semaphore>, i32) -> ()
      %9 = vm.call @hal.semaphore.await(%ref_0, %c1) : (!vm.ref<!hal.semaphore>, i32) -> i32
      vm.cond_br %9, ^bb2(%9 : i32), ^bb5
    ^bb4:  // pred: ^bb1
      vm.fail %c2, "unreachable location reached"
    ^bb5:  // pred: ^bb3
