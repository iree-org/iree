...
extension, which is core in Vulkan 1.2. For older Vulkan installs without
native support for this extension, the
...
Developers may build/install this layer on their own, or using the
Bazel or CMake build targets at
