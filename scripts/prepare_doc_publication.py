...
def parse_arguments():
    ...
    parser = argparse.ArgumentParser(description='Processes MarkDown files for publication')
    parser.add_argument('base_dir', metavar='PATH', type=str, help='Base documentation directory.')
...
def process_file(basedir, relpath, filename):
    """Modifies the given file in-place with metadata and other changes to
