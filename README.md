...
Kokoro    | Bazel        | Linux    | x86             | Integrations         | [![kokoro_status_bazel_linux_x86_integrations](https://storage.googleapis.com/iree-oss-build-badges/bazel/linux/x86/integrations/main_status.svg)](https://storage.googleapis.com/iree-oss-build-badges/bazel/linux/x86/integrations/main_result.html)
...
Kokoro    | CMake        | Linux    | x86             | Core + Bindings      | [![kokoro_status_cmake_linux_x86](https://storage.googleapis.com/iree-oss-build-badges/cmake/linux/x86/main_status.svg)](https://storage.googleapis.com/iree-oss-build-badges/cmake/linux/x86/main_result.html)
