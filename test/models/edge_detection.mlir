...
module attributes {tf_saved_model.semantics} {
  func @__inference_edge_detect_sobel_operator_130(%arg0: tensor<1x128x128x1xf32> {tf_saved_model.index_path = [0]}) -> (tensor<1x128x128x1xf32> {tf_saved_model.index_path = []}) attributes {tf._input_shapes = ["tfshape$dim { size: 1 } dim { size: 128 } dim { size: 128 } dim { size: 1 }"], tf_saved_model.exported_names = ["edge_detect_sobel_operator"]} {
