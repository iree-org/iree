vm.module @comparison_ops_f32 {
  ...
  vm.func @test_cmp_lt_0_f32() {
    ...
    %lhs_dno = vm.optimization_barrier %lhs : f32
    %rhs = vm.const.f32 -4.0
    %rhs_dno = vm.optimization_barrier %rhs : f32
  ...
  vm.func @test_cmp_eq_f32_near() {
    ...
    %cn2_dno = vm.optimization_barrier %cn2 : f32
    %c2 = vm.const.f32 2.0
    %c2_dno = vm.optimization_barrier %c2 : f32
    ...
    %c1a_dno = vm.optimization_barrier %c1a : f32
    %c1b = vm.const.f32 1.00003
    %c1b_dno = vm.optimization_barrier %c1b : f32
