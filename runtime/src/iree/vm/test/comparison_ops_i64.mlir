vm.module @comparison_ops_i64 {
  ...
  vm.func @test_cmp_lt_s_0_i64() {
    ...
    %lhs_dno = vm.optimization_barrier %lhs : i64
    %rhs = vm.const.i64 -4294967295
    %rhs_dno = vm.optimization_barrier %rhs : i64
  ...
  vm.func @test_cmp_lte_i64() {
    ...
    %cn2 = vm.const.i64 -2
    %cn2_dno = vm.optimization_barrier %cn2 : i64
    %c2 = vm.const.i64 2
    %c2_dno = vm.optimization_barrier %c2 : i64
