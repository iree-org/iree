vm.module @arithmetic_ops_f32 {
  ...
  vm.func @test_sub_f32() {
    ...
    %c1dno = vm.optimization_barrier %c1 : f32
    %c2 = vm.const.f32 2.5
    %c2dno = vm.optimization_barrier %c2 : f32
  ...
  vm.func @test_fma_f32() {
    ...
    %c2dno = vm.optimization_barrier %c2 : f32
    %c3 = vm.const.f32 3.0
    %c3dno = vm.optimization_barrier %c3 : f32
    %c5 = vm.const.f32 5.0
    %c5dno = vm.optimization_barrier %c5 : f32
  ...
  vm.func @test_floor_f32() {
    ...
    %c15dno = vm.optimization_barrier %c15 : f32
  ...
  vm.func @test_min_f32() {
    ...
    %cn3dno = vm.optimization_barrier %cn3 : f32
    %cn2 = vm.const.f32 -2.0
    %cn2dno = vm.optimization_barrier %cn2 : f32
