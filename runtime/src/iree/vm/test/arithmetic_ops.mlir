vm.module @arithmetic_ops {
  ...
  vm.func @test_fma_i32() {
    ...
    %c2dno = vm.optimization_barrier %c2 : i32
    %c3 = vm.const.i32 3
    %c3dno = vm.optimization_barrier %c3 : i32
    %c5 = vm.const.i32 5
    %c5dno = vm.optimization_barrier %c5 : i32
  ...
  vm.func @test_abs_i32() {
    %cn1 = vm.const.i32 -1
    %cn1dno = vm.optimization_barrier %cn1 : i32
  ...
  vm.func @test_min_i32s() {
    %cn3 = vm.const.i32 -3
    %cn3dno = vm.optimization_barrier %cn3 : i32
    %c2 = vm.const.i32 2
    %c2dno = vm.optimization_barrier %c2 : i32
  ...
  vm.func @test_ctlz_i32_const_zero() {
    %c = vm.const.i32 0
    %cdno = vm.optimization_barrier %c : i32
