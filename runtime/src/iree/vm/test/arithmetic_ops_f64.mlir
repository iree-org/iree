vm.module @arithmetic_ops_f64 {
  ...
  vm.func @test_add_f64() {
    %c1 = vm.const.f64 1.5
    %c1dno = vm.optimization_barrier %c1 : f64
  ...
  vm.func @test_sub_f64() {
    ...
    %c1dno = vm.optimization_barrier %c1 : f64
    %c2 = vm.const.f64 2.5
    %c2dno = vm.optimization_barrier %c2 : f64
  ...
  vm.func @test_fma_f64() {
    ...
    %c2dno = vm.optimization_barrier %c2 : f64
    %c3 = vm.const.f64 3.0
    %c3dno = vm.optimization_barrier %c3 : f64
    %c5 = vm.const.f64 5.0
    %c5dno = vm.optimization_barrier %c5 : f64
  ...
  vm.func @test_floor_f64() {
    ...
    %c15dno = vm.optimization_barrier %c15 : f64
  ...
  vm.func @test_min_f64() {
    ...
    %cn3dno = vm.optimization_barrier %cn3 : f64
    %cn2 = vm.const.f64 -2.0
    %cn2dno = vm.optimization_barrier %cn2 : f64
