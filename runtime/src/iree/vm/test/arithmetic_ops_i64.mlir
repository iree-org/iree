vm.module @arithmetic_ops_i64 {
  ...
  vm.func @test_add_i64() {
    %c1 = vm.const.i64 1
    %c1dno = vm.optimization_barrier %c1 : i64
  ...
  vm.func @test_fma_i64() {
    ...
    %c2dno = vm.optimization_barrier %c2 : i64
    %c3 = vm.const.i64 3
    %c3dno = vm.optimization_barrier %c3 : i64
    %c5 = vm.const.i64 5
    %c5dno = vm.optimization_barrier %c5 : i64
  ...
  vm.func @test_abs_i64() {
    %cn1 = vm.const.i64 -1
    %cn1dno = vm.optimization_barrier %cn1 : i64
  ...
  vm.func @test_min_i64s() {
    %cn3 = vm.const.i64 -3
    %cn3dno = vm.optimization_barrier %cn3 : i64
    %c2 = vm.const.i64 2
    %c2dno = vm.optimization_barrier %c2 : i64
  ...
  vm.func @test_ctlz_i64_const_zero() {
    %c = vm.const.i64 0
    %cdno = vm.optimization_barrier %c : i64
