vm.module @comparison_ops {
  ...
  vm.func @test_cmp_lt_s_0() {
    %lhs = vm.const.i32 2
    %lhs_dno = vm.optimization_barrier %lhs : i32
    %rhs = vm.const.i32 -2
    %rhs_dno = vm.optimization_barrier %rhs : i32
  ...
  vm.func @test_cmp_lte() {
    ...
    %cn2 = vm.const.i32 -2
    %cn2_dno = vm.optimization_barrier %cn2 : i32
    %c2 = vm.const.i32 2
    %c2_dno = vm.optimization_barrier %c2 : i32
