...
typedef enum {
  ...
  IREE_VM_OP_EXT_F32_RoundF32 = 0x2A,
  IREE_VM_OP_EXT_F32_CmpEQF32O = 0x2B,
  IREE_VM_OP_EXT_F32_CmpEQF32U = 0x2C,
  IREE_VM_OP_EXT_F32_CmpNEF32O = 0x2D,
  IREE_VM_OP_EXT_F32_CmpNEF32U = 0x2E,
  IREE_VM_OP_EXT_F32_CmpLTF32O = 0x2F,
  IREE_VM_OP_EXT_F32_CmpLTF32U = 0x30,
  IREE_VM_OP_EXT_F32_CmpLTEF32O = 0x31,
  IREE_VM_OP_EXT_F32_CmpLTEF32U = 0x32,
  IREE_VM_OP_EXT_F32_CmpNaNF32 = 0x33,
  IREE_VM_OP_EXT_F32_BufferLoadF32 = 0x34,
  IREE_VM_OP_EXT_F32_BufferStoreF32 = 0x35,
  IREE_VM_OP_EXT_F32_BufferFillF32 = 0x36,
...
#define IREE_VM_OP_EXT_F32_TABLE(OPC, RSV) \
    ...
    OPC(0x32, CmpLTEF32U) \
    OPC(0x33, CmpNaNF32) \
    OPC(0x34, BufferLoadF32) \
    OPC(0x35, BufferStoreF32) \
    OPC(0x36, BufferFillF32) \
    RSV(0x37) \
    RSV(0x38) \
    RSV(0x39) \
    RSV(0x3A) \
...
typedef enum {
  ...
  IREE_VM_OP_EXT_F64_RoundF64 = 0x30,
  IREE_VM_OP_EXT_F64_CmpEQF64O = 0x31,
  IREE_VM_OP_EXT_F64_CmpEQF64U = 0x32,
  IREE_VM_OP_EXT_F64_CmpNEF64O = 0x33,
  IREE_VM_OP_EXT_F64_CmpNEF64U = 0x34,
  IREE_VM_OP_EXT_F64_CmpLTF64O = 0x35,
  IREE_VM_OP_EXT_F64_CmpLTF64U = 0x36,
  IREE_VM_OP_EXT_F64_CmpLTEF64O = 0x37,
  IREE_VM_OP_EXT_F64_CmpLTEF64U = 0x38,
  IREE_VM_OP_EXT_F64_CmpNaNF64 = 0x39,
  IREE_VM_OP_EXT_F64_BufferLoadF64 = 0x3A,
  IREE_VM_OP_EXT_F64_BufferStoreF64 = 0x3B,
  IREE_VM_OP_EXT_F64_BufferFillF64 = 0x3C,
...
#define IREE_VM_OP_EXT_F64_TABLE(OPC, RSV) \
    ...
    OPC(0x38, CmpLTEF64U) \
    OPC(0x39, CmpNaNF64) \
    OPC(0x3A, BufferLoadF64) \
    OPC(0x3B, BufferStoreF64) \
    OPC(0x3C, BufferFillF64) \
    RSV(0x3D) \
    RSV(0x3E) \
    RSV(0x3F) \
    RSV(0x40) \
