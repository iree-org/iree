...
static iree_status_t iree_hal_static_executable_export_info(
  ...
  iree_hal_static_executable_t* executable =
      (iree_hal_static_executable_t*)base_executable;
  return iree_hal_executable_library_export_info(
      executable->library.v0, export_ordinal, out_info);
}
        ...
        .base =
            {
                ...
                .export_parameters = iree_hal_static_executable_export_parameters,
                .lookup_export_by_name = iree_hal_static_executable_lookup_export_by_name,
            },
...
static iree_status_t iree_hal_static_library_loader_infer_format(
  ...
  iree_status_t status =
      iree_make_status(IREE_STATUS_UNIMPLEMENTED,
                       "static library size inference not yet implemented");
  (void)executable_loader;
