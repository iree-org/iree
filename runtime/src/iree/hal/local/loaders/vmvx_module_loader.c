...
static iree_host_size_t iree_hal_vmvx_executable_export_count(
  ...
  iree_hal_vmvx_executable_t* executable =
      (iree_hal_vmvx_executable_t*)base_executable;
  // TODO(vmvx): return the total number of exports in the executable.
  (void)executable;
  return 0;
}
...
static iree_status_t iree_hal_vmvx_executable_export_info(
  ...
  iree_hal_vmvx_executable_t* executable =
      (iree_hal_vmvx_executable_t*)base_executable;
  (void)executable;
  // TODO(vmvx): return export information from VM module.
...
static iree_status_t iree_hal_vmvx_executable_lookup_export_by_name(
  ...
  iree_hal_vmvx_executable_t* executable =
      (iree_hal_vmvx_executable_t*)base_executable;
  (void)executable;
  // TODO(vmvx): lookup the export ordinal by name.
  return iree_make_status(IREE_STATUS_UNIMPLEMENTED,
                          "reflection not implemented");
}
        ...
        .base =
            {
                ...
                .lookup_export_by_name = iree_hal_vmvx_executable_lookup_export_by_name,
            },
...
static iree_status_t iree_hal_vmvx_module_loader_infer_format(
  ...
  iree_status_t status = iree_make_status(
      IREE_STATUS_UNIMPLEMENTED, "VMVX size inference not yet implemented");
  (void)executable_loader;
