...
#ifndef IREE_HAL_REMOTE_CLIENT_REGISTRATION_DRIVER_MODULE_H_
#define IREE_HAL_REMOTE_CLIENT_REGISTRATION_DRIVER_MODULE_H_
...
#endif  // IREE_HAL_REMOTE_CLIENT_REGISTRATION_DRIVER_MODULE_H_
