...
TEST_P(semaphore_submission_test, WaitAllHostAndDeviceSemaphores) {
  ...
  IREE_ASSERT_OK(iree_hal_device_queue_execute(
      ...
      device_signal_semaphores, 1, &command_buffer, NULL));
...
TEST_P(semaphore_submission_test, IntermediateSemaphoreBetweenDeviceBatches) {
  ...
  IREE_ASSERT_OK(iree_hal_device_queue_execute(
      ...
      /*signal_semaphore_list=*/semaphore2_list, 1, &command_buffer2, NULL));
  ...
  IREE_ASSERT_OK(iree_hal_device_queue_execute(
      ...
      /*signal_semaphore_list=*/semaphore1_list, 1, &command_buffer1, NULL));
...
TEST_P(semaphore_submission_test, TwoBatchesWaitingOn1FormerBatchAmongst2) {
  ...
  IREE_ASSERT_OK(iree_hal_device_queue_execute(
      ...
      /*signal_semaphore_list=*/semaphore22_list, 1, &command_buffer22, NULL));
  IREE_ASSERT_OK(iree_hal_device_queue_execute(
      device_, IREE_HAL_QUEUE_AFFINITY_ANY,
      /*wait_semaphore_list=*/semaphore11_list,
      /*signal_semaphore_list=*/semaphore21_list, 1, &command_buffer21, NULL));
  IREE_ASSERT_OK(iree_hal_device_queue_execute(
      device_, IREE_HAL_QUEUE_AFFINITY_ANY,
  ...
  IREE_ASSERT_OK(iree_hal_device_queue_execute(
      device_, IREE_HAL_QUEUE_AFFINITY_ANY,
      /*wait_semaphore_list=*/empty_semaphore_list,
      /*signal_semaphore_list=*/semaphore11_list, 1, &command_buffer11, NULL));
