...
enum iree_hal_numerical_type_bits_t {
  ...
  IREE_HAL_NUMERICAL_TYPE_FLOAT_6_E3M2FN =
      IREE_HAL_NUMERICAL_TYPE_FLOAT | 0x09u,
  IREE_HAL_NUMERICAL_TYPE_FLOAT_6_E2M3FN =
      IREE_HAL_NUMERICAL_TYPE_FLOAT | 0x0Au,
  IREE_HAL_NUMERICAL_TYPE_FLOAT_4_E2M1FN =
...
enum iree_hal_element_types_t {
  ...
  IREE_HAL_ELEMENT_TYPE_FLOAT_6_E3M2_FN    = IREE_HAL_ELEMENT_TYPE_VALUE(IREE_HAL_NUMERICAL_TYPE_FLOAT_6_E3M2FN,      6),  // NOLINT
  IREE_HAL_ELEMENT_TYPE_FLOAT_6_E2M3_FN    = IREE_HAL_ELEMENT_TYPE_VALUE(IREE_HAL_NUMERICAL_TYPE_FLOAT_6_E2M3FN,      6),  // NOLINT
  IREE_HAL_ELEMENT_TYPE_FLOAT_4_E2M1_FN    = IREE_HAL_ELEMENT_TYPE_VALUE(IREE_HAL_NUMERICAL_TYPE_FLOAT_4_E2M1FN,      4),  // NOLINT
};
