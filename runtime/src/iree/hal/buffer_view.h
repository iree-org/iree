...
enum iree_hal_numerical_type_bits_t {
  ...
  IREE_HAL_NUMERICAL_TYPE_FLOAT_8_E4M3FN =
      IREE_HAL_NUMERICAL_TYPE_FLOAT | 0x05u,
  ...
  IREE_HAL_NUMERICAL_TYPE_FLOAT_8_E8M0_FNU =
      IREE_HAL_NUMERICAL_TYPE_FLOAT | 0x08u,
  IREE_HAL_NUMERICAL_TYPE_FLOAT_6_E3M2_FN =
      IREE_HAL_NUMERICAL_TYPE_FLOAT | 0x09u,
  IREE_HAL_NUMERICAL_TYPE_FLOAT_6_E2M3_FN =
      IREE_HAL_NUMERICAL_TYPE_FLOAT | 0x0Au,
  IREE_HAL_NUMERICAL_TYPE_FLOAT_4_E2M1_FN =
      IREE_HAL_NUMERICAL_TYPE_FLOAT | 0x0Bu,
};
...
enum iree_hal_element_types_t {
  ...
  IREE_HAL_ELEMENT_TYPE_FLOAT_8_E4M3_FN    = IREE_HAL_ELEMENT_TYPE_VALUE(IREE_HAL_NUMERICAL_TYPE_FLOAT_8_E4M3FN,      8),  // NOLINT
  ...
  IREE_HAL_ELEMENT_TYPE_FLOAT_8_E8M0_FNU   = IREE_HAL_ELEMENT_TYPE_VALUE(IREE_HAL_NUMERICAL_TYPE_FLOAT_8_E8M0_FNU,    8),  // NOLINT
  IREE_HAL_ELEMENT_TYPE_FLOAT_6_E3M2_FN    = IREE_HAL_ELEMENT_TYPE_VALUE(IREE_HAL_NUMERICAL_TYPE_FLOAT_6_E3M2_FN,     6),  // NOLINT
  IREE_HAL_ELEMENT_TYPE_FLOAT_6_E2M3_FN    = IREE_HAL_ELEMENT_TYPE_VALUE(IREE_HAL_NUMERICAL_TYPE_FLOAT_6_E2M3_FN,     6),  // NOLINT
  IREE_HAL_ELEMENT_TYPE_FLOAT_4_E2M1_FN    = IREE_HAL_ELEMENT_TYPE_VALUE(IREE_HAL_NUMERICAL_TYPE_FLOAT_4_E2M1_FN,     4),  // NOLINT
};
