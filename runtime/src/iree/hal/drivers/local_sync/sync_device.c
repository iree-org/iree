...
static iree_status_t iree_hal_sync_device_transfer_h2d_raw(
...
static iree_status_t iree_hal_sync_device_transfer_d2h_raw(
...
static const iree_hal_device_vtable_t iree_hal_sync_device_vtable = {
    ...
    .query_string = iree_hal_sync_device_query_string,
    ...
    .transfer_h2d_raw = iree_hal_sync_device_transfer_h2d_raw,
    .transfer_d2h_raw = iree_hal_sync_device_transfer_d2h_raw,
};
