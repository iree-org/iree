...
// Each physical device may have one or more HAL queues that map to hardware
// queues.
//
// All physical devices that make up a logical device are expected to be the
// same today. It's possible for heterogeneous devices but the implementation
// does not currently handle taking the minimum capabilities and limits.
