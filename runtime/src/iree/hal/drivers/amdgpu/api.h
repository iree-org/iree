...
typedef struct iree_hal_amdgpu_logical_device_options_t {
  ...
  struct {
    struct {
      // Size in bytes of the small host block. Must be a power of two.
      iree_host_size_t block_size;
    } small;
    struct {
      // Size in bytes of the large host block. Must be a power of two.
      iree_host_size_t block_size;
    } large;
  } host_block_pools;
  ...
  struct {
    struct {
      // Size in bytes of the small device block. Must be a power of two.
      iree_device_size_t block_size;
      // Initial small block pool block allocation count.
      iree_host_size_t initial_capacity;
    } small;
    struct {
      // Size in bytes of the large device block. Must be a power of two.
      iree_device_size_t block_size;
