...
typedef struct iree_hal_amdgpu_queue_t iree_hal_amdgpu_queue_t;
...
typedef struct iree_hal_amdgpu_physical_device_t {
  ...
  iree_hal_amdgpu_block_pools_t block_pools;
  // Block pool-based allocators for small transient allocations.
