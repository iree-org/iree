...
// The max number of per-dispatch bindings allowed.
...
// The max number of per-dispatch constants allowed.
// This is limited by the field size in iree_hal_amdgpu_device_kernel_args_t.
...
// Looks up an exported kernel function and returns the kernel arguments in host
// memory and the memory of the GPU device with the given ordinal.
