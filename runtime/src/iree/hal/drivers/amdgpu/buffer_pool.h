...
// many more.
#define IREE_HAL_AMDGPU_BUFFER_POOL_DEFAULT_BLOCK_CAPACITY 2048
...
typedef struct iree_hal_amdgpu_buffer_pool_t {
  ...
  // DO NOT SUBMIT common flags/buffer types/etc

  // Capacity of each block in buffers.
  // Most likely IREE_HAL_AMDGPU_BUFFER_POOL_DEFAULT_BLOCK_CAPACITY.
...
// Buffers will be usable on all GPU devices in |topology|.
...
#endif  // IREE_HAL_DRIVERS_AMDGPU_BUFFER_POOL_H_
