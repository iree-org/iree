...
// Wraps a AMDGPU allocation in an iree_hal_buffer_t.
...
void iree_hal_amdgpu_transient_buffer_initialize(
    uint32_t pool, iree_hal_amdgpu_device_allocation_handle_t* handle,
...
iree_status_t iree_hal_amdgpu_resolve_transient_buffer(
    iree_hal_buffer_t* buffer, uint32_t* out_pool,
