...
// valid on the device between an alloc/free pair and we assume the client code
// is not going to do something invalid (free and then try to use the handle).
//
...
typedef struct iree_hal_amdgpu_device_allocation_handle_s {
  ...
  void* ptr;
  // DO NOT SUBMIT pool it was allocated from
  // DO NOT SUBMIT block it was allocated from
} iree_hal_amdgpu_device_allocation_handle_t;
