...
typedef struct IREE_AMDGPU_ALIGNAS(64) iree_hal_amdgpu_device_cmd_barrier_s {
  iree_hal_amdgpu_device_cmd_header_t header;
} iree_hal_amdgpu_device_cmd_barrier_t;
...
typedef struct IREE_AMDGPU_ALIGNAS(64)
    iree_hal_amdgpu_device_cmd_signal_event_s {
  iree_hal_amdgpu_device_cmd_header_t header;
...
typedef struct IREE_AMDGPU_ALIGNAS(64)
    iree_hal_amdgpu_device_cmd_reset_event_s {
  iree_hal_amdgpu_device_cmd_header_t header;
  iree_hal_amdgpu_device_event_ordinal_t event;
} iree_hal_amdgpu_device_cmd_reset_event_t;
...
typedef struct IREE_AMDGPU_ALIGNAS(64)
    iree_hal_amdgpu_device_cmd_wait_events_s {
  iree_hal_amdgpu_device_cmd_header_t header;
...
typedef struct IREE_AMDGPU_ALIGNAS(64)
    iree_hal_amdgpu_device_cmd_fill_buffer_s {
  iree_hal_amdgpu_device_cmd_header_t header;
...
typedef struct IREE_AMDGPU_ALIGNAS(64)
    iree_hal_amdgpu_device_cmd_copy_buffer_s {
  iree_hal_amdgpu_device_cmd_header_t header;
  // Block-relative kernel arguments address.
  uint32_t kernarg_offset;
  // Copy source.
...
typedef struct IREE_AMDGPU_ALIGNAS(64) iree_hal_amdgpu_device_cmd_dispatch_s {
  iree_hal_amdgpu_device_cmd_header_t header;
  // Block-relative kernel arguments address.
...
// same command buffer.
typedef struct IREE_AMDGPU_ALIGNAS(64) iree_hal_amdgpu_device_cmd_branch_s {
  iree_hal_amdgpu_device_cmd_header_t header;
  // Block-relative kernel arguments address.
  uint32_t kernarg_offset;
...
// target.
typedef struct IREE_AMDGPU_ALIGNAS(64) iree_hal_amdgpu_device_cmd_return_s {
  iree_hal_amdgpu_device_cmd_header_t header;
  // Block-relative kernel arguments address.
  uint32_t kernarg_offset;
} iree_hal_amdgpu_device_cmd_return_t;
...
// packets.
typedef struct IREE_AMDGPU_ALIGNAS(64) iree_hal_amdgpu_device_cmd_s {
  union {
    iree_hal_amdgpu_device_cmd_header_t header;
...
typedef struct iree_hal_amdgpu_device_command_query_map_s {
  ...
  const iree_hal_amdgpu_device_command_query_id_t* query_ids;
...
typedef struct IREE_AMDGPU_ALIGNAS(64) iree_hal_amdgpu_device_command_block_s {
...
static_assert(sizeof(iree_hal_amdgpu_device_command_block_t) ==
                  IREE_HAL_AMDGPU_DEVICE_CMD_SIZE,
...
typedef struct IREE_AMDGPU_ALIGNAS(64) iree_hal_amdgpu_device_command_buffer_s {
...
// manipulate it.
typedef struct IREE_AMDGPU_ALIGNAS(64)
    iree_hal_amdgpu_device_execution_state_s {
