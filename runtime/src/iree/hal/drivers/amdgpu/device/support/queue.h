...
typedef struct iree_hsa_queue_s {
  ...
  IREE_AMDGPU_ALIGNAS(64) void* base_address;
...
typedef struct iree_hsa_kernel_dispatch_packet_s {
  ...
  IREE_AMDGPU_ALIGNAS(16) void* kernarg_address;
...
typedef struct IREE_AMDGPU_ALIGNAS(8) iree_amdgpu_kernel_implicit_args_s {
