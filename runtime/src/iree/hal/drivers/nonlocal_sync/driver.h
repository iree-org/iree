...
#ifndef IREE_HAL_DRIVERS_NONLOCAL_SYNC_DRIVER_H_
#define IREE_HAL_DRIVERS_NONLOCAL_SYNC_DRIVER_H_
...
iree_status_t iree_hal_nl_sync_driver_create(
...
#endif  // IREE_HAL_DRIVERS_NONLOCAL_SYNC_DRIVER_H_
