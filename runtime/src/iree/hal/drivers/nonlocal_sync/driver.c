...
} iree_hal_nl_sync_driver_t;

static const iree_hal_driver_vtable_t iree_hal_nl_sync_driver_vtable;

static iree_hal_nl_sync_driver_t* iree_hal_nl_sync_driver_cast(
    iree_hal_driver_t* base_value) {
  IREE_HAL_ASSERT_TYPE(base_value, &iree_hal_nl_sync_driver_vtable);
  return (iree_hal_nl_sync_driver_t*)base_value;
}
...
iree_status_t iree_hal_nl_sync_driver_create(
  ...
  *out_driver = NULL;
  ...
  iree_hal_nl_sync_driver_t* driver = NULL;
...
static void iree_hal_nl_sync_driver_destroy(iree_hal_driver_t* base_driver) {
...
static iree_status_t iree_hal_nl_sync_driver_query_available_devices(
...
static iree_status_t iree_hal_nl_sync_driver_dump_device_info(
...
static iree_status_t iree_hal_nl_sync_driver_create_device_by_id(
    iree_hal_driver_t* base_driver, iree_hal_device_id_t device_id,
...
static iree_status_t iree_hal_nl_sync_driver_create_device_by_path(
  ...
  return iree_hal_nl_sync_driver_create_device_by_id(
      base_driver, IREE_HAL_DEVICE_ID_DEFAULT, param_count, params,
      host_allocator, out_device);
}

static const iree_hal_driver_vtable_t iree_hal_nl_sync_driver_vtable = {
    .destroy = iree_hal_nl_sync_driver_destroy,
    .query_available_devices = iree_hal_nl_sync_driver_query_available_devices,
    .dump_device_info = iree_hal_nl_sync_driver_dump_device_info,
    .create_device_by_id = iree_hal_nl_sync_driver_create_device_by_id,
    .create_device_by_path = iree_hal_nl_sync_driver_create_device_by_path,
};
