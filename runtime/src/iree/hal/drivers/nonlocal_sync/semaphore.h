...
#ifndef IREE_HAL_DRIVERS_NONLOCAL_SYNC_SYNC_SEMAPHORE_H_
#define IREE_HAL_DRIVERS_NONLOCAL_SYNC_SYNC_SEMAPHORE_H_
...
typedef struct iree_hal_nl_sync_semaphore_state_t {
...
#endif  // IREE_HAL_DRIVERS_NONLOCAL_SYNC_SYNC_SEMAPHORE_H_
