...
// Parameters configuring an iree_hal_nl_task_device_t.
// Must be initialized with iree_hal_nl_task_device_params_initialize prior to use.
typedef struct iree_hal_nl_task_device_params_t {
...
} iree_hal_nl_task_device_params_t;
