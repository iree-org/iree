...
#ifndef IREE_HAL_DRIVERS_CUDA2_GRAPH_COMMAND_BUFFER_H_
#define IREE_HAL_DRIVERS_CUDA2_GRAPH_COMMAND_BUFFER_H_
...
#endif  // IREE_HAL_DRIVERS_CUDA2_GRAPH_COMMAND_BUFFER_H_
