...
static iree_status_t iree_hal_metal_executable_flatbuffer_read_size(
...
iree_status_t iree_hal_metal_executable_infer_format(iree_const_byte_span_t executable_data,
  ...
  IREE_RETURN_IF_ERROR(iree_hal_metal_executable_flatbuffer_read_size(
  ...
  *out_inferred_size = flatbuffer_data.data_length + sizeof(flatbuffers_uoffset_t);
  return iree_ok_status();
}
...
iree_status_t iree_hal_metal_executable_create(
  ...
  *out_executable = NULL;
  ...
  IREE_RETURN_AND_END_ZONE_IF_ERROR(z0, iree_hal_metal_executable_flatbuffer_read_size(
                                            executable_params->executable_data,
                                            /*unsafe_infer_size=*/false, &executable_flatbuffer));
