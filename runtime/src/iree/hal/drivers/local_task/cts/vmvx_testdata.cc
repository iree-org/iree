...
// VMVX executable format registration for the local-task CTS2 backend.
//
...
#include "runtime/src/iree/hal/drivers/local_task/cts/testdata_vmvx.h"
...
static bool vmvx_format_registered_ =
    (CtsRegistry::RegisterExecutableFormat(
         "local_task", {"vmvx", "vmvx-bytecode-fb", GetVmvxExecutableData}),
     true);
