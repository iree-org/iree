...
static iree_status_t iree_hal_task_device_query_string(
    iree_hal_device_t* base_device, iree_string_view_t category,
...
static iree_status_t iree_hal_task_device_transfer_h2d_raw(
...
static iree_status_t iree_hal_task_device_transfer_d2h_raw(
...
static const iree_hal_device_vtable_t iree_hal_task_device_vtable = {
    ...
    .query_string = iree_hal_task_device_query_string,
    ...
    .transfer_h2d_raw = iree_hal_task_device_transfer_h2d_raw,
    .transfer_d2h_raw = iree_hal_task_device_transfer_d2h_raw,
};
