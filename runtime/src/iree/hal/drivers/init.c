...
#if defined(IREE_HAVE_HAL_NONLOCAL_SYNC_DRIVER_MODULE)
#include "iree/hal/drivers/nonlocal_sync/registration/driver_module.h"
#endif  // IREE_HAVE_HAL_NONLOCAL_SYNC_DRIVER_MODULE

#if defined(IREE_HAVE_HAL_NONLOCAL_TASK_DRIVER_MODULE)
#include "iree/hal/drivers/nonlocal_task/registration/driver_module.h"
#endif  // IREE_HAVE_HAL_NONLOCAL_TASK_DRIVER_MODULE
...
#if defined(IREE_HAVE_HAL_NONLOCAL_SYNC_DRIVER_MODULE)
  IREE_RETURN_AND_END_ZONE_IF_ERROR(
      z0, iree_hal_nonlocal_sync_driver_module_register(registry));
#endif  // IREE_HAVE_HAL_NONLOCAL_SYNC_DRIVER_MODULE

#if defined(IREE_HAVE_HAL_NONLOCAL_TASK_DRIVER_MODULE)
  IREE_RETURN_AND_END_ZONE_IF_ERROR(
      z0, iree_hal_nonlocal_task_driver_module_register(registry));
#endif  // IREE_HAVE_HAL_NONLOCAL_TASK_DRIVER_MODULE
