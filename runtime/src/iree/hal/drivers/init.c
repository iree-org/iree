...
#if defined(IREE_HAVE_HAL_HSA_DRIVER_MODULE)
#include "iree/hal/drivers/hsa/registration/driver_module.h"
#endif  // IREE_HAVE_HAL_HSA_DRIVER_MODULE
...
#if defined(IREE_HAVE_HAL_HSA_DRIVER_MODULE)
  IREE_RETURN_AND_END_ZONE_IF_ERROR(
      z0, iree_hal_hsa_driver_module_register(registry));
#endif  // IREE_HAVE_HAL_HSA_DRIVER_MODULE
