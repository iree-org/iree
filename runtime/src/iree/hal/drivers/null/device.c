...
static iree_status_t iree_hal_null_device_query_string(
    iree_hal_device_t* base_device, iree_string_view_t category,
  ...
  // TODO(null): implement string queries if needed.
  return iree_make_status(
      IREE_STATUS_NOT_FOUND,
      "unknown device configuration key value '%.*s :: %.*s'",
      (int)category.size, category.data, (int)key.size, key.data);
...
static iree_status_t iree_hal_null_device_transfer_h2d_raw(
...
static iree_status_t iree_hal_null_device_transfer_d2h_raw(
...
static const iree_hal_device_vtable_t iree_hal_null_device_vtable = {
    ...
    .query_string = iree_hal_null_device_query_string,
    ...
    .transfer_h2d_raw = iree_hal_null_device_transfer_h2d_raw,
    .transfer_d2h_raw = iree_hal_null_device_transfer_d2h_raw,
};
