  ...
  *out_executable = NULL;
  ...
  IREE_RETURN_AND_END_ZONE_IF_ERROR(
      z0, iree_hal_read_executable_flatbuffer_header(
              ...
              iree_hal_vulkan_ExecutableDef_file_identifier,
...
static iree_host_size_t iree_hal_vulkan_native_executable_export_count(
    iree_hal_executable_t* base_executable) {
  iree_hal_vulkan_native_executable_t* executable =
      iree_hal_vulkan_native_executable_cast(base_executable);
  // TODO(vulkan): return the total number of exports in the executable.
  (void)executable;
  return 0;
}

static iree_status_t iree_hal_vulkan_native_executable_export_info(
    iree_hal_executable_t* base_executable,
  ...
  iree_hal_vulkan_native_executable_t* executable =
      iree_hal_vulkan_native_executable_cast(base_executable);
  (void)executable;
  // TODO(vulkan): return export information from SPIR-V reflection.
  return iree_make_status(IREE_STATUS_UNIMPLEMENTED,
                          "reflection not implemented");
}

static iree_status_t iree_hal_vulkan_native_executable_export_parameters(
    iree_hal_executable_t* base_executable,
    iree_hal_executable_export_ordinal_t export_ordinal,
  ...
  iree_hal_vulkan_native_executable_t* executable =
      iree_hal_vulkan_native_executable_cast(base_executable);
  (void)executable;
  // TODO(vulkan): return export parameter information from SPIR-V reflection.
  return iree_make_status(IREE_STATUS_UNIMPLEMENTED,
                          "parameter reflection not implemented");
}

static iree_status_t iree_hal_vulkan_native_executable_lookup_export_by_name(
    iree_hal_executable_t* base_executable, iree_string_view_t name,
    iree_hal_executable_export_ordinal_t* out_export_ordinal) {
  iree_hal_vulkan_native_executable_t* executable =
      iree_hal_vulkan_native_executable_cast(base_executable);
  (void)executable;
  // TODO(vulkan): lookup the export ordinal by name.
  return iree_make_status(IREE_STATUS_UNIMPLEMENTED,
                          "reflection not implemented");
}
...
const iree_hal_executable_vtable_t iree_hal_vulkan_native_executable_vtable = {
    ...
    /*.export_count=*/iree_hal_vulkan_native_executable_export_count,
    /*.export_info=*/iree_hal_vulkan_native_executable_export_info,
    ...
    iree_hal_vulkan_executable_lookup_global_by_name,
};
}  // namespace
