...
enum iree_hal_vulkan_feature_bits_t {
  ...
  IREE_HAL_VULKAN_FEATURE_ENABLE_VALIDATION_LAYERS = 1ull << 0,

  // Use VK_EXT_debug_utils, record markers, and log errors.
  IREE_HAL_VULKAN_FEATURE_ENABLE_DEBUG_UTILS = 1ull << 1,
  ...
  IREE_HAL_VULKAN_FEATURE_ENABLE_TRACING = 1ull << 2,
  ...
  // Enables RenderDoc profiling support.
  IREE_HAL_VULKAN_FEATURE_ENABLE_RENDERDOC_PROFILING = 1ull << 7,
  // Enables Radeon Graphics Profiler profiling support.
  IREE_HAL_VULKAN_FEATURE_ENABLE_RGP_PROFILING = 1ull << 8,
};
...
typedef struct iree_hal_vulkan_profiling_context_t {
  iree_allocator_t host_allocator;
  // Populated if IREE_HAL_VULKAN_FEATURE_ENABLE_RGP_PROFILING is set.
  /*DevDriverAPI*/ void* rgp_api;
  /*DevDriverAPIContext*/ void* rgp_context;
} iree_hal_vulkan_profiling_context_t;
