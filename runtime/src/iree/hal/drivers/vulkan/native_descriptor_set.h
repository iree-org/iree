...
#ifndef IREE_HAL_DRIVERS_VULKAN_NATIVE_DESCRIPTOR_SET_H_
#define IREE_HAL_DRIVERS_VULKAN_NATIVE_DESCRIPTOR_SET_H_
...
#endif  // IREE_HAL_DRIVERS_VULKAN_NATIVE_DESCRIPTOR_SET_H_
