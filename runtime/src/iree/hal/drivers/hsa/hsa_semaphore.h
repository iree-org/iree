...
// Creates a semaphore that allows for ordering of operations.
// This is a host-only semaphore implementation backed by a shared
// iree_notification_t in |shared_state|.
