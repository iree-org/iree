...
#ifndef IREE_HAL_DRIVERS_HSA_REGISTRATION_MULTI_QUEUE_H_
#define IREE_HAL_DRIVERS_HSA_REGISTRATION_MULTI_QUEUE_H_
...
inline iree_status_t iree_hal_drivers_hsa_cts_default_multi_queue_create(
  ...
  *out_device = NULL;
  ...
  return iree_hal_driver_create_device_by_path(
      driver, IREE_SV("hsa"), IREE_SV(path.c_str()), /*param_count=*/0,
      /*params=*/NULL, iree_allocator_system(), out_device);
}

#endif  // IREE_HAL_DRIVERS_HSA_REGISTRATION_MULTI_QUEUE_H_
