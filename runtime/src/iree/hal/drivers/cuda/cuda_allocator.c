...
static bool iree_hal_cuda_allocator_supports_virtual_memory(
    iree_hal_allocator_t* IREE_RESTRICT base_allocator) {
  return false;
}

static iree_status_t iree_hal_cuda_allocator_virtual_memory_query_granularity(
    iree_hal_allocator_t* IREE_RESTRICT base_allocator,
...
static iree_status_t iree_hal_cuda_allocator_virtual_memory_reserve(
    iree_hal_allocator_t* IREE_RESTRICT base_allocator,
...
static iree_status_t iree_hal_cuda_allocator_virtual_memory_release(
    iree_hal_allocator_t* IREE_RESTRICT base_allocator,
...
static iree_status_t iree_hal_cuda_allocator_physical_memory_allocate(
    iree_hal_allocator_t* IREE_RESTRICT base_allocator,
...
static iree_status_t iree_hal_cuda_allocator_physical_memory_free(
    iree_hal_allocator_t* IREE_RESTRICT base_allocator,
...
static iree_status_t iree_hal_cuda_allocator_virtual_memory_map(
    iree_hal_allocator_t* IREE_RESTRICT base_allocator,
    iree_hal_buffer_t* IREE_RESTRICT virtual_buffer,
...
static iree_status_t iree_hal_cuda_allocator_virtual_memory_unmap(
    iree_hal_allocator_t* IREE_RESTRICT base_allocator,
    iree_hal_buffer_t* IREE_RESTRICT virtual_buffer,
...
static iree_status_t iree_hal_cuda_allocator_virtual_memory_protect(
    iree_hal_allocator_t* IREE_RESTRICT base_allocator,
    iree_hal_buffer_t* IREE_RESTRICT virtual_buffer,
    iree_device_size_t virtual_offset, iree_device_size_t size,
...
static iree_status_t iree_hal_cuda_allocator_virtual_memory_advise(
    iree_hal_allocator_t* IREE_RESTRICT base_allocator,
    iree_hal_buffer_t* IREE_RESTRICT virtual_buffer,
    iree_device_size_t virtual_offset, iree_device_size_t size,
...
static const iree_hal_allocator_vtable_t iree_hal_cuda_allocator_vtable = {
    ...
    .supports_virtual_memory = iree_hal_cuda_allocator_supports_virtual_memory,
    .virtual_memory_query_granularity =
        iree_hal_cuda_allocator_virtual_memory_query_granularity,
    .virtual_memory_reserve = iree_hal_cuda_allocator_virtual_memory_reserve,
    .virtual_memory_release = iree_hal_cuda_allocator_virtual_memory_release,
    .physical_memory_allocate =
        iree_hal_cuda_allocator_physical_memory_allocate,
    .physical_memory_free = iree_hal_cuda_allocator_physical_memory_free,
    .virtual_memory_map = iree_hal_cuda_allocator_virtual_memory_map,
    .virtual_memory_unmap = iree_hal_cuda_allocator_virtual_memory_unmap,
    .virtual_memory_protect = iree_hal_cuda_allocator_virtual_memory_protect,
    .virtual_memory_advise = iree_hal_cuda_allocator_virtual_memory_advise,
};
