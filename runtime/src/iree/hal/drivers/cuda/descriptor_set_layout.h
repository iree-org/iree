...
#ifndef IREE_HAL_DRIVERS_CUDA_DESCRIPTOR_SET_LAYOUT_H_
#define IREE_HAL_DRIVERS_CUDA_DESCRIPTOR_SET_LAYOUT_H_
...
#endif  // IREE_HAL_DRIVERS_CUDA_DESCRIPTOR_SET_LAYOUT_H_
