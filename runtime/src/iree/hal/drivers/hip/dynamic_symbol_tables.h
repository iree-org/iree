...
IREE_HAL_HIP_REQUIRED_PFN_DECL(hipGraphInstantiate, hipGraphExec_t*, hipGraph_t,
...
IREE_HAL_HIP_REQUIRED_PFN_DECL(hipLaunchHostFunc, hipStream_t, hipHostFn_t,
                               void*)
IREE_HAL_HIP_REQUIRED_PFN_DECL(hipLaunchKernel, const void*, dim3, dim3, void**,
                               size_t, hipStream_t)
...
IREE_HAL_HIP_OPTIONAL_PFN_DECL(hipExtModuleLaunchKernel, hipFunction_t,
                               unsigned int, unsigned int, unsigned int,
                               unsigned int, unsigned int, unsigned int, size_t,
