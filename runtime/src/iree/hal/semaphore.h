...
enum iree_hal_semaphore_flag_bits_t {
  ...
  // Semaphore can be exported using iree_hal_semaphore_export and
  // iree_hal_semaphore_export_timepoint. This may require significant internal
  // tracking and should only be used when interoperating with other APIs.
