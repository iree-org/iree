...
#define IREE_MPI_MAX(syms) ((IREE_MPI_Op)0x58000001)
#define IREE_MPI_MIN(syms) ((IREE_MPI_Op)0x58000002)
#define IREE_MPI_SUM(syms) ((IREE_MPI_Op)0x58000003)
#define IREE_MPI_PROD(syms) ((IREE_MPI_Op)0x58000004)
#define IREE_MPI_LAND(syms) ((IREE_MPI_Op)0x58000005)
#define IREE_MPI_BAND(syms) ((IREE_MPI_Op)0x58000006)
#define IREE_MPI_LOR(syms) ((IREE_MPI_Op)0x58000007)
#define IREE_MPI_BOR(syms) ((IREE_MPI_Op)0x58000008)
#define IREE_MPI_LXOR(syms) ((IREE_MPI_Op)0x58000009)
#define IREE_MPI_BXOR(syms) ((IREE_MPI_Op)0x5800000a)
#define IREE_MPI_MINLOC(syms) ((IREE_MPI_Op)0x5800000b)
#define IREE_MPI_MAXLOC(syms) ((IREE_MPI_Op)0x5800000c)
#define IREE_MPI_REPLACE(syms) ((IREE_MPI_Op)0x5800000d)
#define IREE_MPI_NO_OP(syms) ((IREE_MPI_Op)0x5800000e)
