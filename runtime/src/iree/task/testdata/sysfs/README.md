...
3. Register it in the `manifests` list of
   `//runtime/src/iree/task:expanded_sysfs_snapshots` in `BUILD.bazel` and in
   `_IREE_TASK_SYSFS_MANIFEST_NAMES` in the CMake mirror next to it
