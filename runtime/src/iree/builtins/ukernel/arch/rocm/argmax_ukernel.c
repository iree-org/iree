...
extern "C" __device__ void __iree_uk_rocm_argmax_F32I32(float *inputBuffer, size_t input_offset,
...
extern "C" __device__ void __iree_uk_rocm_argmax_F32I64(float *inputBuffer, size_t input_offset,
...
extern "C" __device__ void __iree_uk_rocm_argmax_F16I32(half* inputBuffer, size_t input_offset,
                                                int32_t *outputBuffer,
                                                size_t output_offset,
                                                size_t reductionSize, uint32_t flag) {
...
extern "C" __device__ void __iree_uk_rocm_argmax_F16I64(half* inputBuffer, size_t input_offset,
                                                int64_t *outputBuffer,
                                                size_t output_offset,
                                                size_t reductionSize, uint32_t flag) {
  half NEG_F16_MAX = __float2half(-65504.0f);
