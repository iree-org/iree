...
void iree_uk_mmt4d_tile_i8i8i32_8x8x8_arm_64_i8mm_inline_asm(
  ...
  asm("    // Do we accumulate into or clear the accumulator tile?         \n"
      "    tbnz %w[flags], %[accumulate_bit_pos], 1f                       \n"
      "                                                                    \n"
      "0:                                                                  \n"
      ...
      "    // Load rows 0--3.                                              \n"
      "    ldp q0, q1, [%[out_ptr], 0]                                     \n"
      "    ldp q2, q3, [%[out_ptr], 32]                                    \n"
      "    ldp q4, q5, [%[out_ptr], 64]                                    \n"
      "    ldp q6, q7, [%[out_ptr], 96]                                    \n"
      "    // Load rows 4--7.                                              \n"
      "    ldp q8, q9, [%[out_ptr], 128]                                   \n"
      "    ldp q10, q11, [%[out_ptr], 160]                                 \n"
      "    ldp q12, q13, [%[out_ptr], 192]                                 \n"
      "    ldp q14, q15, [%[out_ptr], 224]                                 \n"
      ...
      "    //                                                              \n"
      "    // Load 8x8 LHS tile                                            \n"
      "    ldp q0, q1, [%[lhs_ptr]], 32                                    \n"
      "    ldp q2, q3, [%[lhs_ptr]], 32                                    \n"
      "    // Load 8x8 RHS tile                                            \n"
      "    ldp q4, q5, [%[rhs_ptr]], 32                                    \n"
      "    ldp q6, q7, [%[rhs_ptr]], 32                                    \n"
      "    // Load 8x8 LHS tile                                            \n"
      "    ldp q8, q9, [%[lhs_ptr]], 32                                    \n"
      "    ldp q10, q11, [%[lhs_ptr]], 32                                  \n"
      "    // Load 8x8 RHS tile...                                         \n"
      "    ldp q12, q13, [%[rhs_ptr]], 32                                  \n"
      ...
      "    stp q0, q1, [%[out_ptr], 0]                                     \n"
      "    stp q2, q3, [%[out_ptr], 32]                                    \n"
      "    stp q4, q5, [%[out_ptr], 64]                                    \n"
      "    stp q6, q7, [%[out_ptr], 96]                                    \n"
      "    stp q8, q9, [%[out_ptr], 128]                                   \n"
      "    stp q10, q11, [%[out_ptr], 160]                                 \n"
      "    stp q12, q13, [%[out_ptr], 192]                                 \n"
      "    stp q14, q15, [%[out_ptr], 224]                                 \n"
