...
static void iree_uk_pack_tile_8x1_x8_x86_64_direct(
...
static void iree_uk_pack_tile_8x4_x8_x86_64_direct(
    void* IREE_UK_RESTRICT out_tile_ptr,
    const void* IREE_UK_RESTRICT in_tile_ptr, iree_uk_ssize_t outer_size1,
    iree_uk_ssize_t out_stride1, iree_uk_ssize_t in_stride0,
    iree_uk_ssize_t elem_size, iree_uk_ssize_t tile_size0,
...
static void iree_uk_pack_tile_8x1_x32_x86_64_direct(
    void* IREE_UK_RESTRICT out_tile_ptr,
    const void* IREE_UK_RESTRICT in_tile_ptr, iree_uk_ssize_t outer_size1,
    iree_uk_ssize_t out_stride1, iree_uk_ssize_t in_stride0,
    iree_uk_ssize_t elem_size, iree_uk_ssize_t tile_size0,
  ...
  IREE_UK_ASSERT(tile_size0 == 8);
  IREE_UK_ASSERT(tile_size1 == 1);
  iree_uk_pack_tile_8x4_x8_x86_64_direct(out_tile_ptr, in_tile_ptr, outer_size1,
                                         out_stride1 * 4, in_stride0 * 4, 1, 8,
                                         4);
}

static void iree_uk_pack_tile_8x8_x8_x86_64_direct(
    void* IREE_UK_RESTRICT out_tile_ptr,
    const void* IREE_UK_RESTRICT in_tile_ptr, iree_uk_ssize_t outer_size1,
    iree_uk_ssize_t out_stride1, iree_uk_ssize_t in_stride0,
    iree_uk_ssize_t elem_size, iree_uk_ssize_t tile_size0,
...
static void iree_uk_pack_tile_8x1_x32_x86_64_transpose(
    void* IREE_UK_RESTRICT out_tile_ptr,
    const void* IREE_UK_RESTRICT in_tile_ptr, iree_uk_ssize_t outer_size1,
    iree_uk_ssize_t out_stride1, iree_uk_ssize_t in_stride0,
    iree_uk_ssize_t elem_size, iree_uk_ssize_t tile_size0,
...
static void iree_uk_pack_tile_8x1_x8_x86_64_transpose(
    void* IREE_UK_RESTRICT out_tile_ptr,
    const void* IREE_UK_RESTRICT in_tile_ptr, iree_uk_ssize_t outer_size1,
    iree_uk_ssize_t out_stride1, iree_uk_ssize_t in_stride0,
    iree_uk_ssize_t elem_size, iree_uk_ssize_t tile_size0,
...
static void iree_uk_pack_tile_8x4_x8_x86_64_transpose(
    void* IREE_UK_RESTRICT out_tile_ptr,
    const void* IREE_UK_RESTRICT in_tile_ptr, iree_uk_ssize_t outer_size1,
    iree_uk_ssize_t out_stride1, iree_uk_ssize_t in_stride0,
    iree_uk_ssize_t elem_size, iree_uk_ssize_t tile_size0,
...
static void iree_uk_pack_tile_8x8_x8_x86_64_transpose(
    void* IREE_UK_RESTRICT out_tile_ptr,
    const void* IREE_UK_RESTRICT in_tile_ptr, iree_uk_ssize_t outer_size1,
    iree_uk_ssize_t out_stride1, iree_uk_ssize_t in_stride0,
    iree_uk_ssize_t elem_size, iree_uk_ssize_t tile_size0,
...
static void iree_uk_pack_tile_8x8_x32_x86_64_direct(
    void* IREE_UK_RESTRICT out_tile_ptr,
    const void* IREE_UK_RESTRICT in_tile_ptr, iree_uk_ssize_t outer_size1,
    iree_uk_ssize_t out_stride1, iree_uk_ssize_t in_stride0,
    iree_uk_ssize_t elem_size, iree_uk_ssize_t tile_size0,
...
iree_uk_pack_tile_func_t iree_uk_pack_select_tile_func_x86_64(
  ...
  if (esize == 4 && params->out_size2 == 8 && params->out_size3 == 8) {
    ...
    return transpose ? 0 : iree_uk_pack_tile_8x8_x32_x86_64_direct;
  } else if (esize == 4 && params->out_size2 == 8 && params->out_size3 == 1) {
    return transpose ? iree_uk_pack_tile_8x1_x32_x86_64_transpose
                     : iree_uk_pack_tile_8x1_x32_x86_64_direct;
  } else if (esize == 1 && params->out_size2 == 8 && params->out_size3 == 1) {
    return transpose ? iree_uk_pack_tile_8x1_x8_x86_64_transpose
                     : iree_uk_pack_tile_8x1_x8_x86_64_direct;
  } else if (esize == 1 && params->out_size2 == 8 && params->out_size3 == 4) {
    return transpose ? iree_uk_pack_tile_8x4_x8_x86_64_transpose
                     : iree_uk_pack_tile_8x4_x8_x86_64_direct;
  } else if (esize == 1 && params->out_size2 == 8 && params->out_size3 == 8) {
    return transpose ? iree_uk_pack_tile_8x8_x8_x86_64_transpose
                     : iree_uk_pack_tile_8x8_x8_x86_64_direct;
  }
#endif
  return 0;
}
