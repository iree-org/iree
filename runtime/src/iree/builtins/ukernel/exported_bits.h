...
// `mmt4d` ukernel-specific bits (bits 16..31).
#define IREE_UK_FLAG_MMT4D_FRACTAL_EXPERIMENTAL 0x10000u
#define IREE_UK_FLAG_MMT4D_FRACTAL_EXPERIMENTAL_BIT_POS 16
IREE_UK_ENSURE_CONSISTENT_FLAG(IREE_UK_FLAG_MMT4D_FRACTAL_EXPERIMENTAL);
