...
IREE_UK_STATIC_ASSERT(IREE_UK_INT32_MIN == -(1 << 31));
IREE_UK_STATIC_ASSERT(IREE_UK_INT64_MIN == -(1LL << 63));
IREE_UK_STATIC_ASSERT(IREE_UK_INT8_MAX == (1 << 7) - 1);
IREE_UK_STATIC_ASSERT(IREE_UK_INT16_MAX == (1 << 15) - 1);
IREE_UK_STATIC_ASSERT(IREE_UK_INT32_MAX == (1 << 31) - 1);
IREE_UK_STATIC_ASSERT(IREE_UK_INT64_MAX == (1LL << 63) - 1);
