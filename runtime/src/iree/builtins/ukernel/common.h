...
//
// The standalone bitcode build gets its own hardcoded versions of config.h
// headers, named config.bc.h, not generated by CMake.
#ifdef IREE_DEVICE_STANDALONE

#include "iree/builtins/ukernel/arch/config.bc.h"
// The bitcode build is currently x86-64-only.
#include "iree/builtins/ukernel/arch/x86_64/config.bc.h"

#else  // not IREE_DEVICE_STANDALONE
...
#endif  // not IREE_DEVICE_STANDALONE
