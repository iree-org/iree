...
int main(int argc, char** argv) {
  ...
  iree_uk_test_mmt4d(iree_uk_mmt4d_type_f32f32f32, 8, 8, 1, cpu_avx2_fma);
  iree_uk_test_mmt4d(iree_uk_mmt4d_type_f32f32f32, 16, 16, 1, cpu_avx512_base);
  iree_uk_test_mmt4d(iree_uk_mmt4d_type_i8i8i32, 8, 4, 2, NULL);  // SSE2
  iree_uk_test_mmt4d(iree_uk_mmt4d_type_i8i8i32, 8, 8, 2, cpu_avx2_fma);
  iree_uk_test_mmt4d(iree_uk_mmt4d_type_i8i8i32, 16, 16, 2, cpu_avx512_base);
  iree_uk_test_mmt4d(iree_uk_mmt4d_type_i8i8i32, 16, 16, 2, cpu_avx512_vnni);
