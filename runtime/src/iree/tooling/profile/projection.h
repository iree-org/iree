...
#ifndef IREE_TOOLING_PROFILE_PROJECTION_H_
#define IREE_TOOLING_PROFILE_PROJECTION_H_
...
// Reads a profile bundle from |path| and writes the selected projection report.
...
#endif  // IREE_TOOLING_PROFILE_PROJECTION_H_
