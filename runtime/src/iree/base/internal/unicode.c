...
// Category range table: sorted array of {start, end, category} entries.
...
// Whitespace codepoints (derived White_Space property).
extern const uint32_t iree_unicode_whitespace_codepoints[];
extern const iree_host_size_t iree_unicode_whitespace_count;

// Control character range (Cc category): 0x0000-0x001F and 0x007F-0x009F.
// Handled inline, no table needed.

// Case mapping table: sorted array of {codepoint, lowercase, uppercase}
// entries.
...
// NFD base character table: sorted array of {codepoint, base} entries.
