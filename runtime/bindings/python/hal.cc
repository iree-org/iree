...
void SetupHalBindings(nanobind::module_ m) {
  ...
  hal_element_type.value("NONE", IREE_HAL_ELEMENT_TYPE_NONE)
      ...
      .value("FLOAT_6_E3M2_FN", IREE_HAL_ELEMENT_TYPE_FLOAT_6_E3M2_FN)
      .value("FLOAT_6_E2M3_FN", IREE_HAL_ELEMENT_TYPE_FLOAT_6_E2M3_FN)
      .value("FLOAT_4_E3M1_FN", IREE_HAL_ELEMENT_TYPE_FLOAT_4_E2M1_FN)
      .export_values()
      .def("__int__",
