...
// CHECK-NEXT:    [[PTR:%.+]] = flow.variable.address @__iree_flow_v : !util.ptr<tensor<?xf32>>
// CHECK-NEXT:    flow.variable.store.indirect %arg0, [[PTR]] : tensor<?xf32> -> !util.ptr<tensor<?xf32>>
// CHECK-NEXT:    return
