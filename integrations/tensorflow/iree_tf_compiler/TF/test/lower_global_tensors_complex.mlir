...
// CHECK-NEXT:   [[PTR:%.+]] = flow.variable.address [[V]] : !util.ptr<tensor<?xf32>>
// CHECK-NEXT:   br ^bb1([[PTR]] : !util.ptr<tensor<?xf32>>)
// CHECK-NEXT: ^bb1([[PTR1:%.+]]: !util.ptr<tensor<?xf32>>):   // pred: ^bb0
// CHECK-NEXT:   flow.variable.store.indirect %arg0, [[PTR1]] : tensor<?xf32> -> !util.ptr<tensor<?xf32>>
// CHECK-NEXT:   return
...
// CHECK-NEXT:   [[PTR0:%.+]] = flow.variable.address [[V]] : !util.ptr<tensor<?xf32>>
// CHECK-NEXT:   [[PTR1:%.+]] = flow.variable.address [[V1]] : !util.ptr<tensor<?xf32>>
...
// CHECK-NEXT:   [[T:%.+]] = flow.variable.load.indirect [[PTR]] : !util.ptr<tensor<?xf32>> -> tensor<?xf32>
...
// CHECK-NEXT:   flow.variable.store.indirect %arg0, [[PTR0]] : tensor<?xf32> -> !util.ptr<tensor<?xf32>>
