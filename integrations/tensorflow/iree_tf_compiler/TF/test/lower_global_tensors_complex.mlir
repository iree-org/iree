...
// CHECK-NEXT:   br ^bb1([[PTR]] : !iree_input.ptr<tensor<?xf32>>)
...
// CHECK-NEXT:   cond_br %[[FALSE]], ^bb1([[PTR0]] : !iree_input.ptr<tensor<?xf32>>), ^bb1([[PTR1]] : !iree_input.ptr<tensor<?xf32>>)
...
// CHECK:      func @f(%arg0: tensor<?xf32> {tf_saved_model.index_path = [0]}) attributes {tf_saved_model.exported_names = ["f"]} {
// CHECK-NEXT:   [[PTR:%.+]] = iree_input.global.address [[V]] : !iree_input.ptr<tensor<?xf32>>
// CHECK-NEXT:   br ^bb1([[PTR]], [[PTR]], [[PTR]] : !iree_input.ptr<tensor<?xf32>>, !iree_input.ptr<tensor<?xf32>>, !iree_input.ptr<tensor<?xf32>>)
...
// CHECK-NEXT:   br ^bb1([[PTR1]], [[PTR2]], [[PTR0]] : !iree_input.ptr<tensor<?xf32>>, !iree_input.ptr<tensor<?xf32>>, !iree_input.ptr<tensor<?xf32>>)
