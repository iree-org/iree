// RUN: iree-tf-opt --split-input-file --verify-diagnostics --pass-pipeline='builtin.module(iree-tf-strip-module-metadata,func.func(iree-tf-strip-function-metadata))' %s | FileCheck %s
