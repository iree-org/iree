...
func.func @scatter_update_scalar_1D(
  ...
  iree_linalg_ext.scatter dimension_map(dense<0> : tensor<1xi64>) unique_indices(true)
...
func.func @scatter_add_scalar_2D(
    ...
    %updates: memref<3xi32>) {
  iree_linalg_ext.scatter dimension_map(dense<[0, 1]> : tensor<2xi64>) unique_indices(true)
...
func.func @scatter_partial_slices(%arg0: memref<2x64x12xf32>, %arg1: memref<2x3xi32>, %arg2: memref<2x1x12xf32>) {
  iree_linalg_ext.scatter
    dimension_map(dense<[0, 1, 2]> : tensor<3xi64>)
    unique_indices(true)
