...
// SINGLE:           %[[D1:.*]] = tensor.empty(3, 3) : tensor<3x3xf32>
// SINGLE:           %[[D2:.*]] = tensor.empty(3, 3) : tensor<3x3xi32>
...
// MULTIPLE:           %[[D1:.*]] = tensor.empty(3, 10, 4, 4, 8) : tensor<3x10x4x4x8xf32>
// MULTIPLE:           %[[D2:.*]] = tensor.empty(3, 10, 4, 4, 8) : tensor<3x10x4x4x8xi32>
...
// DOUBLE:           %[[D1:.*]] = tensor.empty(40, 3) : tensor<40x3xf32>
// DOUBLE:           %[[D2:.*]] = tensor.empty(40, 3) : tensor<40x3xi32>
...
// DOUBLE:           %[[D11:.*]] = tensor.empty(10, 3) : tensor<10x3xf32>
// DOUBLE:           %[[D12:.*]] = tensor.empty(10, 3) : tensor<10x3xi32>
