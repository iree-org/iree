...
ZE_PFN_DECL(zeEventPoolCreate, ze_context_handle_t,
            const ze_event_pool_desc_t *, uint32_t, ze_device_handle_t *,
            ze_event_pool_handle_t *)
ZE_PFN_DECL(zeEventCreate, ze_event_pool_handle_t, const ze_event_desc_t *,
            ze_event_handle_t *)
...
ZE_PFN_DECL(zeCommandListAppendSignalEvent, ze_command_list_handle_t,
            ze_event_handle_t)
ZE_PFN_DECL(zeCommandListAppendWaitOnEvents, ze_command_list_handle_t, uint32_t,
            ze_event_handle_t *)
ZE_PFN_DECL(zeCommandListAppendEventReset, ze_command_list_handle_t,
            ze_event_handle_t)
