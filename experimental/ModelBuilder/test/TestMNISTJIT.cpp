...
// CHECK-SAME:   ins(%{{[a-z0-9]*}}, %{{[a-z0-9]*}} : tensor<?x784xf32>,
// tensor<784x256xf32>) CHECK-SAME:   init(%{{[a-z0-9]*}} : tensor<?x256xf32>)
...
// Matmul
// CHECK: linalg.generic
// CHECK-SAME:   ins(%{{[a-z0-9]*}}, %{{[a-z0-9]*}} : tensor<?x256xf32>,
// tensor<256x256xf32>) CHECK-SAME:   init(%{{[a-z0-9]*}} : tensor<?x256xf32>)
// CHECK:   -> tensor<?x256xf32>
//
// Pointwise
// CHECK: linalg.generic
// CHECK-SAME:   ins(%{{[a-z0-9]*}}, %{{[a-z0-9]*}} : tensor<?x256xf32>,
// tensor<256xf32>) CHECK:   -> tensor<?x256xf32>
//
// Matmul
// CHECK: linalg.generic
// CHECK-SAME:   ins(%{{[a-z0-9]*}}, %{{[a-z0-9]*}} : tensor<?x256xf32>,
// tensor<256x10xf32>) CHECK-SAME:   init(%{{[a-z0-9]*}} : tensor<?x10xf32>)
// CHECK:   -> tensor<?x10xf32>
//
// Pointwise
// CHECK: linalg.generic
// CHECK-SAME:   ins(%{{[a-z0-9]*}}, %{{[a-z0-9]*}} : tensor<?x10xf32>,
// tensor<10xf32>) CHECK:   -> tensor<?x10xf32> CHECK:   return {{.*}} :
// tensor<?x10xf32>
