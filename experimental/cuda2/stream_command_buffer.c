...
static iree_hal_cuda2_stream_command_buffer_t*
iree_hal_cuda2_stream_command_buffer_cast(
    iree_hal_command_buffer_t* base_value) {
  IREE_HAL_ASSERT_TYPE(base_value,
                       &iree_hal_cuda2_stream_command_buffer_vtable);
  return (iree_hal_cuda2_stream_command_buffer_t*)base_value;
}
...
static void iree_hal_cuda2_stream_command_buffer_destroy(
...
static iree_status_t iree_hal_cuda2_stream_command_buffer_flush_collectives(
    iree_hal_cuda2_stream_command_buffer_t* command_buffer) {
...
static iree_status_t iree_hal_cuda2_stream_command_buffer_begin(
    iree_hal_command_buffer_t* base_command_buffer) {
  iree_hal_cuda2_stream_command_buffer_t* command_buffer =
      iree_hal_cuda2_stream_command_buffer_cast(base_command_buffer);
  (void)command_buffer;
...
static iree_status_t iree_hal_cuda2_stream_command_buffer_end(
    iree_hal_command_buffer_t* base_command_buffer) {
  iree_hal_cuda2_stream_command_buffer_t* command_buffer =
      iree_hal_cuda2_stream_command_buffer_cast(base_command_buffer);
  IREE_TRACE_ZONE_BEGIN(z0);
...
static void iree_hal_cuda2_stream_command_buffer_begin_debug_group(
...
static void iree_hal_cuda2_stream_command_buffer_end_debug_group(
    iree_hal_command_buffer_t* base_command_buffer) {
  iree_hal_cuda2_stream_command_buffer_t* command_buffer =
      iree_hal_cuda2_stream_command_buffer_cast(base_command_buffer);
  (void)command_buffer;
...
static iree_status_t iree_hal_cuda2_stream_command_buffer_fill_buffer(
    iree_hal_command_buffer_t* base_command_buffer,
...
static iree_status_t iree_hal_cuda2_stream_command_buffer_update_buffer(
...
static iree_status_t iree_hal_cuda2_stream_command_buffer_copy_buffer(
    iree_hal_command_buffer_t* base_command_buffer,
...
static iree_status_t iree_hal_cuda2_stream_command_buffer_collective(
...
static iree_status_t iree_hal_cuda2_stream_command_buffer_dispatch(
    iree_hal_command_buffer_t* base_command_buffer,
...
static iree_status_t iree_hal_cuda2_stream_command_buffer_dispatch_indirect(
    iree_hal_command_buffer_t* base_command_buffer,
    iree_hal_executable_t* executable, int32_t entry_point,
...
static iree_status_t iree_hal_cuda2_stream_command_buffer_execute_commands(
    iree_hal_command_buffer_t* base_command_buffer,
...
static const iree_hal_command_buffer_vtable_t
    iree_hal_cuda2_stream_command_buffer_vtable = {
        .destroy = iree_hal_cuda2_stream_command_buffer_destroy,
        .begin = iree_hal_cuda2_stream_command_buffer_begin,
        .end = iree_hal_cuda2_stream_command_buffer_end,
        .begin_debug_group =
        ...
        .execution_barrier =
            iree_hal_cuda2_stream_command_buffer_execution_barrier,
        .signal_event = iree_hal_cuda2_stream_command_buffer_signal_event,
        .reset_event = iree_hal_cuda2_stream_command_buffer_reset_event,
        .wait_events = iree_hal_cuda2_stream_command_buffer_wait_events,
        .discard_buffer = iree_hal_cuda2_stream_command_buffer_discard_buffer,
        .fill_buffer = iree_hal_cuda2_stream_command_buffer_fill_buffer,
        .update_buffer = iree_hal_cuda2_stream_command_buffer_update_buffer,
        .copy_buffer = iree_hal_cuda2_stream_command_buffer_copy_buffer,
        .collective = iree_hal_cuda2_stream_command_buffer_collective,
        .push_constants = iree_hal_cuda2_stream_command_buffer_push_constants,
        .push_descriptor_set =
            iree_hal_cuda2_stream_command_buffer_push_descriptor_set,
        .dispatch = iree_hal_cuda2_stream_command_buffer_dispatch,
        .dispatch_indirect =
            iree_hal_cuda2_stream_command_buffer_dispatch_indirect,
        .execute_commands =
            iree_hal_cuda2_stream_command_buffer_execute_commands,
};
