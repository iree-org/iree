...
#include "experimental/rocm/Conversion/LinalgToROCDL/KernelConfig.h"
...
struct TileAndDistributeToThreads
  ...
  void runOnOperation() override {
    ...
    for (FuncOp funcOp : module.getOps<FuncOp>()) {
      ...
      auto config = getROCMLaunchConfig(context, dependenceGraph, linalgOps);
      ...
      funcOp->setAttr("rocm_workgroup_size",
...
static PassRegistration<TileAndDistributeToThreads> pass(
    "iree-codegen-rocm-tile-and-distribute",
