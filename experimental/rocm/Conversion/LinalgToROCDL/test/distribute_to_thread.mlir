// RUN: iree-opt-rocm -split-input-file  -pass-pipeline="hal.executable(hal.executable.target(iree-codegen-rocm-tile-and-distribute))" %s | IreeFileCheck %s
...
//  CHECK-SAME: rocm_workgroup_size = dense<[32, 1, 1]>
