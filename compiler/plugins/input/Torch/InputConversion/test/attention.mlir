...
// CHECK-SAME:         %[[ARG0:.*]]: tensor<5x2x3x4xf32>, %[[ARG1:.*]]: tensor<5x2x3x4xf32>, %[[ARG2:.*]]: tensor<5x2x3x4xf32>, %[[ARG3:.*]]: tensor<5x2x3x4xf32>) -> tensor<5x2x3x4xf32> {
...
// CHECK-LABEL:         func.func @attention(
// CHECK-SAME:         %[[ARG0:.*]]: tensor<1x3x4xf32>, %[[ARG1:.*]]: tensor<1x3x4xf32>, %[[ARG2:.*]]: tensor<1x3x4xf32>, %[[ARG3:.*]]: tensor<1x3x4xf32>
...
// -----
func.func @attention(%arg0: tensor<5x2x3x16xf32>, %arg1: tensor<5x2x3x16xf32>, %arg2: tensor<5x2x3x16xf32>, %arg3: tensor<5x2x3x16xf32>) -> (tensor<5x2x3x16xf32>) {
  %0 = tm_tensor.attention ins(%arg0, %arg1, %arg2 : tensor<5x2x3x16xf32>, tensor<5x2x3x16xf32>, tensor<5x2x3x16xf32>) outs(%arg3: tensor<5x2x3x16xf32>) -> tensor<5x2x3x16xf32>
...
// CHECK-LABEL:         func.func @attention(
// CHECK-SAME:         %[[ARG0:.*]]: tensor<5x2x3x16xf32>, %[[ARG1:.*]]: tensor<5x2x3x16xf32>, %[[ARG2:.*]]: tensor<5x2x3x16xf32>,, %[[ARG3:.*]]: tensor<5x2x3x16xf32>
// CHECK:         %arg3: tensor<5x2x3x16xf32>) -> tensor<5x2x3x16xf32> {
// CHECK:         %[[SCALE:.*]] = arith.constant 2.500000e-01 : f32
// CHECK:         %[[EMPTY:.*]] = tensor.empty() : tensor<5x2x3x16xf32>
// CHECK:         %[[ATTN:.*]] = iree_linalg_ext.attention {indexing_maps = [#[[$MAP_Q]], #[[$MAP_K]], #[[$MAP_V]], #[[$MAP_O]]]} ins(%[[ARG0]], %[[ARG1]], %[[ARG2]], %[[SCALE]] : tensor<5x2x3x16xf32>, tensor<5x2x3x16xf32>, tensor<5x2x3x16xf32>, f32) outs(%[[EMPTY]] : tensor<5x2x3x16xf32>) -> tensor<5x2x3x16xf32>
