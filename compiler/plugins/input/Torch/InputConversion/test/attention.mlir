...
// CHECK:         %[[SCALED_Q:.*]] = linalg.generic
// CHECK-SAME:         ins(%[[CST]] : f32) outs(%[[ARG0]] :
// CHECK:           arith.mulf
// CHECK:         %[[ATTN:.*]] = iree_linalg_ext.attention {indexing_maps = [#[[$MAP_Q]], #[[$MAP_K]], #[[$MAP_V]], #[[$MAP_O]]]} ins(%[[SCALED_Q]], %[[ARG1]], %[[ARG2]] : tensor<5x2x3x4xf32>, tensor<5x2x3x4xf32>, tensor<5x2x3x4xf32>) outs(%[[EMPTY]] : tensor<5x2x3x4xf32>) {
...
// CHECK-SAME:         ins(%[[CST]] : f32) outs(%[[ARG0]] :
// CHECK:           arith.mulf
// CHECK:         %[[ATTN:.*]] = iree_linalg_ext.attention {indexing_maps = [#[[$MAP_Q]], #[[$MAP_K]], #[[$MAP_V]], #[[$MAP_O]]]} ins(%[[SCALED_Q]], %[[ARG1]], %[[ARG2]] : tensor<5x2x8x4xf32>, tensor<5x2x3x4xf32>, tensor<5x2x3x4xf32>) outs(%[[EMPTY]] : tensor<5x2x8x4xf32>) {
// CHECK:    ^[[BLOCK:.+]](%[[SCORE:.+]]: f32):
// CHECK:         linalg_ext.yield %[[SCORE]]
...
// CHECK-SAME:         ins(%[[CST]] : f32) outs(%[[ARG0]] :
// CHECK:           arith.mulf
// CHECK:         %[[ATTN:.*]] = iree_linalg_ext.attention {indexing_maps = [#[[$MAP_Q]], #[[$MAP_K]], #[[$MAP_V]], #[[$MAP_O]]]} ins(%[[SCALED_Q]], %[[ARG1]], %[[ARG2]] : tensor<1x3x4xf32>, tensor<1x3x4xf32>, tensor<1x3x4xf32>) outs(%[[EMPTY]] : tensor<1x3x4xf32>) {
// CHECK:    ^[[BLOCK:.+]](%[[SCORE:.+]]: f32):
// CHECK:         linalg_ext.yield %[[SCORE]]
...
// CHECK-SAME:         ins(%[[CST]] : f32) outs(%[[ARG0]] :
// CHECK:           arith.mulf
// CHECK:         %[[ATTN:.*]] = iree_linalg_ext.attention {indexing_maps = [#[[$MAP_Q]], #[[$MAP_K]], #[[$MAP_V]], #[[$MAP_O]]]} ins(%[[SCALED_Q]], %[[ARG1]], %[[ARG2]] : tensor<?x?x4xf32>, tensor<?x?x4xf32>, tensor<?x?x4xf32>) outs(%[[EMPTY]] : tensor<?x?x4xf32>) {
// CHECK:    ^[[BLOCK:.+]](%[[SCORE:.+]]: f32):
// CHECK:         linalg_ext.yield %[[SCORE]]
