...
// CHECK-DAG: #[[$MAP_M:.+]] = affine_map<(d0, d1, d2, d3, d4, d5) -> (d0, d1, d2, d4)>
...
// CHECK:         %[[ATTN:.*]] = iree_linalg_ext.attention {indexing_maps = [#[[$MAP_Q]], #[[$MAP_K]], #[[$MAP_V]], #[[$MAP_M]], #[[$MAP_O]]]} ins(%[[ARG0]], %[[ARG1]], %[[ARG2]], %[[SCALE]], %[[ARG3]] : tensor<5x2x3x16xf32>, tensor<5x2x3x16xf32>, tensor<5x2x3x16xf32>, f32, tensor<3x3xf32>) outs(%[[EMPTY]] : tensor<5x2x3x16xf32>) -> tensor<5x2x3x16xf32>
