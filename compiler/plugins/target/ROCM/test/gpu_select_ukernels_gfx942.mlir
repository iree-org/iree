// RUN: iree-opt --split-input-file --iree-gpu-test-target=gfx942 --pass-pipeline="builtin.module(func.func(iree-codegen-gpu-select-ukernels,cse,canonicalize))" %s | FileCheck %s
...
//  CHECK-SAME: ukernel = #iree_codegen.ukernel_spec<name = "iree_uk_amdgpu_argmax_f32i64", def_attrs = {vm.import.module = "rocm"}>
...
//   CHECK-NOT: ukernel = #iree_codegen.ukernel_spec
