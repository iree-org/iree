...
transform.named_sequence
@match_mmt_f16_f16_f32_expanded_ge_4k(%matmul: !transform.any_op {transform.readonly})
  -> (!transform.any_op, !transform.any_param) {
  ...
  // TODO(qedawkins): Support > 2d
  transform.iree.match.cast_compatible_type %lhs = tensor<?x?x?xf16> : !transform.any_value
  transform.iree.match.cast_compatible_type %rhs = tensor<?x?xf16> : !transform.any_value
...
transform.named_sequence
@match_mmt_f8_f8_f32_expanded_ge_4k(%matmul: !transform.any_op {transform.readonly})
  -> (!transform.any_op, !transform.any_param) {
  ...
  // TODO(qedawkins): Support > 2d
  transform.iree.match.cast_compatible_type %lhs = tensor<?x?x?xf8E4M3FNUZ> : !transform.any_value
  transform.iree.match.cast_compatible_type %rhs = tensor<?x?xf8E4M3FNUZ> : !transform.any_value
...
transform.named_sequence
@match_mmt_f16_f16_f32_medium_expanded_ge_4k(%matmul: !transform.any_op {transform.readonly})
  -> (!transform.any_op, !transform.any_param) {
...
@__kernel_config(%variant_op: !transform.any_op {transform.consumed}) -> !transform.any_op
  ...
  %res = transform.foreach_match in %variant_op
    @match_mmt_f16_f16_f32_expanded_ge_4k -> @apply_expanded_pingpong_op_config,
    @match_mmt_f16_f16_f32_medium_expanded_ge_4k -> @apply_expanded_medium_pingpong_op_config,
    @match_mmt_f8_f8_f32_expanded_ge_4k -> @apply_expanded_f8_pingpong_op_config,
