...
`runtime/src/iree/builtins/ukernel/` — see the design pillars below for the
differences. The two coexist; this directory is purely additive.
...
In particular, this is a **lower-level interface than the legacy
`mmt4d` ukernels**:
