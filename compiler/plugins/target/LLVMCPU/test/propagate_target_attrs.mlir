// RUN: iree-opt --split-input-file --pass-pipeline='builtin.module(hal.executable(hal.executable.variant(iree-llvmcpu-target-test-propagate-target-attrs)))' %s -o - | FileCheck %s
