// RUN: iree-opt --pass-pipeline="builtin.module(iree-dispatch-creation-hoist-encoding-ops,cse)" --iree-dispatch-creation-experimental-no-hoist-data-operands-scaled-mma --split-input-file %s | FileCheck %s
// With --iree-dispatch-creation-experimental-no-hoist-data-operands-scaled-mma, only scale operands (indices 2, 3) of
...
// CHECK-DAG:   %[[ENC_RS:.+]] = iree_encoding.set_encoding %[[RS]]
// CHECK:       flow.dispatch.region
// CHECK:         iree_encoding.set_encoding %[[LHS]]
// CHECK:         iree_encoding.set_encoding %[[RHS]]
