...
// CHECK:        %[[DISPATCH:.+]] = flow.dispatch.workgroups(%[[CST]])
// CHECK:          %[[SRC:.+]] = flow.dispatch.tensor.load
// CHECK:          %[[ENCODED_SRC:.+]] = iree_encoding.set_encoding %[[SRC]] : tensor<513x1023xf32> -> tensor<513x1023xf32, #[[RHS_ENCODING]]>
// CHECK:          flow.dispatch.tensor.store %[[ENCODED_SRC]]
// CHECK-NEXT:     flow.return
// CHECK:        util.global.store %[[DISPATCH]], @[[HOISTED]]
