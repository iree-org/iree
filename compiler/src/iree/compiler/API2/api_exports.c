...
extern void ireeCompilerOutputCreate();
...
extern void ireeCompilerRunCreate();
extern void ireeCompilerRunDestroy();
extern void ireeCompilerRunEnableConsoleDiagnostics();
extern void ireeCompilerRunLldMain();
extern void ireeCompilerRunMain();
extern void ireeCompilerRunOutputHALExecutable();
extern void ireeCompilerRunOutputIR();
extern void ireeCompilerRunOutputVMBytecode();
extern void ireeCompilerRunOutputVMCSource();
extern void ireeCompilerRunParseSource();
extern void ireeCompilerRunPipeline();
extern void ireeCompilerRunSetCompileToPhase();
extern void ireeCompilerRunSetVerifyIR();
extern void ireeCompilerSessionCreate();
extern void ireeCompilerSessionDestroy();
extern void ireeCompilerSourceCreate();
...
uintptr_t __iree_compiler_hidden_force_extern() {
  ...
  x += (uintptr_t)&ireeCompilerOutputCreate;
  ...
  x += (uintptr_t)&ireeCompilerRunCreate;
  x += (uintptr_t)&ireeCompilerRunDestroy;
  x += (uintptr_t)&ireeCompilerRunEnableConsoleDiagnostics;
  x += (uintptr_t)&ireeCompilerRunLldMain;
  x += (uintptr_t)&ireeCompilerRunMain;
  x += (uintptr_t)&ireeCompilerRunOutputHALExecutable;
  x += (uintptr_t)&ireeCompilerRunOutputIR;
  x += (uintptr_t)&ireeCompilerRunOutputVMBytecode;
  x += (uintptr_t)&ireeCompilerRunOutputVMCSource;
  x += (uintptr_t)&ireeCompilerRunParseSource;
  x += (uintptr_t)&ireeCompilerRunPipeline;
  x += (uintptr_t)&ireeCompilerRunSetCompileToPhase;
  x += (uintptr_t)&ireeCompilerRunSetVerifyIR;
  x += (uintptr_t)&ireeCompilerSessionCreate;
  x += (uintptr_t)&ireeCompilerSessionDestroy;
  x += (uintptr_t)&ireeCompilerSourceCreate;
