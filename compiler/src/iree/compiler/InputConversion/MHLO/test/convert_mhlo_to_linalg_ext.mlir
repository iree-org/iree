...
// CHECK-DAG:    %[[INIT_TENSOR:.+]] = tensor.empty(8) : tensor<8xf32>
...
// CHECK-SAME:   %[[REAL:[a-zA-Z0-9]+]]
// CHECK-DAG:    %[[INDICES:.+]] = arith.constant dense<[0, 4, 2, 6, 1, 5, 3, 7]> : tensor<8xi32>
// CHECK-DAG:    %[[INIT_TENSOR:.+]] = tensor.empty(4, 8) : tensor<4x8xf32>
// CHECK:        %[[REORDERED:.+]] = linalg.generic
...
// CHECK:        %[[INIT:.+]] = tensor.empty(3, 5) : tensor<3x5xi32>
...
// CHECK-SAME:   %[[ARG0:[a-zA-Z0-9]+]]
// CHECK:        %[[D2:.+]] = tensor.empty(16, 8) : tensor<16x8xi32>
// CHECK:        %[[D3:.+]] = tensor.empty(16, 8) : tensor<16x8xi32>
...
// CHECK-SAME:   %[[ARG0:[a-zA-Z0-9]+]]
// CHECK:        %[[D2:.+]] = tensor.empty(16, 8) : tensor<16x8xf32>
// CHECK:        %[[D3:.+]] = tensor.empty(16, 8) : tensor<16x8xi32>
