...
// CHECK-SAME:      %[[ARG0:[a-zA-Z0-9]+]]
// CHECK-SAME:  )
// CHECK:         %[[CAST:.+]] = util.reinterpret %[[ARG0]] : tensor<128xui32> to tensor<128xi32>
// CHECK:         %[[SORT:.+]] = iree_linalg_ext.sort
// CHECK-SAME:      dimension(0)
...
// CHECK:             iree_linalg_ext.yield %[[CMP]]
// CHECK:         %[[RESULT:.+]] = util.reinterpret %[[SORT]] : tensor<128xi32> to tensor<128xui32>
// CHECK:         return %[[RESULT]]
...
// CHECK:         %[[CONVERSION_CAST_CST:.+]] = util.reinterpret %[[UI32]] : tensor<ui32> to tensor<i32>
