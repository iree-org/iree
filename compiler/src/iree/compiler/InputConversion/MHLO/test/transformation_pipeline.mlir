...
// CHECK-NEXT:     %0 = tensor.empty(4) : tensor<4xf32>
...
// CHECK-NEXT:     %2 = tensor.empty(4) : tensor<4xf32>
...
// CHECK-NEXT:       linalg.yield %6 : f32
// CHECK-NEXT:     } -> tensor<4xf32>
// CHECK-NEXT:     %4 = tensor.empty(4) : tensor<4xf32>
...
// CHECK-NEXT:     %0 = tensor.empty(4, 4) : tensor<4x4xf32>
...
// CHECK-NEXT:     %2 = tensor.empty(4, 4) : tensor<4x4xf32>
...
// CHECK-NEXT:     %5 = tensor.empty(4, 4) : tensor<4x4xf32>
