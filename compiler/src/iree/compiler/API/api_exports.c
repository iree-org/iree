...
extern void ireeGPULoweringConfigAttrGetReductionTileSizes();
extern void ireeGPULoweringConfigAttrGetWorkgroupTileSizes();
extern void ireeGPULoweringConfigAttrGetSubgroupMCount();
extern void ireeGPULoweringConfigAttrGetSubgroupNCount();
...
uintptr_t __iree_compiler_hidden_force_extern() {
  ...
  x += (uintptr_t)&ireeGPULoweringConfigAttrGetReductionTileSizes;
  x += (uintptr_t)&ireeGPULoweringConfigAttrGetWorkgroupTileSizes;
  x += (uintptr_t)&ireeGPULoweringConfigAttrGetSubgroupMCount;
  x += (uintptr_t)&ireeGPULoweringConfigAttrGetSubgroupNCount;
