...
extern void ireeCodegenOneOfKnobAttrGetNumOptions();
extern void ireeCodegenOneOfKnobAttrGetOption();
...
uintptr_t __iree_compiler_hidden_force_extern() {
  ...
  x += (uintptr_t)&ireeCodegenOneOfKnobAttrGetNumOptions;
  x += (uintptr_t)&ireeCodegenOneOfKnobAttrGetOption;
