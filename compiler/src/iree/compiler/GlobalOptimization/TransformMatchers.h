...
#ifndef IREE_COMPILER_GLOBALOPTIMIZATION_TRANSFORMMATCHERS_H_
#define IREE_COMPILER_GLOBALOPTIMIZATION_TRANSFORMMATCHERS_H_
...
#endif // IREE_COMPILER_GLOBALOPTIMIZATION_TRANSFORMMATCHERS_H_
