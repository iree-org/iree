...
func.func @warp_reduction_dispatch() attributes {hal.executable.target = #executable_target_cuda} {
...
//         CHECK:      vector.insert_strided_slice %[[V]], {{.*}} : vector<1x4xf32> into vector<1x1x1x1x1x4xf32>
//         CHECK:      %[[REDUCE:.+]] = vector.multi_reduction <add>, {{.*}}, %[[CST_ACC]] [2, 5, 8] : vector<1x1x1x1x1x1x1x1x4xf32> to vector<1x1x1x1x1x1xf32>
...
func.func @warp_reduction_broadcast_dispatch() attributes {hal.executable.target = #executable_target_cuda} {
...
func.func @softmax() attributes {hal.executable.target = #executable_target_cuda} {
...
//         CHECK:      vector.transfer_read {{.*}} : memref<12x128x40960xf32, {{.*}}>, vector<1x1x4xf32>
...
func.func @softmax_singlesubgroup() attributes {hal.executable.target = #executable_target_cuda} {
  %c0 = arith.constant 0 : index
...
//         CHECK:    scf.for {{.*}} -> (vector<1x1x1x1x1x1x1x1x1xf32>) {
//         CHECK:      vector.transfer_read {{.*}} : memref<12x256x40960xf32, {{.*}}>, vector<1x1x4xf32>
//         CHECK:      vector.multi_reduction <maxnumf>, {{.*}} {{.*}} : vector<1x1x1x1x1x1x1x1x1x1x1x4xf32> to vector<1x1x1x1x1x1x1x1x1xf32>
//         CHECK:      arith.maxnumf {{.*}} : vector<1x1x1x1x1x1x1x1x1xf32>
//         CHECK:      scf.yield
//         CHECK:    gpu.subgroup_reduce maxnumf
...
func.func @small_reduction() attributes {hal.executable.target = #executable_target_cuda} {
  %c0 = arith.constant 0 : index
...
func.func @group_reduction() attributes {hal.executable.target = #executable_target_cuda} {
  %c0 = arith.constant 0 : index
  %cst = arith.constant -0.000000e+00 : f32
...
func.func @group_elementwise_reduction_elementwise() attributes {hal.executable.target = #executable_target_cuda} {
  %c0 = arith.constant 0 : index
  %cst = arith.constant -0.000000e+00 : f32
  %0 = hal.interface.binding.subspan layout(#pipeline_layout) binding(0) alignment(64) offset(%c0) : !iree_tensor_ext.dispatch.tensor<readonly:tensor<8x64xf32>>
  %1 = hal.interface.binding.subspan layout(#pipeline_layout) binding(1) alignment(64) offset(%c0) : !iree_tensor_ext.dispatch.tensor<writeonly:tensor<8xf32>>
...
func.func @group_reduction_larger() attributes {hal.executable.target = #executable_target_cuda} {
  %c0 = arith.constant 0 : index
  %cst = arith.constant -0.000000e+00 : f32
...
func.func @group_reduction_1d() attributes {hal.executable.target = #executable_target_cuda} {
  %c0 = arith.constant 0 : index
  %cst = arith.constant -0.000000e+00 : f32
...
func.func @group_elementwise_reduction_elementwise_4d() attributes {hal.executable.target = #executable_target_cuda} {
  %c0 = arith.constant 0 : index
  %cst = arith.constant -0.000000e+00 : f32
...
func.func @i4_dequant_matvec() attributes {hal.executable.target = #executable_target_cuda} {
  %c0 = arith.constant 0 : index
