...
//       CHECK:   linalg.generic
//       CHECK:   linalg.generic
//  CHECK-SAME:    attrs =  {lowering_config = #iree_gpu.lowering_config<{lane_basis = {{\[}}[1, 1, 64], [0, 1, 2]], partial_reduction = [0, 1, 2048], subgroup_basis = {{\[}}[1, 1, 1], [0, 1, 2]], thread = [0, 1, 32], workgroup = [8, 0, 0]
