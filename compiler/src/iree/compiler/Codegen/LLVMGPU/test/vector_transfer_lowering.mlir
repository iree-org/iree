// RUN: iree-opt --pass-pipeline="builtin.module(func.func(iree-llvmgpu-vector-lowering,canonicalize,cse,iree-codegen-vector-transfer-lowering))" --split-input-file %s | FileCheck %s
