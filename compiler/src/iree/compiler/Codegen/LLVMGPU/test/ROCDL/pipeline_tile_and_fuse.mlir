...
// RUN:   --pass-pipeline="builtin.module(hal.executable(hal.executable.variant(builtin.module(func.func(iree-llvmgpu-lower-executable-target,iree-llvmgpu-optimize-and-prefetch-shared-memory)))))" %s | FileCheck %s
