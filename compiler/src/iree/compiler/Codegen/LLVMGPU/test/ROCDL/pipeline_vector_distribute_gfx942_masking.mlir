...
// CHECK:     arith.select
// CHECK:   scf.yield
func.func @attention_20x16x63x4096x64() attributes {hal.executable.target = #executable_target_rocm, translation_info = #translation} {
...
// CHECK:     arith.select
// CHECK:   scf.yield
func.func @attention_20x16x64x4080x64() attributes {hal.executable.target = #executable_target_rocm, translation_info = #translation} {
  %cst = arith.constant 1.250000e-01 : f16
  %c0 = arith.constant 0 : index
...
// CHECK:   arith.cmpi slt
// CHECK:   arith.select
func.func @layernorm_reduction_2x508_f16() attributes {hal.executable.target = #executable_target_rocm, translation_info = #translation} {
