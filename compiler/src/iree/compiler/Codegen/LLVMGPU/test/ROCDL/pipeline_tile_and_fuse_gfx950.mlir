...
// CHECK-DAG:  %[[PDT_A_ALLOC:.+]] = memref.alloc() : memref<2048xf4E2M1FN, #gpu.address_space<workgroup>>
// CHECK-DAG:  %[[PDT_B_ALLOC:.+]] = memref.alloc() : memref<2048xf4E2M1FN, #gpu.address_space<workgroup>>
//     CHECK:  iree_codegen.swizzle_hint {{.*}}[#iree_codegen.xor_shuffle<256, 32>]
//     CHECK:  iree_codegen.swizzle_hint {{.*}}[#iree_codegen.xor_shuffle<256, 32>]
//     CHECK:  gpu.barrier memfence [#gpu.address_space<workgroup>]
