...
// TODO: Skinny GEMM BF16 VDMFMA test disabled — rocdl.smfmac.f32.16x16x32.bf16
// expects i16 operands but the amdgpu-to-rocdl conversion on gfx950 passes bf16
// through without bitcasting. Re-enable once upstream lowering is fixed.
