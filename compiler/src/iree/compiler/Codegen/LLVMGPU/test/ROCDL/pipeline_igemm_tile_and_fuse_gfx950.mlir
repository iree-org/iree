...
func.func @conv_nhwc_f16() attributes {hal.executable.target = #executable_target_rocm, translation_info = #translation} {
...
func.func @conv_nhwc_unaligned_f16() attributes {hal.executable.target = #executable_target_rocm, translation_info = #translation_unaligned} {
  %cst = arith.constant 0.000000e+00 : f32
  %c0 = arith.constant 0 : index
...
func.func @conv_input_backward_bf16() attributes {hal.executable.target = #executable_target_rocm, translation_info = #translation_backward} {
  %cst = arith.constant 0.000000e+00 : f32
  %c0 = arith.constant 0 : index
