    ...
    hal.executable.variant public @rocm_hsaco_fb target(#executable_target_rocm_hsaco_fb) {
      ...
      builtin.module {
        llvm.func @test_kern_arg(%arg0: i32) attributes {
            func_attrs = {denormal_fp_math_f32 = #iree_codegen.denormal_fp_math<"preserve-sign">,
                          gpu_optimize_occupancy = #iree_gpu.optimize_occupancy},
...
builtin.module {
  hal.executable public @test_kern_arg {
    hal.executable.variant public @rocm_hsaco_fb target(#executable_target_rocm_hsaco_fb) {
      ...
      builtin.module {
        llvm.func @test_kern_arg(%arg0: i32) attributes {
            func_attrs = {denormal_fp_math_f32 = #iree_codegen.denormal_fp_math<none>},
            llvm_func_attrs = {check_attr}
          } {
          llvm.return
        }
