...
//  CHECK-SAME:   #iree_codegen.translation_info<pipeline = #iree_gpu.pipeline<TileAndFuse> workgroup_size = [384, 1, 1] subgroup_size = 64
//  CHECK-SAME:   #iree_gpu.pipeline_options<prefetch_num_stages = 2, no_reduce_shared_memory_bank_conflicts = false
//  CHECK-SAME:   use_igemm_convolution = true

//       CHECK:   linalg.generic {{.*}}lowering_config = #iree_gpu.lowering_config
//  CHECK-SAME:     mma_kind = #iree_gpu.mma_layout<MFMA_F32_16x16x16_BF16>
//  CHECK-SAME:     padding = [16, 2, 48, 128]
//  CHECK-SAME:     promote_operands = [0, 1]
//  CHECK-SAME:     reduction = [0, 0, 0, 8]
//  CHECK-SAME:     subgroup = [1, 1, 1, 0]
//  CHECK-SAME:     workgroup = [16, 2, 48, 0]
...
//     PAD-CONV-GFX942:     padding = [16, 2, 48, 16]
// PAD-CONV-GFX942-NOT:     padding_conv
