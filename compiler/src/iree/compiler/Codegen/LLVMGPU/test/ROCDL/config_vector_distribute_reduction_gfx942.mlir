...
//       CHECK: LLVMGPUVectorDistribute workgroup_size = [512, 1, 1] subgroup_size = 64
...
// CHECK-SAME:       subgroup_basis = {{\[}}[1, 8], [0, 1]],
// CHECK-SAME:               thread = [0, 1],
...
// CHECK-LABEL: mm_bias
func.func @mm_bias(%4: tensor<320x2xf16>, %5: tensor<1280x320xf16>, %6: tensor<1280xf16>, %3 : !iree_tensor_ext.dispatch.tensor<writeonly:tensor<2x1280xf16>>) {
  %cst = arith.constant 0.000000e+00 : f32
