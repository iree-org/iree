// RUN: iree-opt --split-input-file --iree-codegen-test-target=gfx940 --iree-codegen-llvmgpu-use-vector-distribution \
// RUN:   --pass-pipeline="builtin.module(iree-llvmgpu-select-lowering-strategy)" %s | FileCheck %s
// RUN: iree-opt --split-input-file --iree-codegen-test-target=gfx1100 --iree-codegen-llvmgpu-use-vector-distribution \
