...
// REDUCTION:       #[[$TILE_SIZES:.+]] = #iree_codegen.lowering_config<tile_sizes = {{\[}}[1, 1, 1, 512]{{\]}}
// REDUCTION:       #iree_codegen.translation_info<LLVMGPUVectorDistribute
// REDUCTION-SAME:  workgroup_size = [64, 1, 1] subgroup_size = 64
// REDUCTION-LABEL: func.func @reduction_2x32x10x4096_f16xf32xf32xf32()
