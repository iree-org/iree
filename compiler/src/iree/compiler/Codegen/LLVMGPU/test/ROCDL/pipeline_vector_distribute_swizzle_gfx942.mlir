...
// CHECK-DAG: llvm.mlir.global private @__shared_memory___0() {{.*}} : !llvm.array<8192 x f16>
// CHECK-DAG: llvm.mlir.global private @__shared_memory__() {{.*}} : !llvm.array<8192 x f16>
