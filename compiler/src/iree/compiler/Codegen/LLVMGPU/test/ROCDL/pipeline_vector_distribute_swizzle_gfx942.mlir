...
// CHECK-DAG: llvm.mlir.global private @__shared_memory___0() {{.*}} : !llvm.array<4096 x f32>
// CHECK-DAG: llvm.mlir.global private @__shared_memory__() {{.*}} : !llvm.array<4096 x f32>
