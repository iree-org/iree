...
// RUN:   --iree-codegen-llvmgpu-configuration-pipeline --iree-codegen-llvmgpu-nvvm-lowering-pipeline='include-llvm-lowering=false' \
// RUN:   %s | FileCheck %s
...
func.func @conv2d_1x230x230x3_7x7x3x64() attributes {hal.executable.target = #executable_target_cuda} {
...
func.func @conv_nchw() attributes {hal.executable.target = #executable_target_cuda} {
  %c0 = arith.constant 0 : index
  %cst = arith.constant 0.000000e+00 : f32
