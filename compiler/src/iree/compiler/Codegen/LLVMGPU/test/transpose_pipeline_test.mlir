...
// RUN:   --iree-codegen-llvmgpu-configuration-pipeline --iree-codegen-llvmgpu-nvvm-lowering-pipeline='include-llvm-lowering=false' %s | FileCheck %s
...
func.func @transpose_dispatch_0_generic_4096x4096() attributes {hal.executable.target = #executable_target_cuda} {
...
func.func @transpose_single_operand_dispatch_0_generic_768x2048() attributes {hal.executable.target = #executable_target_cuda} {
  %c0 = arith.constant 0 : index
...
func.func @transpose_3d_no_dispatch_0_generic_768x2048x1024() attributes {hal.executable.target = #executable_target_cuda} {
  %c0 = arith.constant 0 : index
...
// CHECK-LABEL:   func @transpose_3d_no_dispatch_0_generic_768x2048x1024
...
func.func @transpose_3d_yes_dispatch_0_generic_10x768x2048() attributes {hal.executable.target = #executable_target_cuda} {
  %c0 = arith.constant 0 : index
...
func.func @transpose_3d_trans_out_dispatch_0_generic_10x2048x768() attributes {hal.executable.target = #executable_target_cuda} {
  %c0 = arith.constant 0 : index
...
func.func @transpose_3d_diff_dispatch_0_generic_10x768x2048() attributes {hal.executable.target = #executable_target_cuda} {
...
// CHECK-LABEL:   func @transpose_3d_diff_dispatch_0_generic_10x768x2048
//   CHECK-NOT:   memref.alloc
//       CHECK:   return
