    ...
    hal.executable.variant public @cuda_nvptx_fb, target = #executable_target_cuda_nvptx_fb {
      ...
      builtin.module {
        func.func @transpose_dispatch_0_generic_4096x4096() {
          ...
          %3 = tensor.empty(4096, 4096) : tensor<4096x4096xf32>
    ...
    hal.executable.variant public @cuda_nvptx_fb, target = #executable_target_cuda_nvptx_fb {
      ...
      builtin.module {
        func.func @transpose_single_operand_dispatch_0_generic_768x2048() {
          ...
          %5 = tensor.empty(768, 2048) : tensor<768x2048xf32>
    ...
    hal.executable.variant public @cuda_nvptx_fb, target = #executable_target_cuda_nvptx_fb {
      ...
      builtin.module {
        func.func @transpose_3d_no_dispatch_0_generic_768x2048x1024() {
          ...
          %5 = tensor.empty(768, 2048, 1024) : tensor<768x2048x1024xf32>
    ...
    hal.executable.variant public @cuda_nvptx_fb, target = #executable_target_cuda_nvptx_fb {
      ...
      builtin.module {
        func.func @transpose_3d_yes_dispatch_0_generic_10x768x2048() {
          ...
          %5 = tensor.empty(10, 768, 2048) : tensor<10x768x2048xf32>
    ...
    hal.executable.variant public @cuda_nvptx_fb, target = #executable_target_cuda_nvptx_fb {
      ...
      builtin.module {
        func.func @transpose_3d_trans_out_dispatch_0_generic_10x2048x768() {
          ...
          %4 = flow.dispatch.tensor.load %1, offsets = [0, 0, 0], sizes = [10, 768, 2048], strides = [1, 1, 1] : !flow.dispatch.tensor<readonly:10x768x2048xf32> -> tensor<10x768x2048xf32>
          %5 = tensor.empty(10, 2048, 768) : tensor<10x2048x768xf32>
      ...
      builtin.module {
        ...
        scf.for %arg0 = %workgroup_id_z to %c10 step %workgroup_count_z {
            ...
            scf.for %arg2 = %3 to %c2048 step %4 {
                ...
                %7 = tensor.empty(1, 1, 256) : tensor<1x1x256xf32>
