...
// RUN:  --iree-codegen-llvmgpu-configuration-pipeline --iree-codegen-llvmgpu-rocdl-lowering-pipeline='include-llvm-lowering=false' \
// RUN:  %s | FileCheck %s
...
func.func @group_reduction_1d() attributes {hal.executable.target = #executable_target_rocm} {
...
func.func @i4_dequant_matvec() attributes {hal.executable.target = #executable_target_rocm} {
  %c0 = arith.constant 0 : index
...
func.func @matvec_fp16() attributes {hal.executable.target = #executable_target_rocm} {
  %c0 = arith.constant 0 : index
  %cst = arith.constant 0.000000e+00 : f16
...
//    RDNA3-LABEL: func.func @matvec_fp16()
//      RDNA3-DAG:   %[[C0:.+]] = arith.constant 0 : index
...
func.func @multi_reduction() attributes {hal.executable.target = #executable_target_rocm} {
  %cst = arith.constant 0.000000e+00 : f32
