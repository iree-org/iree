...
struct LLVMGPUPrefetchSharedMemoryPass
    : public LLVMGPUPrefetchSharedMemoryBase<LLVMGPUPrefetchSharedMemoryPass> {
  void runOnOperation() override {
    ...
    if (failed(prefetchSharedMemoryCopy(rewriter, forOps[0]))) {
