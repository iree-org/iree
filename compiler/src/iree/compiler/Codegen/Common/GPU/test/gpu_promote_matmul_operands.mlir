...
// Test: SwizzleOperand attribute creates swizzle_hint op with xor_shuffle
...
// Test: SwizzleOperand with f16 element type.
...
// Test: SwizzleOperand skips fill producers (same as default promotion).
