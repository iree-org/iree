...
func.func @fold_extract_slice_of_swizzle_hint() -> tensor<16x32xf32> {
  ...
  %swizzle = iree_codegen.swizzle_hint %empty[#iree_codegen.rotate_rows<64, 4>] : tensor<64x64xf32> -> tensor<64x64xf32>
...
//       CHECK:   %[[SWIZZLE:.+]] = iree_codegen.swizzle_hint %[[EMPTY]][#iree_codegen.rotate_rows<64, 4>] : tensor<16x32xf32> -> tensor<16x32xf32>
...
func.func @fold_extract_slice_dynamic(%size0: index, %size1: index) -> tensor<?x?xf32> {
  %empty = tensor.empty() : tensor<64x64xf32>
  %swizzle = iree_codegen.swizzle_hint %empty[#iree_codegen.xor_shuffle<128, 16>] : tensor<64x64xf32> -> tensor<64x64xf32>
...
//       CHECK:   %[[SWIZZLE:.+]] = iree_codegen.swizzle_hint %[[EMPTY]][#iree_codegen.xor_shuffle<128, 16>] : tensor<?x?xf32> -> tensor<?x?xf32>
//       CHECK:   return %[[SWIZZLE]]
...
//       CHECK:   %[[SWIZZLE:.+]] = iree_codegen.swizzle_hint %[[EMPTY]][#iree_codegen.rotate_rows<64, 4>] : tensor<4x16x64xf32> -> tensor<4x16x64xf32>
//       CHECK:   return %[[SWIZZLE]]
...
func.func @fold_collapse_shape_of_swizzle_hint() -> tensor<64x64xf32> {
  ...
  %swizzle = iree_codegen.swizzle_hint %empty[#iree_codegen.rotate_rows<64, 4>] : tensor<4x16x4x16xf32> -> tensor<4x16x4x16xf32>
...
//       CHECK:   %[[SWIZZLE:.+]] = iree_codegen.swizzle_hint %[[EMPTY]][#iree_codegen.rotate_rows<64, 4>] : tensor<64x64xf32> -> tensor<64x64xf32>
//       CHECK:   return %[[SWIZZLE]]
...
func.func @no_fold_extract_slice_non_empty(%arg0: tensor<64x64xf32>) -> tensor<16x32xf32> {
  %swizzle = iree_codegen.swizzle_hint %arg0[#iree_codegen.rotate_rows<64, 4>] : tensor<64x64xf32> -> tensor<64x64xf32>
  %slice = tensor.extract_slice %swizzle[0, 0] [16, 32] [1, 1] : tensor<64x64xf32> to tensor<16x32xf32>
  return %slice : tensor<16x32xf32>
}
...
//       CHECK:   %[[SWIZZLE:.+]] = iree_codegen.swizzle_hint %[[ARG0]][#iree_codegen.rotate_rows<64, 4>] : tensor<64x64xf32> -> tensor<64x64xf32>
...
func.func @fold_xor_shuffle_swizzle() -> tensor<8x64xf32> {
  ...
  %swizzle = iree_codegen.swizzle_hint %empty[#iree_codegen.xor_shuffle<128, 16>] : tensor<16x128xf32> -> tensor<16x128xf32>
...
//       CHECK:   %[[SWIZZLE:.+]] = iree_codegen.swizzle_hint %[[EMPTY]][#iree_codegen.xor_shuffle<128, 16>] : tensor<8x64xf32> -> tensor<8x64xf32>
//       CHECK:   return %[[SWIZZLE]]
...
//       CHECK:   %[[SWIZZLE:.+]] = iree_codegen.swizzle_hint %[[EMPTY]][#iree_codegen.rotate_rows<64, 4>] : tensor<32xf32> -> tensor<32xf32>
//       CHECK:   return %[[SWIZZLE]]
...
func.func @fold_swizzle_hint_of_encoding() -> tensor<16xbf16,#encoding> {
  ...
  %swizzle = iree_codegen.swizzle_hint %empty[#iree_codegen.rotate_rows<8, 4>] : tensor<8x16xbf16, #encoding> -> tensor<8x16xbf16, #encoding>
