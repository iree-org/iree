...
func.func @online_attention_fail_to_pad_no_mask(%query: tensor<192x1024x64xf32>, %key: tensor<192x?x64xf32>, %value: tensor<192x?x64xf32>) -> tensor<192x1024x64xf32> {
  ...
  %out:3 = iree_linalg_ext.online_attention
        ...
        ins(%query, %key, %value : tensor<192x1024x64xf32>, tensor<192x?x64xf32>, tensor<192x?x64xf32>)
...
func.func @online_attention_tile_then_pad(%query: tensor<192x1024x64xf32>, %key: tensor<192x?x64xf32>, %value: tensor<192x?x64xf32>, %mask: tensor<192x1024x?xf32>) -> tensor<192x1024x64xf32> {
  ...
  //    CHECK-SAME:   : tensor<192x1024x64xf32>, tensor<192x32x64xf32>, tensor<192x32x64xf32>, tensor<192x1024x32xf32>)
  %out:3 = iree_linalg_ext.online_attention
        {
          indexing_maps = [#mapQ, #mapK, #mapV, #mapM, #mapO, #mapR, #mapR],
          lowering_config = #lowering_config
        }
        ins(%query, %key, %value, %mask : tensor<192x1024x64xf32>, tensor<192x?x64xf32>, tensor<192x?x64xf32>, tensor<192x1024x?xf32>)
        outs(%output_fill, %acc_fill, %sum_fill : tensor<192x1024x64xf32>, tensor<192x1024xf32>, tensor<192x1024xf32>)
        {
          ^bb0(%score: f32):
            iree_linalg_ext.yield %score: f32
...
func.func @online_attention_tile_then_pad_i8_mask(%query: tensor<192x1024x64xf32>, %key: tensor<192x?x64xf32>, %value: tensor<192x?x64xf32>, %mask: tensor<192x1024x?xi8>) -> tensor<192x1024x64xf32> {
  ...
  %out:3 = iree_linalg_ext.online_attention
        ...
        ins(%query, %key, %value, %mask : tensor<192x1024x64xf32>, tensor<192x?x64xf32>, tensor<192x?x64xf32>, tensor<192x1024x?xi8>)
        outs(%output_fill, %acc_fill, %sum_fill : tensor<192x1024x64xf32>, tensor<192x1024xf32>, tensor<192x1024xf32>)
        {
          ^bb0(%score: f32):
            iree_linalg_ext.yield %score: f32
...
func.func @online_attention_tile_then_pad_7(%n_batches: index, %query: tensor<?x1021x64xf32>, %key: tensor<192x?x64xf32>, %value: tensor<192x?x64xf32>, %mask: tensor<?x1021xf32>) -> tensor<?x1021x64xf32> {
  ...
  //    CHECK-SAME:   : tensor<4x8x64xf32>, tensor<4x32x64xf32>, tensor<4x32x64xf32>, tensor<4x8xf32>)
  ...
  %out:3 = iree_linalg_ext.online_attention
        ...
        ins(%query, %key, %value, %mask : tensor<?x1021x64xf32>, tensor<192x?x64xf32>, tensor<192x?x64xf32>, tensor<?x1021xf32>)
...
func.func @online_attention_no_mask_aligned_dims(%query: tensor<192x1024x64xf32>, %key: tensor<192x64x64xf32>, %value: tensor<192x64x64xf32>) -> tensor<192x1024x64xf32> {
  ...
  //        CHECK: iree_linalg_ext.online_attention {{.*}} ins(%{{[A-Za-z0-9_]+}}, %{{[A-Za-z0-9_]+}}, %{{[A-Za-z0-9_]+}}
  //   CHECK-SAME:   : tensor<192x1024x64xf32>, tensor<192x32x64xf32>, tensor<192x32x64xf32>)
  ...
  %out:3 = iree_linalg_ext.online_attention
        ...
        ins(%query, %key, %value : tensor<192x1024x64xf32>, tensor<192x64x64xf32>, tensor<192x64x64xf32>)
        outs(%output_fill, %acc_fill, %sum_fill : tensor<192x1024x64xf32>, tensor<192x1024xf32>, tensor<192x1024xf32>)
        {
          ^bb0(%score: f32):
            iree_linalg_ext.yield %score: f32
