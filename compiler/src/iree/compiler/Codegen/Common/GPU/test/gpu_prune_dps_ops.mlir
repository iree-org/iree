...
// CHECK-LABEL: func.func @minimal_unused_result_copied
...
func.func @minimal_unused_result_copied(%arg0: !iree_tensor_ext.dispatch.tensor<readonly:tensor<1x10xf32>>, %arg1: tensor<1x10xi64>) -> tensor<1x10xi64> {
...
// CHECK-LABEL: func.func @minimal_unused_result_not_copied
// CHECK-NOT: bufferization.alloc_tensor()
func.func @minimal_unused_result_not_copied(%arg0: !iree_tensor_ext.dispatch.tensor<readonly:tensor<1x10xf32>>, %arg1: tensor<1x10xi64>) -> tensor<1x10xi64> {
  %cst = arith.constant dense<1.000000e+00> : tensor<1x10xf32>
  %2 = iree_tensor_ext.dispatch.tensor.load %arg0, offsets = [0, 0], sizes = [1, 10], strides = [1, 1] : !iree_tensor_ext.dispatch.tensor<readonly:tensor<1x10xf32>> -> tensor<1x10xf32>
  %add = arith.addf %2, %cst: tensor<1x10xf32>
  %3:2 = iree_linalg_ext.sort dimension(1) outs(%add, %arg1 :tensor<1x10xf32>, tensor<1x10xi64>) {
    ^bb0(%arg4: f32, %arg5: f32, %arg6: i64, %arg7: i64):
    %16 = arith.cmpf oge, %arg4, %arg5 : f32
    iree_linalg_ext.yield %16 : i1
  } -> tensor<1x10xf32>, tensor<1x10xi64>
...
// CHECK-LABEL: func.func @minimal_unused_result_not_copied
// CHECK-NOT: bufferization.alloc_tensor()
func.func @minimal_unused_result_not_copied(%arg0: !iree_tensor_ext.dispatch.tensor<readonly:tensor<1x33xf32>>, %arg1: tensor<1x33xi64>) -> tensor<1x33xi64> {
