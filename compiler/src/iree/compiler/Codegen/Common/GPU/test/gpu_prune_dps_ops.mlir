...
// CHECK-DAG: %[[SRC:.*]] = bufferization.alloc_tensor() copy(%{{.*}}) : tensor<1x10xf32>
...
// CHECK-LABEL: func.func @unused_result_not_copied
// CHECK-NOT: bufferization.alloc_tensor()
func.func @unused_result_not_copied(%arg0: !iree_tensor_ext.dispatch.tensor<readonly:tensor<1x10xf32>>, %arg1: tensor<1x10xi64>) -> tensor<1x10xi64> {
