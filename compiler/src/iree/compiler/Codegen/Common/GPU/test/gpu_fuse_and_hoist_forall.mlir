...
func.func @swizzle_with_fusion(%arg0: tensor<128x128xf16>, %arg1: tensor<128x128xf16>) -> tensor<128x128xf16>
  ...
  %swizzle_1 = iree_codegen.swizzle_hint %empty1[#iree_codegen.xor_shuffle<64, 8>] : tensor<128x128xf16> -> tensor<128x128xf16>
  ...
  %swizzle_2 = iree_codegen.swizzle_hint %empty2[#iree_codegen.xor_shuffle<64, 16>] : tensor<128x128xf16> -> tensor<128x128xf16>
...
//       CHECK:   %[[SWIZZLE1:.+]] = iree_codegen.swizzle_hint %[[ALLOC1]][#iree_codegen.xor_shuffle<64, 8>] : tensor<128x128xf16> -> tensor<128x128xf16>
//       CHECK:   %[[ALLOC2:.+]] = bufferization.alloc_tensor() {memory_space = #gpu.address_space<workgroup>} : tensor<128x128xf16>
//       CHECK:   %[[SWIZZLE2:.+]] = iree_codegen.swizzle_hint %[[ALLOC2]][#iree_codegen.xor_shuffle<64, 16>] : tensor<128x128xf16> -> tensor<128x128xf16>
