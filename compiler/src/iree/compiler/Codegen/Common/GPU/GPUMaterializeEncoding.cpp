...
struct GPUSetEncodingOpLoweringConversion
  ...
  matchAndRewrite(IREE::Encoding::SetEncodingOp encodingOp, OpAdaptor adaptor,
    ...
    auto [iM, iK] = *intrinsicVectorShape;
    auto oM = sourceType[0] / iM;
    auto oK = sourceType[1] / iK;
    expandShapeShape = {oM, iM, oK, iK};
    ...
    auto permutation = roleIdx == 2 ? ArrayRef<int64_t>{0, 2, 1, 3}
                                    : ArrayRef<int64_t>{2, 0, 3, 1};
