...
struct GPUMMASchedule {
  ...
  SmallVector<int64_t>
      mTileCounts; // Number of tiles per subgroup along M dimensions
  SmallVector<int64_t>
      nTileCounts; // Number of tiles per subgroup along N dimensions
  SmallVector<int64_t> kTileCounts; // Number of tiles along K dimensions
