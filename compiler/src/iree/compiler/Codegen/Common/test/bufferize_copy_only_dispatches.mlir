...
//   CHECK-DAG:   %[[SUBSPAN_DEST:.+]] = hal.interface.binding.subspan layout({{.+}}) binding(0)
//   CHECK-DAG:   %[[DEST:.+]] = memref.assume_alignment %[[SUBSPAN_DEST]], 64
//   CHECK-DAG:   %[[SUBSPAN_SOURCE:.+]] = hal.interface.binding.subspan layout({{.+}}) binding(1)
//   CHECK-DAG:   %[[SOURCE:.+]] = memref.assume_alignment %[[SUBSPAN_SOURCE]], 64
