...
//      CHECK: func.func private @scalar_fn(memref<f32>, index, i32, f64, index)
...
//      CHECK:   call @scalar_fn(%[[BASE]], %[[OFFSET]], %[[ARG0]], %[[ARG1]], %[[ARG2]])
...
//       CHECK:   call @vmvx.matmul.f32f32f32(%[[BASE0]], %[[OFFSET0]], %[[BASE1]], %[[OFFSET1]], %[[BASE2]], %[[OFFSET2]],
