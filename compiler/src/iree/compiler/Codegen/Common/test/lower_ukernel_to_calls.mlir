...
//      CHECK: func.func private @scalar_fn(memref<f32>, i32, f64, index)
...
//      CHECK:   call @scalar_fn(%[[BASE]], %[[ARG0]], %[[ARG1]], %[[ARG2]])
...
//  CHECK-SAME:     (memref<f32>, memref<f32>, memref<f32>, index, index, index, index,
//  CHECK-SAME:     index, index, index, index, index, i32)
...
//       CHECK:   call @vmvx.matmul.f32f32f32(%[[BASE0]], %[[BASE1]], %[[BASE2]],
//  CHECK-SAME:       %[[OFFSET0]], %[[STRIDES0]]#0
//  CHECK-SAME:       %[[OFFSET1]], %[[STRIDES1]]#0
//  CHECK-SAME:       %[[OFFSET2]], %[[STRIDES2]]#0
...
//   CHECK-DAG:   %[[C0_I32:.+]] = arith.constant 0 : i32
//       CHECK:   call @vmvx.mmt4d.f32f32f32(%[[BASE0]], %[[BASE1]], %[[BASE2]], 
//  CHECK-SAME:       %[[OFFSET0]], %[[STRIDES0]]#0
//  CHECK-SAME:       %[[OFFSET1]], %[[STRIDES1]]#0
//  CHECK-SAME:       %[[OFFSET2]], %[[STRIDES2]]#0
//  CHECK-SAME:       %[[D0]], %[[D1]], %[[D2]],
