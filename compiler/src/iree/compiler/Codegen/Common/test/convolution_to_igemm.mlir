...
func.func @conv_with_lowering_config() attributes {translation_info = #iree_codegen.translation_info<LLVMGPUIGEMMTileAndFuse workgroup_size = [256, 1, 1] subgroup_size = 64, {gpu_pipeline_options = #iree_gpu.pipeline_options<prefetch_shared_memory = true, no_reduce_shared_memory_bank_conflicts = false>}>} {
