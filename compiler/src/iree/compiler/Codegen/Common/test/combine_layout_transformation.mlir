...
//  CHECK-SAME:       [%[[IDX0]], %[[IDX1]], %[[IDX2]]] by (2, 4, 16)
//       CHECK:     %[[DELINEARIZE:.+]]:2 = affine.delinearize_index
//  CHECK-SAME:       %[[LINEARIZE]] into (8, 16) : index, index
//       CHECK:     iree_linalg_ext.yield %[[DELINEARIZE]]#0, %[[DELINEARIZE]]#1, %[[TRUE]] : index, index, i1
...
//       CHECK:     %[[LINEARIZE:.+]] = affine.linearize_index
//  CHECK-SAME:       [%[[IDX0]], %[[IDX1]]] by (8, 16)
//       CHECK:     %[[DELINEARIZE:.+]]:3 = affine.delinearize_index
//  CHECK-SAME:       %[[LINEARIZE]] into (2, 4, 16) : index, index, index
//       CHECK:     iree_linalg_ext.yield %[[DELINEARIZE]]#0, %[[DELINEARIZE]]#1, %[[DELINEARIZE]]#2, %[[TRUE]]
...
//       CHECK:     %[[MASK:.+]] = arith.cmpi uge, %[[IDX0]], %[[C63]] : index
...
//       CHECK:     %[[BOUND0:.+]] = arith.cmpi uge, %[[DELINEARIZE]]#0, %[[RES_D0]] : index
//       CHECK:     %[[BOUND1:.+]] = arith.cmpi uge, %[[DELINEARIZE]]#1, %[[RES_D1]] : index
...
//  CHECK-NEXT:   ^bb0(%[[IDX0:.+]]: index, %[[IDX1:.+]]: index):
//       CHECK:     %[[LINEARIZE:.+]] = affine.linearize_index
//  CHECK-SAME:       [%[[IDX0]], %[[IDX1]]] by (256, 256)
//       CHECK:     %[[DELINEARIZE:.+]]:4 = affine.delinearize_index %[[LINEARIZE]]
//  CHECK-SAME:       into (2, 128, 2, 128) : index, index, index, index
//       CHECK:     iree_linalg_ext.yield %[[DELINEARIZE]]#0, %[[DELINEARIZE]]#2, %[[DELINEARIZE]]#1, %[[DELINEARIZE]]#3, %[[TRUE]]
