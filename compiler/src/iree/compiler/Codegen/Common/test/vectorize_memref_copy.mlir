...
//       CHECK:       %[[SOURCE_SUBVIEW:.+]] = memref.subview %[[SOURCE]][%[[ARG2]], %[[ARG3]]] [1, 2] [1, 1]
//       CHECK:       %[[DEST_SUBVIEW:.+]] = memref.subview %[[DEST]][%[[ARG2]], %[[ARG3]]] [1, 2] [1, 1]
...
func.func @memref_copy_not_multiple_of_preferred_copy_bits(%source: memref<2x6xf32>, %dest: memref<2x6xf32>) {
  memref.copy %source, %dest : memref<2x6xf32> to memref<2x6xf32>
  return
}
// CHECK-LABEL: func.func @memref_copy_not_multiple_of_preferred_copy_bits
