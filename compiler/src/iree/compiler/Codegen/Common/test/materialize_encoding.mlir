...
//  CHECK-DAG:   %[[C0:.+]] = arith.constant 0 : index
//  CHECK-DAG:   %[[ENCODING_LHS:.+]] = arith.constant 4 : i64
//  CHECK-DAG:   %[[ENCODING_RHS_TRANSPOSE:.+]] = arith.constant 6 : i64
//  CHECK-DAG:   %[[ENCODING_RESULT:.+]] = arith.constant 7 : i64
//  CHECK-DAG:   %[[DYNAMIC:.+]] = arith.constant -9223372036854775808 : index
//  CHECK-DAG:   %[[M:.+]] = hal.interface.constant.load[0]
//  CHECK-DAG:   %[[N:.+]] = hal.interface.constant.load[1]
//  CHECK-DAG:   %[[K:.+]] = hal.interface.constant.load[2]
//      CHECK:   %[[LHS_TILE_SIZES:.+]]:2 = vmvx.query_tile_sizes encoding(%[[ENCODING_LHS]]) sizes(%[[DYNAMIC]], %[[DYNAMIC]]) -> index, index
...
//      CHECK:   %[[RHS_TILE_SIZES:.+]]:2 = vmvx.query_tile_sizes encoding(%[[ENCODING_RHS_TRANSPOSE]]) sizes(%[[DYNAMIC]], %[[DYNAMIC]]) -> index, index
...
//      CHECK:   %[[RESULT_TILE_SIZES:.+]]:2 = vmvx.query_tile_sizes encoding(%[[ENCODING_RESULT]]) sizes(%[[DYNAMIC]], %[[DYNAMIC]]) -> index, index
