...
//       CHECK:   %[[WRITE_BARRIER:.+]] = iree_gpu.tensor_barrier %[[IN]]
//       CHECK:   %[[OUT:.+]] = tensor.extract_slice %[[WRITE_BARRIER]][0, %[[X]]] [3, 2] [1, 1] : tensor<6x6xf32> to tensor<3x2xf32>
//       CHECK:   %[[READ_BARRIER:.+]] = iree_gpu.tensor_barrier %[[OUT]]
...
//       CHECK:   %[[READ_BARRIER:.+]] = iree_gpu.vector_barrier %[[VEC_OUT]]
...
//       CHECK:   %[[READ_BARRIER:.+]] = iree_gpu.vector_barrier %[[READ]]
