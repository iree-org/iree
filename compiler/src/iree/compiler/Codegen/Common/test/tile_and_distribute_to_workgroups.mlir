  ...
  hal.executable.variant public @llvm, target = #executable_target_embedded_elf_x86_64_ {
    ...
    builtin.module {
      func.func @add() {
        ...
        %8 = linalg.generic {
            indexing_maps = [#map0, #map1, #map0], iterator_types = [#linalg.iterator_type<parallel>, #linalg.iterator_type<parallel>]}
  ...
  hal.executable.variant public @llvm, target = #executable_target_embedded_elf_x86_64_ {
    ...
    builtin.module {
      func.func @add4D() {
        ...
        %10 = linalg.generic {
            indexing_maps = [#map, #map, #map], iterator_types = [#linalg.iterator_type<parallel>, #linalg.iterator_type<parallel>, #linalg.iterator_type<parallel>, #linalg.iterator_type<parallel>]}
  ...
  hal.executable.variant public @system_elf_x86_64, target = #executable_target_system_elf_x86_64_ {
    ...
    builtin.module {
      func.func @outs_fusion_fn() {
        ...
        %7 = linalg.generic {
            indexing_maps = [#map0], iterator_types = [#linalg.iterator_type<parallel>, #linalg.iterator_type<parallel>]} outs(%6 : tensor<?x?xf32>) {
        ^bb0(%arg0: f32):
        ...
        %9 = flow.dispatch.tensor.load %4, offsets = [0, 0], sizes = [%2, %1], strides = [1, 1]
            : !flow.dispatch.tensor<readonly:tensor<?x?xf32>>{%2, %1} -> tensor<?x?xf32>
        %10 = linalg.generic {
            indexing_maps = [#map1, #map2, #map3], iterator_types = [#linalg.iterator_type<parallel>, #linalg.iterator_type<parallel>, #linalg.iterator_type<reduction>]}
  ...
  hal.executable.variant public @system_elf_x86_64, target = #executable_target_system_elf_x86_64_ {
    ...
    builtin.module {
      func.func @generic_static() {
        ...
        %4 = linalg.generic {
            indexing_maps = [#map0, #map1], iterator_types = [#linalg.iterator_type<parallel>, #linalg.iterator_type<parallel>]}
  ...
  hal.executable.variant public @reduction, target = #executable_target_embedded_elf_x86_64_ {
    ...
    builtin.module {
      func.func @reduction(%arg0 : !flow.dispatch.tensor<readonly:tensor<7x7x2048xf32>>,
        ...
        %3 = linalg.generic {
            indexing_maps = [#map0, #map1], iterator_types = [#linalg.iterator_type<parallel>, #linalg.iterator_type<reduction>, #linalg.iterator_type<reduction>]}
        ...
        %4 = linalg.generic {
            indexing_maps = [#map2, #map2], iterator_types = [#linalg.iterator_type<parallel>]}
  ...
  hal.executable.variant public @llvm, target = #executable_target_embedded_elf_x86_64_ {
    ...
    builtin.module {
      func.func @generic_unit_dims() {
        ...
        %8 = linalg.generic {
            indexing_maps = [#map, #map], iterator_types = [#linalg.iterator_type<parallel>, #linalg.iterator_type<parallel>, #linalg.iterator_type<parallel>, #linalg.iterator_type<parallel>, #linalg.iterator_type<parallel>, #linalg.iterator_type<parallel>, #linalg.iterator_type<parallel>, #linalg.iterator_type<parallel>]}
  ...
  hal.executable.variant public @llvm, target = #executable_target_embedded_elf_x86_64_ {
    ...
    builtin.module {
      func.func @reduce_to_scalar() {
        ...
        %5 = linalg.generic {
            indexing_maps = [#map0, #map1], iterator_types = [#linalg.iterator_type<reduction>]}
  ...
  hal.executable.variant public @embedded_elf_x86_64, target = <"llvm-cpu", "embedded-elf-x86_64", {}> {
    ...
    builtin.module {
      func.func @no_tile() {
        ...
        %0 = hal.interface.binding.subspan set(0) binding(0) type(storage_buffer) offset(%c0) alignment(64) : !flow.dispatch.tensor<readonly:tensor<10xf32>>
        %1 = hal.interface.binding.subspan set(0) binding(1) type(storage_buffer) offset(%c0) alignment(64) : !flow.dispatch.tensor<readonly:tensor<10xi32>>
        %2 = hal.interface.binding.subspan set(0) binding(2) type(storage_buffer) offset(%c0) alignment(64) : !flow.dispatch.tensor<readwrite:tensor<3xf32>>
        %3 = hal.interface.binding.subspan set(0) binding(3) type(storage_buffer) offset(%c64) alignment(64) : !flow.dispatch.tensor<readwrite:tensor<3xi32>>
