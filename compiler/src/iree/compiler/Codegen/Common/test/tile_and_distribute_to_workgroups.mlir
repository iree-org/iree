// RUN: iree-opt --pass-pipeline='hal.executable(hal.executable.variant(iree-codegen-tile-and-distribute-to-workgroups{specialize=false})), canonicalize, cse' --split-input-file %s | FileCheck %s
