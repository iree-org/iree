...
//   CHECK-DAG:   hal.interface.binding.subspan layout({{.+}}) binding(0) : memref<256x256xf32, #amdgpu.address_space<fat_raw_buffer>>
//   CHECK-DAG:   hal.interface.binding.subspan layout({{.+}}) binding(1) offset(%{{.+}}) : memref<256x256xf32, strided<[256, 1], offset: ?>, #amdgpu.address_space<fat_raw_buffer>>
