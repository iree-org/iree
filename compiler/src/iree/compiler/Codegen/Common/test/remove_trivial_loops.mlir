...
hal.executable private @dispatch_0  {
  hal.executable.variant @cuda target(#hal.executable.target<"cuda", "cuda-nvptx-fb", {iree.gpu.target = #iree_gpu.alias_target<"sm_60">}>) {
...
hal.executable private @simple_mul {
  hal.executable.variant public @variant target(#hal.executable.target<"cuda", "cuda-nvptx-fb", {iree.gpu.target = #iree_gpu.alias_target<"sm_60">}>) {
