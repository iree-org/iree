...
enumerateMatmulTileX86_64(EncodingUser user, TypeRange elementTypes,
  ...
  if (out.isSignlessInteger(32) && ((lhs.isSignlessInteger(8) && rhs.isSignlessInteger(8)) ||
  ...
  if (out.isSignlessInteger(32) && lhs.isSignlessInteger(16) && rhs.isUnsignedInteger(4)) {
