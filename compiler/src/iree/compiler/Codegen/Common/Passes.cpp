...
void addCommonTargetExecutablePreprocessingPasses(OpPassManager &passManager, bool useDecomposeSoftmaxFusion) {
  ...
  nestedModulePM.addNestedPass<func::FuncOp>(createDecomposeSoftmaxPass(useDecomposeSoftmaxFusion));
