...
getMatmulOrIGEMMLoweringConfigAndWorkgroupSize(
  ...
  // workgroup tiles are computed. Scaled matmul enables DMA via the
  // promotionArray path below (mxfp4 data operands), so the general rejection
  // (which also filters non-f16/bf16) is skipped here.
