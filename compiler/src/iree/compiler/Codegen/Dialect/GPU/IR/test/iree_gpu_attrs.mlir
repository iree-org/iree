...
module {
  func.func @test_vdmfma_f16_8x16x32() attributes {
      mma_types = #iree_gpu.virtual_mma_layout<VDMFMA_F32_8x16x32_F16>} {
    return
  }
}
// CHECK-LABEL: func @test_vdmfma_f16_8x16x32
//  CHECK-SAME:   mma_types = #iree_gpu.virtual_mma_layout<VDMFMA_F32_8x16x32_F16>

module {
  func.func @test_vdmfma_i8_8x16x64() attributes {
      mma_types = #iree_gpu.virtual_mma_layout<VDMFMA_I32_8x16x32_I8>} {
    return
  }
}
// CHECK-LABEL: func @test_vdmfma_i8_8x16x64
//  CHECK-SAME:   mma_types = #iree_gpu.virtual_mma_layout<VDMFMA_I32_8x16x32_I8>

module {
  func.func @test_vdmfma_bf16_8x16x32() attributes {
      mma_types = #iree_gpu.virtual_mma_layout<VDMFMA_F32_8x16x32_BF16>} {
    return
  }
}
// CHECK-LABEL: func @test_vdmfma_bf16_8x16x32
//  CHECK-SAME:   mma_types = #iree_gpu.virtual_mma_layout<VDMFMA_F32_8x16x32_BF16>

module {
  func.func @test_vdmfma_f8E5M2FNUZ_8x16x64() attributes {
      mma_types = #iree_gpu.virtual_mma_layout<VDMFMA_F32_8x16x32_F8E5M2FNUZ>} {
    return
  }
}
// CHECK-LABEL: func @test_vdmfma_f8E5M2FNUZ_8x16x64
//  CHECK-SAME:   mma_types = #iree_gpu.virtual_mma_layout<VDMFMA_F32_8x16x32_F8E5M2FNUZ>

module {
  func.func @test_vdmfma_f8E5M2FNUZ_f8E4M3FNUZ_8x16x64() attributes {
      mma_types = #iree_gpu.virtual_mma_layout<VDMFMA_F32_8x16x32_F8E5M2FNUZ_F8E4M3FNUZ>} {
    return
  }
}
// CHECK-LABEL: func @test_vdmfma_f8E5M2FNUZ_f8E4M3FNUZ_8x16x64
//  CHECK-SAME:   mma_types = #iree_gpu.virtual_mma_layout<VDMFMA_F32_8x16x32_F8E5M2FNUZ_F8E4M3FNUZ>

module {
  func.func @test_vdmfma_f8E4M3FNUZ_f8E5M2FNUZ_8x16x64() attributes {
      mma_types = #iree_gpu.virtual_mma_layout<VDMFMA_F32_8x16x32_F8E4M3FNUZ_F8E5M2FNUZ>} {
    return
  }
}
// CHECK-LABEL: func @test_vdmfma_f8E4M3FNUZ_f8E5M2FNUZ_8x16x64
//  CHECK-SAME:   mma_types = #iree_gpu.virtual_mma_layout<VDMFMA_F32_8x16x32_F8E4M3FNUZ_F8E5M2FNUZ>

module {
  func.func @test_vdmfma_f8E4M3FNUZ_8x16x64() attributes {
      mma_types = #iree_gpu.virtual_mma_layout<VDMFMA_F32_8x16x32_F8E4M3FNUZ>} {
    return
  }
}
// CHECK-LABEL: func @test_vdmfma_f8E4M3FNUZ_8x16x64
//  CHECK-SAME:   mma_types = #iree_gpu.virtual_mma_layout<VDMFMA_F32_8x16x32_F8E4M3FNUZ>
