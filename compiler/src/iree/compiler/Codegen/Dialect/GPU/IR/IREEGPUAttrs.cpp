...
SmallVector<VirtualMMAIntrinsic> MMAAttr::getVirtualIntrinsics() const {
  ...
  // case MMAIntrinsic::MFMA_F32_16x16x32_F8E5M2FNUZ_F8E4M3FNUZ:
  //   return
  //   {VirtualMMAIntrinsic::VDMFMA_F32_8x16x128x2_F8E5M2FNUZ_F8E4M3FNUZ};
  // case MMAIntrinsic::MFMA_F32_16x16x32_F8E4M3FNUZ_F8E5M2FNUZ:
  //   return
  //   {VirtualMMAIntrinsic::VDMFMA_F32_8x16x128x2_F8E4M3FNUZ_F8E5M2FNUZ};
  // case MMAIntrinsic::MFMA_I32_16x16x32_I8:
...
int64_t VirtualMMAAttr::getKTileHeuristicScaleFactor() const {
  return 2;
  ...
  // Type aType = std::get<0>(getABCElementTypes());
  // // VDMFMA wide-element sparse-trick kernels retire useful compute more
  // // quickly per logical K-element than the MFMAs they derive from. F16/BF16
  // // use cheap v_mov_b32 shuffles for B interleaving, so doubling the
  // // heuristic K tile restores compute-memory overlap. FP8 and I8 spend
  // enough
  // // time in byte-level shuffles already, so no adjustment is needed.
  // if (aType.getIntOrFloatBitWidth() >= 16) {
  //   return 2;
  // }
  // return 1;
}
