...
//   CHECK-DAG:     %[[LINEAR_SLICE_IDX:.+]] = affine.linearize_index [%[[SLICE_IDX_0]], %[[C0]]] by (8, 8) : index
...
//   CHECK-DAG:   %[[LINEAR_SLICE_IDX:.+]] = affine.linearize_index [%[[IDX1]], %[[C0]]] by (%[[SIZE1]], 8) : index
