...
#define GEN_PASS_DEF_DROPRESOURCECASTSPASS
#include "iree/compiler/Codegen/Dialect/GPU/Transforms/Passes.h.inc"

namespace {
struct DropResourceCastsPass final
    : impl::DropResourceCastsPassBase<DropResourceCastsPass> {
...
void DropResourceCastsPass::runOnOperation() {
