...
#define GEN_PASS_DEF_PROMOTEINNERTILEDREDUCTIONOPERANDSPASS
#include "iree/compiler/Codegen/Dialect/GPU/Transforms/Passes.h.inc"

namespace {
struct PromoteInnerTiledReductionOperandsPass final
    : impl::PromoteInnerTiledReductionOperandsPassBase<
          PromoteInnerTiledReductionOperandsPass> {
  void runOnOperation() override;
};
} // namespace

void PromoteInnerTiledReductionOperandsPass::runOnOperation() {
