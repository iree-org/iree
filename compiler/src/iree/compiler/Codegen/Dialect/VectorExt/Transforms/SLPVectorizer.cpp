...
#define GEN_PASS_DEF_GREEDYSLPVECTORIZERPASS
...
struct GreedySLPVectorizerPass
    : public mlir::iree_compiler::IREE::VectorExt::impl::
          GreedySLPVectorizerPassBase<GreedySLPVectorizerPass> {
  using GreedySLPVectorizerPassBase::GreedySLPVectorizerPassBase;
