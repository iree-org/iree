...
public:
  ...
  virtual void
  loadSRefLoweringDependentDialects(MLIRContext *context) const { /*nothing*/
  }
  virtual void
  loadTokenLoweringDependentDialects(MLIRContext *context) const { /*nothing*/
  }
  virtual void loadStructuralLoweringDependentDialects(
      MLIRContext *context) const { /*nothing*/
  }
};
