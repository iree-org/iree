...
hal.executable private @matmul_128_384_1536  {
  hal.executable.variant @system_elf_x86_64, target = <
    ...
    hal.executable.export @matmul_128_384_1536 layout(#executable_layout) {
    ...
    builtin.module {
      func.func @matmul_128_384_1536() {
        ...
        flow.dispatch.tensor.store %8, %2, offsets = [0, 0], sizes = [128, 384], strides = [1, 1] : tensor<128x384xf32> -> !flow.dispatch.tensor<writeonly:128x384xf32>
        return
      }
    }
  }
