// RUN: iree-opt --pass-pipeline='hal.executable(hal.executable.variant(builtin.module(func.func(iree-llvmcpu-aarch64-vector-lowering,iree-codegen-optimize-vector-transfer{flatten=true}))))' --split-input-file %s | FileCheck %s
