...
//  CHECK-DAG: #[[CONFIG:.+]] = #iree_cpu.lowering_config<vector_common_parallel = [8, 32], vector_inner_parallel = [0, 0], vector_reduction = [0, 0]>
...
//  CHECK-DAG: #[[CONFIG:.+]] = #iree_cpu.lowering_config<vector_common_parallel = [7, 64], vector_inner_parallel = [0, 0], vector_reduction = [0, 0]>
...
//  CHECK-DAG: #[[CONFIG:.+]] = #iree_cpu.lowering_config<vector_common_parallel = [7, 128], vector_inner_parallel = [0, 0], vector_reduction = [0, 0]>
...
//  CHECK-AGGRESSIVE-DAG: #[[CONFIG:.+]] = #iree_cpu.lowering_config<vector_common_parallel = [7, 128], vector_inner_parallel = [0, 0], vector_reduction = [0, 0]>
...
//  CHECK-DAG: #[[CONFIG:.+]] = #iree_cpu.lowering_config<vector_common_parallel = [1, 128], vector_inner_parallel = [0, 0], vector_reduction = [0, 0]>
