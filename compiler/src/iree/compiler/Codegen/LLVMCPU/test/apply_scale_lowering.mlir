...
// 32-bit lowering should be used by default if no vector features are provided.
...
// 64-bit lowering should be used with '+v'.
...
// 64-bit lowering should be used with '+zve64x'.
...
// 32-bit lowering should be used with '+zve32x'.
