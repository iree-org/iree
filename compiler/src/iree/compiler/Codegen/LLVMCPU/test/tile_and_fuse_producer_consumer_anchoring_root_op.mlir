...
#config = #iree_cpu.lowering_config<distribution = [0, 0, 0, 0, 0, 0], vector_reduction = [0, 0, 0, 0, 1, 5]>
#map = affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>
...
#config = #iree_cpu.lowering_config<distribution = [0, 0, 0], vector_common_parallel = [4, 8, 0]>
...
#config = #iree_cpu.lowering_config<distribution = [0, 0, 0], vector_common_parallel = [10, 20, 30]>
...
#config = #iree_cpu.lowering_config<distribution = [0, 0, 0], vector_common_parallel = [0, 0, 0]>
...
#config = #iree_cpu.lowering_config<distribution = [0, 0, 0], vector_common_parallel = [1, [32], 0]>
...
#config = #iree_cpu.lowering_config<distribution = [0, 0, 0], vector_common_parallel = [0, 20, 0]>
#map = affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>
...
#config = #iree_cpu.lowering_config<distribution = [0, 0], vector_common_parallel = [0, 1]>
...
#config = #iree_cpu.lowering_config<distribution = [0, 0], vector_common_parallel = [1, 16]>
