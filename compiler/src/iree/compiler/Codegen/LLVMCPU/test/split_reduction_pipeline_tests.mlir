...
hal.executable private @split_reduction_pass1_dispatch_0 {
  hal.executable.variant public @embedded_elf_x86_64, target = #executable_target_embedded_elf_x86_64_ {
    hal.executable.export public @split_reduction_pass1_dispatch_0_generic_1024x512x256 ordinal(0) layout(#pipeline_layout) {
    ^bb0(%arg0: !hal.device, %arg1: index, %arg2: index):
      %x, %y, %z = flow.dispatch.workgroup_count_from_dag_root %arg1, %arg2
      hal.return %x, %y, %z : index, index, index
    }
    builtin.module {
      func.func @split_reduction_pass1_dispatch_0_generic_1024x512x256() {
        ...
        %3 = linalg.init_tensor [1024, 512] : tensor<1024x512xi32>
...
hal.executable private @split_reduction_pass2_dispatch_0 {
  hal.executable.variant public @embedded_elf_x86_64, target = #executable_target_embedded_elf_x86_64_ {
    hal.executable.export public @split_reduction_pass2_dispatch_0_generic_1024xDx256 ordinal(0) layout(#pipeline_layout) {
    ^bb0(%arg0: !hal.device, %arg1: index, %arg2: index, %arg3: index):
      %x, %y, %z = flow.dispatch.workgroup_count_from_dag_root %arg1, %arg2, %arg3
      hal.return %x, %y, %z : index, index, index
    }
    builtin.module {
      func.func @split_reduction_pass2_dispatch_0_generic_1024xDx256() {
        ...
        %5 = linalg.init_tensor [1024, %1] : tensor<1024x?xi32>
...
// CHECK:     func.func @split_reduction_pass2_dispatch_0_generic_1024xDx256()
// CHECK-DAG:   %[[C0:.+]] = arith.constant 0 : index
...
hal.executable private @split_reduction_pass3_dispatch_0 {
  hal.executable.variant public @embedded_elf_x86_64, target = #executable_target_embedded_elf_x86_64_ {
    hal.executable.export public @split_reduction_pass3_dispatch_0_generic_1024x513x256 ordinal(0) layout(#pipeline_layout) {
    ^bb0(%arg0: !hal.device, %arg1: index, %arg2: index, %arg3: index):
      %x, %y, %z = flow.dispatch.workgroup_count_from_dag_root %arg1, %arg2, %arg3
      hal.return %x, %y, %z : index, index, index
    }
    builtin.module {
      func.func @split_reduction_pass3_dispatch_0_generic_1024x513x256() {
        %c0 = arith.constant 0 : index
...
hal.executable private @split_reduction_fail1_dispatch_0 {
  hal.executable.variant public @embedded_elf_x86_64, target = #executable_target_embedded_elf_x86_64_ {
    hal.executable.export public @split_reduction_fail1_dispatch_0_generic_1024x512xD ordinal(0) layout(#pipeline_layout) {
    ^bb0(%arg0: !hal.device, %arg1: index, %arg2: index, %arg3: index):
      %x, %y, %z = flow.dispatch.workgroup_count_from_dag_root %arg1, %arg2, %arg3
      hal.return %x, %y, %z : index, index, index
    }
    builtin.module {
      func.func @split_reduction_fail1_dispatch_0_generic_1024x512xD() {
        %cst = arith.constant dense<0> : tensor<1024x512xi32>
        %c0 = arith.constant 0 : index
        %0 = hal.interface.constant.load[0] : i32
        %1 = arith.index_castui %0 : i32 to index
...
// CHECK:     func.func @split_reduction_fail1_dispatch_0_generic_1024x512xD()
...
hal.executable private @split_reduction_fail2_dispatch_0 {
  hal.executable.variant public @embedded_elf_x86_64, target = #executable_target_embedded_elf_x86_64_ {
    hal.executable.export public @split_reduction_fail2_dispatch_0_generic_1024x512x257 ordinal(0) layout(#pipeline_layout) {
    ^bb0(%arg0: !hal.device, %arg1: index, %arg2: index, %arg3: index):
      %x, %y, %z = flow.dispatch.workgroup_count_from_dag_root %arg1, %arg2, %arg3
      hal.return %x, %y, %z : index, index, index
    }
    builtin.module {
      func.func @split_reduction_fail2_dispatch_0_generic_1024x512x257() {
        %c0 = arith.constant 0 : index
        %cst = arith.constant dense<0> : tensor<1024x512xi32>
...
// CHECK:     func.func @split_reduction_fail2_dispatch_0_generic_1024x512x257()
// CHECK-NOT:   scf.yield %{{.+}} : vector<1x1x4xi32>
// CHECK-NOT:   vector.reduction
...
hal.executable private @split_reduction_fail3_dispatch_0 {
  hal.executable.variant public @embedded_elf_x86_64, target = #executable_target_embedded_elf_x86_64_ {
    hal.executable.export public @split_reduction_fail3_dispatch_0_generic_1024x256x512 ordinal(0) layout(#pipeline_layout) {
    ^bb0(%arg0: !hal.device, %arg1: index, %arg2: index, %arg3: index):
      %x, %y, %z = flow.dispatch.workgroup_count_from_dag_root %arg1, %arg2, %arg3
      hal.return %x, %y, %z : index, index, index
    }
    builtin.module {
      func.func @split_reduction_fail3_dispatch_0_generic_1024x256x512() {
        %c0 = arith.constant 0 : index
...
// CHECK:     func.func @split_reduction_fail3_dispatch_0_generic_1024x256x512()
// CHECK-NOT:   scf.yield %{{.+}} : vector<1x1x4xi32>
// CHECK-NOT:   vector.reduction
...
hal.executable private @split_reduction_fail4_dispatch_0 {
  hal.executable.variant public @embedded_elf_x86_64, target = #executable_target_embedded_elf_x86_64_ {
    hal.executable.export public @split_reduction_fail4_dispatch_0_generic_1024x512x256 ordinal(0) layout(#pipeline_layout) {
    ^bb0(%arg0: !hal.device, %arg1: index, %arg2: index, %arg3: index):
      %x, %y, %z = flow.dispatch.workgroup_count_from_dag_root %arg1, %arg2, %arg3
      hal.return %x, %y, %z : index, index, index
    }
    builtin.module {
      func.func @split_reduction_fail4_dispatch_0_generic_1024x512x256() {
        %c0 = arith.constant 0 : index
...
// CHECK:     func.func @split_reduction_fail4_dispatch_0_generic_1024x512x256()
