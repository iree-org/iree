// RUN: iree-opt --iree-codegen-llvmcpu-vector-transpose-lowering-pipeline --split-input-file %s | FileCheck %s
...
//       CHECK:   vector.transpose %{{.*}}, [1, 0] : vector<8x16xi8> to vector<16x8xi8>
