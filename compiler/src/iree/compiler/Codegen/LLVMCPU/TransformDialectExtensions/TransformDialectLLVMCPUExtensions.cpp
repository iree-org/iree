...
#include "TransformDialectLLVMCPUExtensions.h"

using namespace mlir;
using namespace mlir::iree_compiler;
using namespace mlir::iree_compiler::IREE;

iree_compiler::IREE::transform_dialect::TransformDialectLLVMCPUExtensions::
...
void mlir::iree_compiler::registerTransformDialectLLVMCPUExtension(
  ...
  registry
      .addExtensions<transform_dialect::TransformDialectLLVMCPUExtensions>();
}
