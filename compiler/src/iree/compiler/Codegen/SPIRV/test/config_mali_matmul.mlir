  ...
  hal.executable.variant @vulkan_spirv_fb, target = <"vulkan", "vulkan-spirv-fb", {
    ...
    builtin.module {
      func.func @matmul_1024x2048x512() {
        ...
        %15 = tensor.empty(1024, 2048) : tensor<1024x2048xf32>
  ...
  hal.executable.variant @vulkan_spirv_fb, target = <"vulkan", "vulkan-spirv-fb", {
    ...
    builtin.module {
      func.func @matmul_3136x24x96() {
        ...
        %15 = tensor.empty(3136, 24) : tensor<3136x24xf32>
  ...
  hal.executable.variant @vulkan_spirv_fb, target = <"vulkan", "vulkan-spirv-fb", {
    ...
    builtin.module {
      func.func @matmul_196x64x192() {
        ...
        %15 = tensor.empty(196, 64) : tensor<196x64xf32>
  ...
  hal.executable.variant @vulkan_spirv_fb, target = <"vulkan", "vulkan-spirv-fb", {
    ...
    builtin.module {
      func.func @matmul_49x160x576() {
        ...
        %15 = tensor.empty(49, 160) : tensor<49x160xf32>
  ...
  hal.executable.variant @vulkan_spirv_fb, target = <"vulkan", "vulkan-spirv-fb", {
    ...
    builtin.module {
      func.func @matmul_1x1024x576() {
        ...
        %0 = hal.interface.binding.subspan set(0) binding(0) type(storage_buffer) offset(%c0) alignment(64) : !flow.dispatch.tensor<readonly:1x576xf32>
        %1 = hal.interface.binding.subspan set(0) binding(1) type(storage_buffer) offset(%c3436864) alignment(64) : !flow.dispatch.tensor<readonly:576x1024xf32>
        %2 = hal.interface.binding.subspan set(0) binding(1) type(storage_buffer) offset(%c10141312) alignment(64) : !flow.dispatch.tensor<readonly:1x1024xf32>
        %3 = hal.interface.binding.subspan set(0) binding(2) type(storage_buffer) offset(%c0) alignment(64) : !flow.dispatch.tensor<writeonly:1x1024xf32>
        ...
        %7 = tensor.empty(1, 1024) : tensor<1x1024xf32>
  ...
  hal.executable.variant @vulkan_spirv_fb, target = <"vulkan", "vulkan-spirv-fb", {
    ...
    builtin.module {
      func.func @batch_matmul_4x384x384() {
        ...
        %21 = tensor.empty(4, 384, 384) : tensor<4x384x384xf32>
  ...
  hal.executable.variant @vulkan_spirv_fb, target = <"vulkan", "vulkan-spirv-fb", {
    ...
    builtin.module {
      func.func @batch_matmul_4x2x8() {
        ...
        %21 = tensor.empty(4, 2, 8) : tensor<4x2x8xf32>
  ...
  hal.executable.variant @vulkan_spirv_fb, target = <"vulkan", "vulkan-spirv-fb", {
    ...
    builtin.module {
      func.func @generic_batch_matmul_32x2x512() {
        %c0 = arith.constant 0 : index
        %cst = arith.constant 0.000000e+00 : f32
        %0 = hal.interface.binding.subspan set(0) binding(0) type(storage_buffer) offset(%c0) alignment(64) : !flow.dispatch.tensor<readonly:8x32x64xf32>
        %1 = hal.interface.binding.subspan set(0) binding(1) type(storage_buffer) offset(%c0) alignment(64) : !flow.dispatch.tensor<readonly:32x64x512xf32>
        ...
        %5 = tensor.empty(32, 8, 512) : tensor<32x8x512xf32>
        ...
        flow.dispatch.tensor.store %7, %2, offsets = [0, 0, 0], sizes = [32, 2, 512], strides = [1, 1, 1] : tensor<32x8x512xf32> -> !flow.dispatch.tensor<writeonly:32x8x512xf32>
        return
      }
    }
  }
  ...
  hal.executable.variant @vulkan_spirv_fb, target = <"vulkan", "vulkan-spirv-fb", {
    ...
    builtin.module {
      func.func @generic_batch_matmul_8x2500x512x4608() {
        ...
        %9 = tensor.empty(8, 2500, 512) : tensor<8x2500x512xf32>
