// RUN: iree-opt --pass-pipeline='hal.executable(hal.executable.variant(iree-spirv-lower-executable-target-pass{test-lowering-configuration=true}))' --verify-diagnostics --split-input-file %s
