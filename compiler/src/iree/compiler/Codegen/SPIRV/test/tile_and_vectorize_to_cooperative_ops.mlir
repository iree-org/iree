// RUN: iree-opt --split-input-file --pass-pipeline='builtin.module(hal.executable(hal.executable.variant(builtin.module(func.func(iree-spirv-tile-to-cooperative-ops, iree-spirv-vector-lowering-to-cooperative-ops, canonicalize, cse)))))' %s | FileCheck %s
