...
#compilation = #iree_codegen.compilation_info<
    ...
    translation_info = <SPIRVMatmulPromoteVectorize multibuffer_count = 2>,
...
//       CHECK-DAG: #[[TRANSLATION:.+]] = #iree_codegen.translation_info<SPIRVMatmulPromoteVectorize multibuffer_count = 2>
...
//       CHECK-DAG: #[[TRANSLATION:.+]] = #iree_codegen.translation_info<SPIRVMatmulPromoteVectorize multibuffer_count = 2 store_stage = 0>
//           CHECK: hal.executable.export public @matmul_f32_128x256x64
//      CHECK-SAME:   translation_info = #[[TRANSLATION]]
//      CHECK-SAME:   workgroup_size = [16 : index, 8 : index, 1 : index]
//           CHECK: func.func @matmul_f32_128x256x64()
