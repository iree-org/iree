  ...
  hal.executable.variant public @vulkan_spirv_fb, target = <"vulkan", "vulkan-spirv-fb", {
    ...
    builtin.module {
      func.func @batch_matmul_1x3x32() {
        ...
        %21 = tensor.empty(1, 3, 32) : tensor<1x3x32xf32>
  ...
  hal.executable.variant public @vulkan_spirv_fb, target = <"vulkan", "vulkan-spirv-fb", {
    ...
    builtin.module {
      func.func @matmul_64x16() {
        ...
        %15 = tensor.empty(64, 16) : tensor<64x16xi32>
  ...
  hal.executable.variant public @vulkan_spirv_fb, target = <"vulkan", "vulkan-spirv-fb", {
    ...
    builtin.module {
      func.func @matmul_400x273() {
        ...
        %11 = tensor.empty(400, 273) : tensor<400x273xf32>
        ...
        %16 = tensor.empty(400, 273) : tensor<400x273xf32>
  ...
  hal.executable.variant public @vulkan_spirv_fb, target = <"vulkan", "vulkan-spirv-fb", {
    ...
    builtin.module {
      func.func @matmul_25x546() {
        ...
        %11 = tensor.empty(25, 546) : tensor<25x546xf32>
        ...
        %16 = tensor.empty(25, 546) : tensor<25x546xf32>
    ...
    builtin.module {
      func.func @matmul_pointwise_256x1024() {
        ...
        %12 = flow.dispatch.tensor.load %1, offsets = [0, 0], sizes = [256, 1024], strides = [1, 1]
            : !flow.dispatch.tensor<readonly:256x1024xf16> -> tensor<256x1024xf16>
        %13 = tensor.empty(256, 1024) : tensor<256x1024xf16>
        ...
        %18 = tensor.empty(256, 1024) : tensor<256x1024xf16>
