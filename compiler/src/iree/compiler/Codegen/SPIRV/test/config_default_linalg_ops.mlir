  ...
  hal.executable.variant @vulkan_spirv_fb, target = <"vulkan-spirv", "vulkan-spirv-fb", {
    ...
    builtin.module {
      func.func @avg_pool() {
        ...
        %2 = tensor.empty(12, 12) : tensor<12x12xf32>
        ...
        %20 = tensor.empty(1, 2, 2, 8) : tensor<1x2x2x8xf32>
  ...
  hal.executable.variant @vulkan_spirv_fb, target = <"vulkan-spirv", "vulkan-spirv-fb", {
    ...
    builtin.module {
      func.func @avg_pool() {
        ...
        %3 = tensor.empty(7, 7) : tensor<7x7xf32>
        %4 = tensor.empty(1, 1, 1, 1280) : tensor<1x1x1x1280xf32>
  ...
  hal.executable.variant @vulkan_spirv_fb, target = #hal.executable.target<"vulkan-spirv", "vulkan-spirv-fb", {
    ...
    builtin.module  {
      func.func @max_pool() {
        ...
        %2 = tensor.empty(2, 1) : tensor<2x1xf32>
        ...
        %18 = tensor.empty(1, 38, 1, 1) : tensor<1x38x1x1xf32>
  ...
  hal.executable.variant @vulkan_spirv_fb, target = #hal.executable.target<"vulkan-spirv", "vulkan-spirv-fb", {
    ...
    builtin.module {
      func.func @elementwise() {
        ...
        %11 = tensor.empty(10) : tensor<10xf32>
        %12 = linalg.generic {
  ...
  hal.executable.variant @vulkan_spirv_fb, target = #hal.executable.target<"vulkan-spirv", "vulkan-spirv-fb", {
    ...
    builtin.module  {
      func.func @dwconv_elementwise() {
        ...
        %11 = tensor.empty(1, 19, 18, 1, 4) : tensor<1x19x18x1x4xf32>
        ...
        %18 = tensor.empty(1, 19, 18, 1, 4) : tensor<1x19x18x1x4xf32>
  ...
  hal.executable.variant @vulkan_spirv_fb, target = <"vulkan-spirv", "vulkan-spirv-fb", {
    ...
    builtin.module {
      func.func @outermost_reduction() {
        ...
        %3 = tensor.empty(2048, 512) : tensor<2048x512xf32>
  ...
  hal.executable.variant public @vulkan_spirv_fb, target = <"vulkan-spirv", "vulkan-spirv-fb", {
    ...
    builtin.module {
      func.func @innermost_reduction() {
        ...
        %11 = tensor.empty(128) : tensor<128xf32>
  ...
  hal.executable.variant @vulkan_spirv_fb, target = <"vulkan-spirv", "vulkan-spirv-fb", {
    ...
    builtin.module {
      func.func @four_dim_elementwise() {
        ...
        %3 = tensor.empty(128, 256, 4, 8) : tensor<128x256x4x8xf32>
        %4 = linalg.generic {
