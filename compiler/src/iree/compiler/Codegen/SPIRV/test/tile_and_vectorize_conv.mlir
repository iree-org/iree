...
// RUN:   --pass-pipeline='builtin.module(hal.executable(hal.executable.variant(builtin.module(func.func(iree-spirv-create-fast-slow-path,iree-spirv-tile,canonicalize,cse,iree-codegen-generic-vectorization,iree-spirv-vectorize,canonicalize,cse)))))' \
// RUN:   %s | FileCheck %s
  ...
  hal.executable.variant @vulkan, target = <"vulkan-spirv", "vulkan-spirv-fb"> {
    ...
    builtin.module  {
      func.func @nhwc_conv_static_shape_f32() {
        ...
        %9 = flow.dispatch.tensor.load %2, offsets = [0, %3, %5, %7], sizes = [1, 4, 4, 16], strides = [1, 1, 1, 1] : !flow.dispatch.tensor<writeonly:tensor<1x112x112x16xf32>> -> tensor<1x4x4x16xf32>
        ...
        %13 = flow.dispatch.tensor.load %1, offsets = [0, 0, 0, %7], sizes = [3, 3, 8, 16], strides = [1, 1, 1, 1] : !flow.dispatch.tensor<readonly:tensor<3x3x8x16xf32>> -> tensor<3x3x8x16xf32>
        ...
        flow.dispatch.tensor.store %15, %2, offsets = [0, %3, %5, %7], sizes = [1, 4, 4, 16], strides = [1, 1, 1, 1] : tensor<1x4x4x16xf32> -> !flow.dispatch.tensor<writeonly:tensor<1x112x112x16xf32>>
        return
      }
    }
  }
  ...
  hal.executable.variant @vulkan, target = <"vulkan-spirv", "vulkan-spirv-fb"> {
    ...
    builtin.module {
      func.func @low_padded_conv() {
        ...
        %16 = flow.dispatch.tensor.load %2, offsets = [0, %workgroup_id_z, %7, %9], sizes = [1, 1, %14, %15], strides = [1, 1, 1, 1] : !flow.dispatch.tensor<readonly:tensor<1x112x112x32xf32>> -> tensor<1x1x?x?xf32>
        ...
        %34 = flow.dispatch.tensor.load %1, offsets = [0, 0, 0, %9], sizes = [3, 3, 3, %33], strides = [1, 1, 1, 1] : !flow.dispatch.tensor<readonly:tensor<3x3x3x32xf32>> -> tensor<3x3x3x?xf32>
        ...
        flow.dispatch.tensor.store %41, %3, offsets = [0, %workgroup_id_z, %7, %9], sizes = [1, 1, %18, %19], strides = [1, 1, 1, 1] : tensor<1x1x?x?xf32> -> !flow.dispatch.tensor<writeonly:tensor<1x112x112x32xf32>>
        return
      }
    }
  }
  ...
  hal.executable.variant @vulkan, target = <"vulkan-spirv", "vulkan-spirv-fb"> {
    ...
    builtin.module {
      func.func @low_high_padded_nhwc_depthwise_conv() {
        ...
        %12 = flow.dispatch.tensor.load %2, offsets = [%9], sizes = [%11], strides = [1] : !flow.dispatch.tensor<readonly:tensor<32xf32>> -> tensor<?xf32>
        %14 = affine.min affine_map<(d0) -> (4, -d0 + 112)>(%7)[]
        ...
        %42 = flow.dispatch.tensor.load %1, offsets = [0, 0, %9], sizes = [3, 3, %41], strides = [1, 1, 1] : !flow.dispatch.tensor<readonly:tensor<3x3x32xf32>> -> tensor<3x3x?xf32>
        ...
        flow.dispatch.tensor.store %49, %3, offsets = [0, %workgroup_id_z, %7, %9], sizes = [1, 1, %16, %17], strides = [1, 1, 1, 1] : tensor<1x1x?x?xf32> -> !flow.dispatch.tensor<writeonly:tensor<1x112x112x32xf32>>
        return
      }
    }
  }
  ...
  hal.executable.variant @vulkan, target = <"vulkan-spirv", "vulkan-spirv-fb"> {
    ...
    builtin.module  {
      func.func @nchw_conv_static_shape_f32() {
        ...
        %9 = flow.dispatch.tensor.load %0, offsets = [0, 0, %5, %7], sizes = [2, 1280, 10, 10], strides = [1, 1, 1, 1] : !flow.dispatch.tensor<readonly:tensor<2x1280x10x10xf32>> -> tensor<2x1280x10x10xf32>
        %10 = flow.dispatch.tensor.load %1, offsets = [%3, 0, 0, 0], sizes = [16, 1280, 3, 3], strides = [1, 1, 1, 1] : !flow.dispatch.tensor<readonly:tensor<1280x1280x3x3xf32>> -> tensor<16x1280x3x3xf32>
        %11 = flow.dispatch.tensor.load %2, offsets = [0, %3, %5, %7], sizes = [2, 16, 8, 8], strides = [1, 1, 1, 1] : !flow.dispatch.tensor<readwrite:tensor<2x1280x8x8xf32>> -> tensor<2x16x8x8xf32>
        ...
        flow.dispatch.tensor.store %12, %2, offsets = [0, %3, %5, %7], sizes = [2, 16, 8, 8], strides = [1, 1, 1, 1] : tensor<2x16x8x8xf32> -> !flow.dispatch.tensor<readwrite:tensor<2x1280x8x8xf32>>
        return
      }
    }
  }
