        ...
        scf.for %arg0 = %workgroup_id_z to %c112 step %workgroup_count_z {
          ...
          scf.for %arg1 = %7 to %c112 step %8 {
            ...
            scf.for %arg2 = %9 to %c32 step %10 {
              ...
              %41 = linalg.generic {indexing_maps = [affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>, affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>, affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>], iterator_types = [#linalg.iterator_type<parallel>, #linalg.iterator_type<parallel>, #linalg.iterator_type<parallel>, #linalg.iterator_type<parallel>]} ins(%40, %16 : tensor<1x1x?x?xf32>, tensor<1x1x?x?xf32>) outs(%20 : tensor<1x1x?x?xf32>) {
        ...
        scf.for %arg0 = %workgroup_id_z to %c112 step %workgroup_count_z {
          ...
          scf.for %arg1 = %7 to %c112 step %8 {
            ...
            scf.for %arg2 = %9 to %c32 step %10 {
              ...
              %49 = linalg.generic {indexing_maps = [affine_map<(d0, d1, d2, d3) -> (d3)>, affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>, affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>], iterator_types = [#linalg.iterator_type<parallel>, #linalg.iterator_type<parallel>, #linalg.iterator_type<parallel>, #linalg.iterator_type<parallel>]} ins(%12, %48 : tensor<?xf32>, tensor<1x1x?x?xf32>) outs(%18 : tensor<1x1x?x?xf32>) {
              ^bb0(%arg3: f32, %arg4: f32, %arg5: f32):
