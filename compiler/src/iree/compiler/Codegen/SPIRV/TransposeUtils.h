...
#ifndef IREE_COMPILER_CODEGEN_SPIRV_TRANSPOSEUTILS_H_
#define IREE_COMPILER_CODEGEN_SPIRV_TRANSPOSEUTILS_H_
...
#endif  // IREE_COMPILER_CODEGEN_SPIRV_TRANSPOSEUTILS_H_
