  ...
  void runOnOperation() override {
    ...
    {  // Tile convolution output window dimension by 1 to prepare downsizing.
      ...
      for (linalg::ConvolutionOpInterface convOp : convOps) {
        ...
        // Fully unroll the generated loop.
    ...
    {  // Downsize n-D (n > 1) convolutions to 1-D.
      ...
      // Downsizing creates dobule extract/insert slice ops. Fold them.
      tensor::populateFoldConsecutiveInsertExtractSlicePatterns(patterns);
