...
createExportWrapperFunc(IREE::ABI::InvocationModel invocationModel,
  ...
  // wrapped op.
  if (IREE::Util::PreprocessingPassPipelineAttr preprocessingPassPipeline =
          IREE::Util::getPreprocessingPassPipelineAttribute(exportOp)) {
    IREE::Util::setPreprocessingPassPipelineAttribute(
        wrapperOp, preprocessingPassPipeline);
  }
