// RUN: iree-opt --pass-pipeline="builtin.module(iree-io-export-parameterizable-globals{archive-path="%t.irpa" scope=opt minimum-size=0})" %s | FileCheck %s
...
// CHECK-DAG: util.global private @dense_global_2 = #stream.parameter.named<"opt"::"dense_global_2"> : tensor<1x2xf32>
// CHECK-DAG: util.global private @dense_global_3 = #stream.parameter.named<"opt"::"dense_global_3"> : tensor<2x2xf32>
