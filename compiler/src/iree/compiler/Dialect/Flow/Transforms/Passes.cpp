...
void registerFlowTransformPassPipeline() {
  PassPipelineRegistration<> preprocessingTransformPassPipeline(
      "iree-flow-preprocessing-transformation-pipeline",
      "Runs the IREE flow dialect preprocessing transformation pipeline",
      [](OpPassManager &passManager) {
        buildFlowPreprocessingTransformPassPipeline(passManager);
      });
