...
flow.executable @nested_ops_ex_0 {
  ...
  builtin.module {
    func.func @nested_ops_entry_0(%input0: tensor<5x6xf32>, %input1: tensor<5x6xf32>) -> tensor<5x6xf32> {
      ...
      %max = linalg.generic {indexing_maps = [#map0, #map0, #map0], iterator_types = [#linalg.iterator_type<parallel>, #linalg.iterator_type<parallel>]} ins(%input0, %input1 : tensor<5x6xf32>, tensor<5x6xf32>) outs(%init : tensor<5x6xf32>) {
...
flow.executable @nested_ops_ex_2 {
  ...
  builtin.module {
    func.func @nested_ops_entry_2(%input0: tensor<5x6xf32>, %input1: tensor<5x6xf32>) -> tensor<5x6xf32> {
      %init = tensor.empty() : tensor<5x6xf32>
      %min = linalg.generic {indexing_maps = [#map0, #map0, #map0], iterator_types = [#linalg.iterator_type<parallel>, #linalg.iterator_type<parallel>]} ins(%input0, %input1 : tensor<5x6xf32>, tensor<5x6xf32>) outs(%init : tensor<5x6xf32>) {
      ^bb0(%arg1: f32, %arg2: f32, %arg3: f32):  // no predecessors
...
flow.executable @attributes_ex_1 {
  ...
  builtin.module {
    func.func @attributes_entry_1(%input0: tensor<5x6xf32>, %input1: tensor<5x6xf32>) -> tensor<5x6xf32> {
      ...
      %max = linalg.generic {indexing_maps = [#map1, #map1, #map1], iterator_types = [#linalg.iterator_type<parallel>, #linalg.iterator_type<parallel>]} ins(%input0, %input1 : tensor<5x6xf32>, tensor<5x6xf32>) outs(%init : tensor<5x6xf32>) {
      ^bb0(%arg1: f32, %arg2: f32, %arg3: f32):  // no predecessors
        %27 = arith.maxf %arg1, %arg2 : f32
        linalg.yield %27 : f32
      } -> tensor<5x6xf32>
