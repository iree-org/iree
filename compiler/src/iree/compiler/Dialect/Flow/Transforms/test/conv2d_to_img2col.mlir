...
//      CHECK: %[[INIT_COL_TENSOR:.+]] = tensor.empty(1, 14, 14, 3, 3, 4) : tensor<1x14x14x3x3x4xf32>
...
//      CHECK: %[[INPUT_T_INIT:.+]] = tensor.empty(1, 16, 114, 114) : tensor<1x16x114x114xf32>
...
//      CHECK: %[[FILTER_T_INIT:.+]] = tensor.empty(16, 3, 3) : tensor<16x3x3xf32>
...
//      CHECK: %[[INIT_OUTPUT_TENSOR:.+]] = tensor.empty(1, 16, 112, 112) : tensor<1x16x112x112xf32>
...
//      CHECK:  %[[INIT_COL_TENSOR:.+]] = tensor.empty(1, 16, 112, 112, 3, 3) : tensor<1x16x112x112x3x3xf32>
//      CHECK: %[[COL_TENSOR:.+]] = linalg.generic
...
//      CHECK: %[[RESULT_INIT:.+]] = tensor.empty(1, 112, 112, 16) : tensor<1x112x112x16xf32>
...
//      CHECK:   %[[IT:.+]] = tensor.empty(8, 14, 14, 3, 3, 4) : tensor<8x14x14x3x3x4xf32>
