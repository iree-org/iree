// RUN: iree-opt --split-input-file --verify-diagnostics --pass-pipeline="builtin.module(func.func(iree-flow-interchange-transpose-generic-ops,iree-flow-form-dispatch-regions-pass{aggressive-fusion=true}, iree-flow-form-dispatch-workgroups-pass, canonicalize, cse))" %s | FileCheck %s
