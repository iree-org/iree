...
//      CHECK: %[[LHS4DT_INIT:.+]] = tensor.empty(3, 4, 8, 2) : tensor<3x4x8x2xf32>
...
//      CHECK: %[[RHS4DT_INIT:.+]] = tensor.empty(8, 4, 4, 2) : tensor<8x4x4x2xf32>
...
// CHECK-NEXT: %[[DST4DT_INIT:.+]] = tensor.empty(3, 8, 8, 4) : tensor<3x8x8x4xf32>
...
//      CHECK: %[[MMT4DT_INIT:.+]] = tensor.empty(3, 8, 8, 4) : tensor<3x8x8x4xf32>
...
func.func @check_mmt4d_with_init_tensor_and_fill(%arg0: tensor<24x8xf32>, %arg1: tensor<8x32xf32>) -> tensor<24x32xf32> {
    ...
    %0 = tensor.empty(24, 32) : tensor<24x32xf32>
...
//      CHECK: %[[RHS4D:.+]] = tensor.expand_shape %[[RHS]]
// CHECK-SAME:   tensor<8x32xf32> into tensor<4x2x8x4xf32>
//      CHECK: %[[DST_INIT:.+]] = tensor.empty(3, 8, 8, 4) : tensor<3x8x8x4xf32>
