...
//  CHECK-DAG:     %[[ARG6_W:.+]] = flow.dispatch.workload_ordinal %[[ARG6]] 0
//  CHECK-DAG:     %[[ARG7_W:.+]] = flow.dispatch.workload_ordinal %[[ARG7]] 1
//  CHECK-DAG:     %[[ARG8_W:.+]] = flow.dispatch.workload_ordinal %[[ARG8]] 2
//  CHECK-DAG:     %[[ARG9_W:.+]] = flow.dispatch.workload_ordinal %[[ARG9]] 3
//  CHECK-DAG:     %[[ARG10_W:.+]] = flow.dispatch.workload_ordinal %[[ARG10]] 4
//  CHECK-DAG:     %[[ARG11_W:.+]] = flow.dispatch.workload_ordinal %[[ARG11]] 5
...
//      CHECK:       %[[WX:.+]], %[[WY:.+]], %[[WZ:.+]] = flow.dispatch.workgroup_count_from_body_slice %[[W0]], %[[W1]], %[[W2]], %[[W3]], %[[W4]], %[[W5]]
...
//  CHECK-DAG:     %[[ARG0_D0_W:.+]] = flow.dispatch.workload_ordinal %[[ARG0_D0_CAPTURE]] 0
//  CHECK-DAG:     %[[ARG0_D1_W:.+]] = flow.dispatch.workload_ordinal %[[ARG0_D1_CAPTURE]] 1
//  CHECK-DAG:     %[[ARG1_D0_W:.+]] = flow.dispatch.workload_ordinal %[[ARG1_D0_CAPTURE]] 2
//  CHECK-DAG:     %[[ARG0_D0_W_0:.+]] = flow.dispatch.workload_ordinal %[[ARG0_D0_CAPTURE]] 3
//  CHECK-DAG:     %[[ARG0_D1_W_0:.+]] = flow.dispatch.workload_ordinal %[[ARG0_D1_CAPTURE]] 4
...
//   CHECK-DAG:        %[[ARG0_DIM0_W:.+]] = flow.dispatch.workload_ordinal %[[ARG0_DIM0_CAPTURE]] 0
//   CHECK-DAG:        %[[ARG0_DIM1_W:.+]] = flow.dispatch.workload_ordinal %[[ARG0_DIM1_CAPTURE]] 1
//   CHECK-DAG:        %[[ARG1_DIM0_W:.+]] = flow.dispatch.workload_ordinal %[[ARG1_DIM0_CAPTURE]] 2
//   CHECK-DAG:        %[[ARG1_DIM1_W:.+]] = flow.dispatch.workload_ordinal %[[ARG1_DIM1_CAPTURE]] 3
//   CHECK-DAG:        %[[ARG0_DIM0_W_0:.+]] = flow.dispatch.workload_ordinal %[[ARG0_DIM0_CAPTURE]] 4
//   CHECK-DAG:        %[[ARG1_DIM1_W_0:.+]] = flow.dispatch.workload_ordinal %[[ARG1_DIM1_CAPTURE]] 5
...
//  CHECK-DAG:     %[[ARG2_W:.+]] = flow.dispatch.workload_ordinal %[[ARG2_CAPTURE]] 0
//  CHECK-DAG:     %[[ARG3_W:.+]] = flow.dispatch.workload_ordinal %[[ARG3_CAPTURE]] 1
//  CHECK-DAG:     %[[ARG4_W:.+]] = flow.dispatch.workload_ordinal %[[ARG4_CAPTURE]] 2
//  CHECK-DAG:     %[[ARG5_W:.+]] = flow.dispatch.workload_ordinal %[[ARG5_CAPTURE]] 3
//  CHECK-DAG:     %[[ARG0_D0_W:.+]] = flow.dispatch.workload_ordinal %[[ARG0_D0_CAPTURE]] 4
//  CHECK-DAG:     %[[ARG0_D1_W:.+]] = flow.dispatch.workload_ordinal %[[ARG0_D1_CAPTURE]] 5
//  CHECK-DAG:     %[[ARG1_D0_W:.+]] = flow.dispatch.workload_ordinal %[[ARG1_D0_CAPTURE]] 6
//  CHECK-DAG:     %[[ARG1_D1_W:.+]] = flow.dispatch.workload_ordinal %[[ARG1_D1_CAPTURE]] 7
...
//  CHECK-DAG:     %[[ARG0_D0_W:.+]] = flow.dispatch.workload_ordinal %[[ARG0_D0_CAPTURE]] 0
//  CHECK-DAG:     %[[ARG0_D1_W:.+]] = flow.dispatch.workload_ordinal %[[ARG0_D1_CAPTURE]] 1
//  CHECK-DAG:     %[[ARG0_D2_W:.+]] = flow.dispatch.workload_ordinal %[[ARG0_D2_CAPTURE]] 2
//  CHECK-DAG:     %[[ARG1_D0_W:.+]] = flow.dispatch.workload_ordinal %[[ARG1_D0_CAPTURE]] 3
//  CHECK-DAG:     %[[ARG1_D1_W:.+]] = flow.dispatch.workload_ordinal %[[ARG1_D1_CAPTURE]] 4
//  CHECK-DAG:     %[[ARG1_D2_W:.+]] = flow.dispatch.workload_ordinal %[[ARG1_D2_CAPTURE]] 5
...
//  CHECK-DAG:     %[[ARG1_W:.+]] = flow.dispatch.workload_ordinal %[[ARG1_CAPTURE]] 0
//  CHECK-DAG:     %[[ARG2_W:.+]] = flow.dispatch.workload_ordinal %[[ARG2_CAPTURE]] 1
//  CHECK-DAG:     %[[ARG5_W:.+]] = flow.dispatch.workload_ordinal %[[ARG5_CAPTURE]] 2
//  CHECK-DAG:     %[[ARG6_W:.+]] = flow.dispatch.workload_ordinal %[[ARG6_CAPTURE]] 3
//  CHECK-DAG:     %[[ARG3_W:.+]] = flow.dispatch.workload_ordinal %[[ARG3_CAPTURE]] 6
//  CHECK-DAG:     %[[ARG4_W:.+]] = flow.dispatch.workload_ordinal %[[ARG4_CAPTURE]] 7
...
//  CHECK-DAG:     %[[SOURCE_OFFSET_Y_W:.+]] = flow.dispatch.workload_ordinal %[[SOURCE_OFFSET_Y_CAPTURE]] 0
//  CHECK-DAG:     %[[SOURCE_OFFSET_X_W:.+]] = flow.dispatch.workload_ordinal %[[SOURCE_OFFSET_X_CAPTURE]] 1
//  CHECK-DAG:     %[[SLICE_SIZE_W:.+]] = flow.dispatch.workload_ordinal %[[SLICE_SIZE_CAPTURE]] 2
//  CHECK-DAG:     %[[SOURCE_STRIDE_Y_W:.+]] = flow.dispatch.workload_ordinal %[[SOURCE_STRIDE_Y_CAPTURE]] 3
//  CHECK-DAG:     %[[SOURCE_STRIDE_X_W:.+]] = flow.dispatch.workload_ordinal %[[SOURCE_STRIDE_X_CAPTURE]] 4
//  CHECK-DAG:     %[[DEST_OFFSET_Y_W:.+]] = flow.dispatch.workload_ordinal %[[DEST_OFFSET_Y_CAPTURE]] 5
//  CHECK-DAG:     %[[DEST_OFFSET_X_W:.+]] = flow.dispatch.workload_ordinal %[[DEST_OFFSET_X_CAPTURE]] 6
//  CHECK-DAG:     %[[DEST_STRIDE_Y_W:.+]] = flow.dispatch.workload_ordinal %[[DEST_STRIDE_Y_CAPTURE]] 7
//  CHECK-DAG:     %[[DEST_STRIDE_X_W:.+]] = flow.dispatch.workload_ordinal %[[DEST_STRIDE_X_CAPTURE]] 8
//  CHECK-DAG:     %[[SOURCE_D0_W:.+]] = flow.dispatch.workload_ordinal %[[SOURCE_D0_CAPTURE]] 9
//  CHECK-DAG:     %[[SOURCE_D1_W:.+]] = flow.dispatch.workload_ordinal %[[SOURCE_D1_CAPTURE]] 10
//  CHECK-DAG:     %[[DEST_D0_W:.+]] = flow.dispatch.workload_ordinal %[[DEST_D0_CAPTURE]] 11
//  CHECK-DAG:     %[[DEST_D1_W:.+]] = flow.dispatch.workload_ordinal %[[DEST_D1_CAPTURE]] 12
...
//  CHECK-DAG:     %[[D0_W:.+]] = flow.dispatch.workload_ordinal %[[D0_CAPTURE]] 0
//  CHECK-DAG:     %[[D1_W:.+]] = flow.dispatch.workload_ordinal %[[D1_CAPTURE]] 1
//  CHECK-DAG:     %[[D2_W:.+]] = flow.dispatch.workload_ordinal %[[D2_CAPTURE]] 2
//  CHECK-DAG:     %[[D0_W_0:.+]] = flow.dispatch.workload_ordinal %[[D0_CAPTURE]] 3
//  CHECK-DAG:     %[[D1_W_0:.+]] = flow.dispatch.workload_ordinal %[[D1_CAPTURE]] 4
...
//  CHECK-DAG:     %[[W0:.+]] = flow.dispatch.workload_ordinal %[[INDEXARG0]] 0
//  CHECK-DAG:     %[[W1:.+]] = flow.dispatch.workload_ordinal %[[INDEXARG1]] 1
//  CHECK-DAG:     %[[W2:.+]] = flow.dispatch.workload_ordinal %[[INDEXARG0]] 2
//  CHECK-DAG:     %[[W3:.+]] = flow.dispatch.workload_ordinal %[[INDEXARG1]] 3
...
//      CHECK:     %[[X:[a-zA-Z0-9]+]], %[[Y:[a-zA-Z0-9]+]], %[[Z:.+]] = flow.dispatch.workgroup_count_from_body_slice %[[WL0]], %[[WL1]], %[[WL2]], %[[WL3]]
...
//  CHECK-DAG:     %[[D0_W:.+]] = flow.dispatch.workload_ordinal %[[INDEXARG0]] 0
//  CHECK-DAG:     %[[D1_W:.+]] = flow.dispatch.workload_ordinal %[[INDEXARG1]] 1
//  CHECK-DAG:     %[[D0_W_0:.+]] = flow.dispatch.workload_ordinal %[[INDEXARG0]] 2
//  CHECK-DAG:     %[[D1_W_0:.+]] = flow.dispatch.workload_ordinal %[[INDEXARG1]] 3
//      CHECK:     %[[LOAD:.+]] = flow.dispatch.tensor.load %[[INARG]]
...
// CHECK-SAME:       %[[OUTARG:[a-zA-Z0-9]+]]: !flow.dispatch.tensor<writeonly:tensor<?x?xf32, #iree_linalg_ext.encoding<MATMUL_F32F32F32_LHS>>>
//  CHECK-DAG:     %[[D1_W:.+]] = flow.dispatch.workload_ordinal %[[INDEXARG1]] 0
//  CHECK-DAG:     %[[D0_W:.+]] = flow.dispatch.workload_ordinal %[[INDEXARG0]] 1
//  CHECK-DAG:     %[[D0_W_0:.+]] = flow.dispatch.workload_ordinal %[[INDEXARG0]] 2
//  CHECK-DAG:     %[[D1_W_1:.+]] = flow.dispatch.workload_ordinal %[[INDEXARG1]] 3
//  CHECK-DAG:     %[[PADDED_D0_W:.+]] = flow.dispatch.workload_ordinal %[[PADDED_D0]] 4
//  CHECK-DAG:     %[[PADDED_D1_W:.+]] = flow.dispatch.workload_ordinal %[[PADDED_D1]] 5
//      CHECK:     %[[LOAD:.+]] = flow.dispatch.tensor.load %[[INARG]]
...
//      CHECK:     %[[X:[a-zA-Z0-9]+]], %[[Y:[a-zA-Z0-9]+]], %[[Z:.+]] = flow.dispatch.workgroup_count_from_body_slice %[[WL0]], %[[WL1]], %[[WL2]], %[[WL3]], %[[WL4]], %[[WL5]]
//      CHECK:     flow.return %[[X]], %[[Y]], %[[Z]]
//      CHECK:   return %[[DISPATCH]]
...
//  CHECK-DAG:     %[[D0_W:.+]] = flow.dispatch.workload_ordinal %[[INDEXARG0]] 0
//  CHECK-DAG:     %[[D1_W:.+]] = flow.dispatch.workload_ordinal %[[INDEXARG1]] 1
//  CHECK-DAG:     %[[ARG0_W:.+]] = flow.dispatch.workload_ordinal %[[INDEXARG2]] 2
//  CHECK-DAG:     %[[ARG1_W:.+]] = flow.dispatch.workload_ordinal %[[INDEXARG3]] 3
//      CHECK:     %[[LOAD:.+]] = flow.dispatch.tensor.load %[[INARG]]
// CHECK-SAME:         sizes = [%[[D0_W]], %[[D1_W]]]
// CHECK-SAME:         !flow.dispatch.tensor<readonly:tensor<?x?xf32, #iree_linalg_ext.encoding<MATMUL_F32F32F32_LHS>>>{%[[D0_W]], %[[D1_W]]}
//      CHECK:     %[[ENCODING:.+]] = iree_linalg_ext.unset_encoding %[[LOAD]]
