// RUN: iree-opt --split-input-file --verify-diagnostics --pass-pipeline="builtin.module(util.func(iree-flow-form-dispatch-regions{aggressive-fusion=true}, iree-flow-clone-producers-into-dispatch-regions, iree-flow-dispatch-regions-to-workgroups, iree-flow-dispatch-tensor, iree-flow-dispatch-workgroups-canonicalization), cse, canonicalize, cse)" %s | FileCheck %s
