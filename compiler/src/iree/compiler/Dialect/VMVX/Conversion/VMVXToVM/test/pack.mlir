...
func.func @pack_f32f32(
  ...
  // CHECK-SAME: %arg12,
  // CHECK-SAME: %[[FLAGS]]) : (!vm.buffer, !vm.buffer, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, f32, i32) -> ()
...
func.func @pack_i32i32(
  ...
  // CHECK-SAME: %arg9, %arg10, %arg11,
  // CHECK-SAME: %arg12,
  // CHECK-SAME: %[[FLAGS]]) : (!vm.buffer, !vm.buffer, i64, i64, i64, i64, i64, i64, i64, i64, i64, i64, i32, i32) -> ()
  vmvx.pack in(%arg0 offset %arg1 stride0 %arg2 : !util.buffer)
             out(%arg3 offset %arg4 stride0 %arg5 : !util.buffer)
             in_shape(%arg6, %arg7)
             out_shape(%arg8, %arg9, %arg10, %arg11)
