...
static llvm::cl::opt<bool> clUsePTXAS("iree-hal-use-ptxas",
                                      llvm::cl::init(true),
                                      llvm::cl::desc("Use ptxas."));
...
class CUDATargetBackend final : public TargetBackend {
 public:
  ...
  LogicalResult serializeExecutable(const SerializationOptions &options,
    ...
    if (!clUsePTXASfrom.empty() || clUsePTXAS) {
      auto ptxas_tool = clUsePTXASfrom.getValue();
      if (ptxas_tool.empty()) ptxas_tool = findTool("ptxas");
      FailureOr<std::string> maybePtxImage = compileWithPTXAS(
          ptxas_tool, clTargetChip, clUsePTXASparams, ptxImage);
