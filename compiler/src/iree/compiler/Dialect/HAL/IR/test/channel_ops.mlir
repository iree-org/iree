...
//  CHECK-SAME: (%[[DEVICE:.+]]: !hal.device, %[[AFFINITY:.+]]: i64, %[[ID:.+]]: !util.buffer)
func.func @channel_default(%device: !hal.device, %affinity: i64, %id: !util.buffer) {
  //      CHECK: %channel = hal.channel.default
  // CHECK-SAME:   device(%[[DEVICE]] : !hal.device)
  // CHECK-SAME:   affinity(%[[AFFINITY]])
  // CHECK-SAME:   flags(0)
  // CHECK-SAME:   id(%[[ID]]) : !hal.channel
