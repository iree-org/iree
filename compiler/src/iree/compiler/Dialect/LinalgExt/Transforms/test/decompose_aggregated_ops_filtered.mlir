// RUN: iree-opt --pass-pipeline="builtin.module(func.func(iree-linalg-ext-decompose-aggregated-ops{filter-ops='iree_linalg_ext.online_attention,iree_linalg_ext.custom_op'}), canonicalize, cse)" --split-input-file %s | FileCheck %s
