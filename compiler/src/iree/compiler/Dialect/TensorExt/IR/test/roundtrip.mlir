...
// Check for statically specified `max_ragged_column_length`

util.func public @staticMaxRaggedColumnLengths(%source : tensor<?x?x?xf32>,
...
// CHECK-LABEL: @staticMaxRaggedColumnLengths

// -----

// Check for dynamically specified `max_ragged_column_length`
...
// CHECK-LABEL: @dynamicMaxRaggedColumnLengths
