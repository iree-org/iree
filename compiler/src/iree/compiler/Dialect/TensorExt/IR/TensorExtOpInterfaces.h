...
/// `SparseOpInterface`, the operation needs to be used to resolve this range
/// (either to an estimated range or generate code that iterates over the exact
/// sparse range). This struct holds information of the sparse operation that
/// has to be used for the resolution, and the result dimension that defines the
/// range.
