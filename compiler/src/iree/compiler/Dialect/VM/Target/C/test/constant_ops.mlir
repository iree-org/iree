...
vm.module @rodata_ops {
  ...
  // CHECK-NEXT: [[BUFFER_PTR_1_LVAL:[^ ]*]] = [[BUFFER_PTR_1]];
  // CHECK-NEXT: [[VOID_PTR_1:[^ ]*]] = (void*) [[BUFFER_PTR_1_LVAL]];
  ...
  // CHECK-NEXT: [[BUFFER_PTR_2_LVAL:[^ ]*]] = [[BUFFER_PTR_2]];
  // CHECK-NEXT: [[VOID_PTR_2:[^ ]*]] = (void*) [[BUFFER_PTR_2_LVAL]];
