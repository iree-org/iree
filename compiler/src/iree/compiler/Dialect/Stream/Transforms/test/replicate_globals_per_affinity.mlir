// RUN: iree-opt --iree-stream-replicate-globals-per-affinity --split-input-file %s \
// RUN: | FileCheck %s --check-prefixes=CHECK,REPLICATE
// RUN: iree-opt --iree-stream-replicate-globals-per-affinity="use-transfers=true" --split-input-file %s \
