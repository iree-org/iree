...
void buildStreamAsyncPassPipeline(OpPassManager &passManager,
  ...
  if (transformOptions.parameterEncoderOutputFile.hasValue() &&
    ...
    encoderPassOptions.target = transformOptions.parameterEncoderTarget;
    encoderPassOptions.pipelineDepth =
        transformOptions.parameterEncoderPipelineDepth;
    encoderPassOptions.maxSlabSize =
        transformOptions.parameterEncoderMaxSlabSize;
