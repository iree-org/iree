...
util.func private @ElideUnusedParameterLoad(%scope: !util.buffer, %key: !util.buffer) {
...
// CHECK-SAME: (%[[TARGET:.+]]: !stream.resource<transient>, %[[TARGET_SIZE:.+]]: index, %[[OFFSET:.+]]: index, %[[LENGTH:.+]]: index, %[[SCOPE:.+]]: !util.buffer, %[[KEY:.+]]: !util.buffer)
util.func private @FoldAsyncParameterReadTargetSubview(%target: !stream.resource<transient>, %target_size: index, %offset: index, %length: index, %scope: !util.buffer, %key: !util.buffer) -> !stream.resource<transient> {
...
// CHECK-SAME: (%[[SOURCE:.+]]: !stream.resource<transient>, %[[SOURCE_SIZE:.+]]: index, %[[OFFSET:.+]]: index, %[[LENGTH:.+]]: index, %[[SCOPE:.+]]: !util.buffer, %[[KEY:.+]]: !util.buffer)
util.func private @FoldAsyncParameterWriteSourceSubview(%source: !stream.resource<transient>, %source_size: index, %offset: index, %length: index, %scope: !util.buffer, %key: !util.buffer) -> !stream.resource<transient> {
  // CHECK-DAG: %[[PARAM_OFFSET:.+]] = arith.constant 50 : i64
  %param_offset = arith.constant 50 : i64
  // CHECK-DAG: %[[RESOURCE_OFFSET:.+]] = arith.constant 100 : index
  %resource_offset = arith.constant 100 : index
...
// CHECK-SAME: (%[[TARGET:.+]]: !stream.resource<transient>, %[[TARGET_SIZE:.+]]: index, %[[OFFSET:.+]]: index, %[[SCOPE:.+]]: !util.buffer, %[[KEY0:.+]]: !util.buffer, %[[KEY1:.+]]: !util.buffer)
util.func private @FoldAsyncParameterGatherTargetSubview(%target: !stream.resource<transient>, %target_size: index, %offset: index, %scope: !util.buffer, %key0: !util.buffer, %key1: !util.buffer) -> !stream.resource<transient> {
...
// CHECK-SAME: (%[[SOURCE:.+]]: !stream.resource<transient>, %[[SOURCE_SIZE:.+]]: index, %[[OFFSET:.+]]: index, %[[SCOPE:.+]]: !util.buffer, %[[KEY0:.+]]: !util.buffer, %[[KEY1:.+]]: !util.buffer)
util.func private @FoldAsyncParameterScatterSourceSubview(%source: !stream.resource<transient>, %source_size: index, %offset: index, %scope: !util.buffer, %key0: !util.buffer, %key1: !util.buffer) -> !stream.resource<transient> {
  // CHECK-DAG: %[[PARAM_OFFSET0:.+]] = arith.constant 50 : i64
  %param_offset0 = arith.constant 50 : i64
  // CHECK-DAG: %[[PARAM_OFFSET1:.+]] = arith.constant 51 : i64
  %param_offset1 = arith.constant 51 : i64
...
// CHECK-SAME: (%[[OFFSET:.+]]: index, %[[SCOPE:.+]]: !util.buffer, %[[KEY:.+]]: !util.buffer)
util.func private @FoldAsyncParameterLoadResultSubview(%offset: index, %scope: !util.buffer, %key: !util.buffer) -> !stream.resource<constant> {
  // CHECK-DAG: %[[PARAM_OFFSET:.+]] = arith.constant 50 : i64
  %param_offset = arith.constant 50 : i64
...
// CHECK-SAME: (%[[OFFSET:.+]]: index, %[[SCOPE:.+]]: !util.buffer, %[[KEY:.+]]: !util.buffer)
util.func private @FoldAsyncParameterLoadResultSlice(%offset: index, %scope: !util.buffer, %key: !util.buffer) -> !stream.resource<constant> {
...
// CHECK-SAME: (%[[SCOPE:.+]]: !util.buffer, %[[KEY:.+]]: !util.buffer)
util.func private @FoldAsyncParameterLoadResultSubviewMultipleAwaits(%scope: !util.buffer, %key: !util.buffer) -> (!stream.resource<constant>, !stream.resource<constant>) {
...
// CHECK-SAME: (%[[SCOPE:.+]]: !util.buffer, %[[KEY:.+]]: !util.buffer)
util.func private @FoldAsyncParameterLoadResultSubviewMultipleSubviews(%scope: !util.buffer, %key: !util.buffer) -> (!stream.resource<constant>, !stream.resource<constant>) {
  // CHECK-DAG: %[[PARAM_OFFSET:.+]] = arith.constant 0 : i64
  %c0_i64 = arith.constant 0 : i64
  // CHECK-DAG: %[[SIZE:.+]] = arith.constant 100 : index
  %c100 = arith.constant 100 : index
...
// CHECK-SAME: (%[[PARAM_OFFSET:[a-zA-Z0-9]+]]: i64, %[[SIZE:[a-zA-Z0-9]+]]: index, %[[SLICE1_SIZE:[a-zA-Z0-9]+]]: index, %[[SLICE2_SIZE:[a-zA-Z0-9]+]]: index, %[[SLICE1_START:[a-zA-Z0-9]+]]: index, %[[SLICE1_END:[a-zA-Z0-9]+]]: index, %[[SLICE2_START:[a-zA-Z0-9]+]]: index, %[[SLICE2_END:[a-zA-Z0-9]+]]: index, %[[SCOPE:.+]]: !util.buffer, %[[KEY:.+]]: !util.buffer)
util.func private @FoldAsyncParameterLoadResultSliceMultipleSlices(%param_offset: i64, %size: index, %slice1_size: index, %slice2_size: index, %slice1_start: index, %slice1_end: index, %slice2_start: index, %slice2_end: index, %scope: !util.buffer, %key: !util.buffer) -> (!stream.resource<constant>, !stream.resource<constant>) {
...
// CHECK-SAME: (%[[PARAM_OFFSET:[a-zA-Z0-9]+]]: i64, %[[LOAD_SIZE:[a-zA-Z0-9]+]]: index, %[[SUBVIEW_OFFSET:[a-zA-Z0-9]+]]: index, %[[SUBVIEW_SIZE:[a-zA-Z0-9]+]]: index, %[[SCOPE:.+]]: !util.buffer, %[[KEY:.+]]: !util.buffer)
util.func private @FoldAsyncParameterLoadResultZeroOffsetSubview(%param_offset: i64, %load_size: index, %subview_offset: index, %subview_size: index, %scope: !util.buffer, %key: !util.buffer) -> !stream.resource<constant> {
...
// CHECK-SAME: (%[[LARGE_PARAM_OFFSET:[a-zA-Z0-9]+]]: i64, %[[LOAD_SIZE:[a-zA-Z0-9]+]]: index, %[[LARGE_SUBVIEW_OFFSET:[a-zA-Z0-9]+]]: index, %[[SUBVIEW_SIZE:[a-zA-Z0-9]+]]: index, %[[SCOPE:.+]]: !util.buffer, %[[KEY:.+]]: !util.buffer)
util.func private @FoldAsyncParameterLoadResultLargeI64Offsets(%large_param_offset: i64, %load_size: index, %large_subview_offset: index, %subview_size: index, %scope: !util.buffer, %key: !util.buffer) -> !stream.resource<constant> {
...
// CHECK-SAME: (%[[DYNAMIC_START:.+]]: index, %[[DYNAMIC_END:.+]]: index, %[[SCOPE:.+]]: !util.buffer, %[[KEY:.+]]: !util.buffer)
util.func private @FoldAsyncParameterLoadResultSliceDynamicBoth(%dynamic_start: index, %dynamic_end: index, %scope: !util.buffer, %key: !util.buffer) -> !stream.resource<constant> {
...
// CHECK-SAME: (%[[SCOPE:.+]]: !util.buffer, %[[KEY:.+]]: !util.buffer)
util.func private @ElideImmediateAsyncParameterLoadWait(%scope: !util.buffer, %key: !util.buffer) -> (!stream.resource<constant>, !stream.timepoint) {
  %c0 = arith.constant 0 : i64
  %c100 = arith.constant 100 : index
...
// CHECK-SAME: (%[[TARGET:.+]]: !stream.resource<transient>, %[[TARGET_SIZE:.+]]: index, %[[SCOPE:.+]]: !util.buffer, %[[KEY:.+]]: !util.buffer)
util.func private @ElideImmediateAsyncParameterReadWait(%target: !stream.resource<transient>, %target_size: index, %scope: !util.buffer, %key: !util.buffer) -> (!stream.resource<transient>, !stream.timepoint) {
  %c0 = arith.constant 0 : i64
...
// CHECK-SAME: (%[[SOURCE:.+]]: !stream.resource<transient>, %[[SOURCE_SIZE:.+]]: index, %[[SCOPE:.+]]: !util.buffer, %[[KEY:.+]]: !util.buffer)
util.func private @ElideImmediateAsyncParameterWriteWait(%source: !stream.resource<transient>, %source_size: index, %scope: !util.buffer, %key: !util.buffer) -> (!stream.resource<transient>, !stream.timepoint) {
  %c0 = arith.constant 0 : i64
  %c0_index = arith.constant 0 : index
  %c100 = arith.constant 100 : index
  // CHECK-NOT: stream.timepoint.immediate
...
// CHECK-SAME: (%[[TARGET:.+]]: !stream.resource<transient>, %[[TARGET_SIZE:.+]]: index, %[[SCOPE:.+]]: !util.buffer, %[[KEY0:.+]]: !util.buffer, %[[KEY1:.+]]: !util.buffer)
util.func private @ElideImmediateAsyncParameterGatherWait(%target: !stream.resource<transient>, %target_size: index, %scope: !util.buffer, %key0: !util.buffer, %key1: !util.buffer) -> (!stream.resource<transient>, !stream.timepoint) {
  %c0 = arith.constant 0 : i64
...
// CHECK-SAME: (%[[SOURCE:.+]]: !stream.resource<transient>, %[[SOURCE_SIZE:.+]]: index, %[[SCOPE:.+]]: !util.buffer, %[[KEY0:.+]]: !util.buffer, %[[KEY1:.+]]: !util.buffer)
util.func private @ElideImmediateAsyncParameterScatterWait(%source: !stream.resource<transient>, %source_size: index, %scope: !util.buffer, %key0: !util.buffer, %key1: !util.buffer) -> (!stream.resource<transient>, !stream.timepoint) {
  %c0 = arith.constant 0 : i64
  %c10 = arith.constant 10 : i64
  %c0_index = arith.constant 0 : index
  %c100 = arith.constant 100 : index
...
// CHECK-SAME: (%[[BASE:.+]]: !stream.resource<transient>, %[[BASE_SIZE:.+]]: index, %[[PARAM_OFFSET1:[a-zA-Z0-9]+]]: i64, %[[PARAM_OFFSET2:[a-zA-Z0-9]+]]: i64, %[[SUBVIEW_OFFSET:[a-zA-Z0-9]+]]: index, %[[SUBVIEW_SIZE:[a-zA-Z0-9]+]]: index, %[[WRITE1_OFFSET:[a-zA-Z0-9]+]]: index, %[[WRITE1_END:[a-zA-Z0-9]+]]: index, %[[WRITE1_LENGTH:[a-zA-Z0-9]+]]: index, %[[WRITE2_OFFSET:[a-zA-Z0-9]+]]: index, %[[WRITE2_END:[a-zA-Z0-9]+]]: index, %[[WRITE2_LENGTH:[a-zA-Z0-9]+]]: index, %[[SCOPE:.+]]: !util.buffer, %[[KEY1:.+]]: !util.buffer, %[[KEY2:.+]]: !util.buffer)
util.func private @FoldAsyncParameterWriteSourceSubviewMultipleWrites(%base: !stream.resource<transient>, %base_size: index, %param_offset1: i64, %param_offset2: i64, %subview_offset: index, %subview_size: index, %write1_offset: index, %write1_end: index, %write1_length: index, %write2_offset: index, %write2_end: index, %write2_length: index, %scope: !util.buffer, %key1: !util.buffer, %key2: !util.buffer) -> (!stream.resource<transient>, !stream.resource<transient>) {
...
// CHECK-SAME: (%[[BASE:.+]]: !stream.resource<transient>, %[[BASE_SIZE:.+]]: index, %[[PARAM_OFFSET:[a-zA-Z0-9]+]]: i64, %[[OFFSET1:[a-zA-Z0-9]+]]: index, %[[SUBVIEW1_SIZE:[a-zA-Z0-9]+]]: index, %[[OFFSET2:[a-zA-Z0-9]+]]: index, %[[SUBVIEW2_SIZE:[a-zA-Z0-9]+]]: index, %[[READ_OFFSET:[a-zA-Z0-9]+]]: index, %[[READ_END:[a-zA-Z0-9]+]]: index, %[[READ_LENGTH:[a-zA-Z0-9]+]]: index, %[[SCOPE:.+]]: !util.buffer, %[[KEY:.+]]: !util.buffer)
util.func private @FoldAsyncParameterReadTargetNestedSubviews(%base: !stream.resource<transient>, %base_size: index, %param_offset: i64, %offset1: index, %subview1_size: index, %offset2: index, %subview2_size: index, %read_offset: index, %read_end: index, %read_length: index, %scope: !util.buffer, %key: !util.buffer) -> !stream.resource<transient> {
...
// CHECK-SAME: (%[[BASE:.+]]: !stream.resource<transient>, %[[BASE_SIZE:.+]]: index, %[[PARAM_OFFSET1:[a-zA-Z0-9]+]]: i64, %[[PARAM_OFFSET2:[a-zA-Z0-9]+]]: i64, %[[SUBVIEW_OFFSET:[a-zA-Z0-9]+]]: index, %[[SUBVIEW_SIZE:[a-zA-Z0-9]+]]: index, %[[GATHER1_OFFSET:[a-zA-Z0-9]+]]: index, %[[GATHER1_END:[a-zA-Z0-9]+]]: index, %[[GATHER1_LENGTH:[a-zA-Z0-9]+]]: index, %[[GATHER2_OFFSET:[a-zA-Z0-9]+]]: index, %[[GATHER2_END:[a-zA-Z0-9]+]]: index, %[[GATHER2_LENGTH:[a-zA-Z0-9]+]]: index, %[[SCOPE:.+]]: !util.buffer, %[[KEY1:.+]]: !util.buffer, %[[KEY2:.+]]: !util.buffer)
util.func private @FoldAsyncParameterGatherTargetSubviewMultipleGathers(%base: !stream.resource<transient>, %base_size: index, %param_offset1: i64, %param_offset2: i64, %subview_offset: index, %subview_size: index, %gather1_offset: index, %gather1_end: index, %gather1_length: index, %gather2_offset: index, %gather2_end: index, %gather2_length: index, %scope: !util.buffer, %key1: !util.buffer, %key2: !util.buffer) -> (!stream.resource<transient>, !stream.resource<transient>) {
...
// CHECK-SAME: (%[[BASE:.+]]: !stream.resource<transient>, %[[BASE_SIZE:.+]]: index, %[[OFFSET:.+]]: index, %[[SCOPE:.+]]: !util.buffer, %[[KEY1:.+]]: !util.buffer, %[[KEY2:.+]]: !util.buffer, %[[KEY3:.+]]: !util.buffer)
util.func private @FoldAsyncParameterScatterSourceSubviewVariadicEntries(%base: !stream.resource<transient>, %base_size: index, %offset: index, %scope: !util.buffer, %key1: !util.buffer, %key2: !util.buffer, %key3: !util.buffer) -> !stream.resource<transient> {
...
// CHECK-SAME: (%[[BASE:.+]]: !stream.resource<transient>, %[[BASE_SIZE:.+]]: index, %[[PARAM_OFFSET1:[a-zA-Z0-9]+]]: i64, %[[PARAM_OFFSET2:[a-zA-Z0-9]+]]: i64, %[[SUBVIEW_OFFSET:[a-zA-Z0-9]+]]: index, %[[SUBVIEW_SIZE:[a-zA-Z0-9]+]]: index, %[[GATHER1_OFFSET:[a-zA-Z0-9]+]]: index, %[[GATHER1_END:[a-zA-Z0-9]+]]: index, %[[GATHER1_LENGTH:[a-zA-Z0-9]+]]: index, %[[GATHER2_OFFSET:[a-zA-Z0-9]+]]: index, %[[GATHER2_END:[a-zA-Z0-9]+]]: index, %[[GATHER2_LENGTH:[a-zA-Z0-9]+]]: index, %[[SCOPE:.+]]: !util.buffer, %[[KEY1:.+]]: !util.buffer, %[[KEY2:.+]]: !util.buffer)
util.func private @FoldAsyncParameterGatherTargetSubviewMultipleEntries(%base: !stream.resource<transient>, %base_size: index, %param_offset1: i64, %param_offset2: i64, %subview_offset: index, %subview_size: index, %gather1_offset: index, %gather1_end: index, %gather1_length: index, %gather2_offset: index, %gather2_end: index, %gather2_length: index, %scope: !util.buffer, %key1: !util.buffer, %key2: !util.buffer) -> !stream.resource<transient> {
...
// CHECK-SAME: (%[[TARGET:.+]]: !stream.resource<transient>, %[[TARGET_SIZE:.+]]: index, %[[PARAM_OFFSET1:[a-zA-Z0-9]+]]: i64, %[[PARAM_OFFSET2:[a-zA-Z0-9]+]]: i64, %[[SUBVIEW_OFFSET:[a-zA-Z0-9]+]]: index, %[[SUBVIEW_SIZE:[a-zA-Z0-9]+]]: index, %[[READ_OFFSET:[a-zA-Z0-9]+]]: index, %[[READ_END:[a-zA-Z0-9]+]]: index, %[[READ_LENGTH:[a-zA-Z0-9]+]]: index, %[[SCOPE:.+]]: !util.buffer, %[[KEY1:.+]]: !util.buffer, %[[KEY2:.+]]: !util.buffer)
util.func private @FoldAsyncParameterReadAwaitThenSubviewThenRead(%target: !stream.resource<transient>, %target_size: index, %param_offset1: i64, %param_offset2: i64, %subview_offset: index, %subview_size: index, %read_offset: index, %read_end: index, %read_length: index, %scope: !util.buffer, %key1: !util.buffer, %key2: !util.buffer) -> !stream.resource<transient> {
...
// CHECK-SAME: (%[[PARAM_OFFSET:[a-zA-Z0-9]+]]: i64, %[[LOAD_SIZE:[a-zA-Z0-9]+]]: index, %[[SUBVIEW_OFFSET:[a-zA-Z0-9]+]]: index, %[[SUBVIEW_SIZE:[a-zA-Z0-9]+]]: index, %[[SCOPE:.+]]: !util.buffer, %[[KEY:.+]]: !util.buffer)
util.func private @ElideImmediateAsyncParameterLoadThenSubviewFold(%param_offset: i64, %load_size: index, %subview_offset: index, %subview_size: index, %scope: !util.buffer, %key: !util.buffer) -> !stream.resource<constant> {
...
// CHECK-SAME: (%[[TARGET:.+]]: !stream.resource<transient>, %[[TARGET_SIZE:.+]]: index, %[[LOAD_PARAM_OFFSET:[a-zA-Z0-9]+]]: i64, %[[LOAD_SIZE:[a-zA-Z0-9]+]]: index, %[[LOAD_SUBVIEW_OFFSET:[a-zA-Z0-9]+]]: index, %[[LOAD_SUBVIEW_SIZE:[a-zA-Z0-9]+]]: index, %[[READ_PARAM_OFFSET:[a-zA-Z0-9]+]]: i64, %[[READ_SUBVIEW_OFFSET:[a-zA-Z0-9]+]]: index, %[[READ_SUBVIEW_SIZE:[a-zA-Z0-9]+]]: index, %[[READ_OFFSET:[a-zA-Z0-9]+]]: index, %[[READ_END:[a-zA-Z0-9]+]]: index, %[[READ_LENGTH:[a-zA-Z0-9]+]]: index, %[[SCOPE:.+]]: !util.buffer, %[[KEY1:.+]]: !util.buffer, %[[KEY2:.+]]: !util.buffer)
util.func private @MultipleAsyncParameterFoldsInFunction(%target: !stream.resource<transient>, %target_size: index, %load_param_offset: i64, %load_size: index, %load_subview_offset: index, %load_subview_size: index, %read_param_offset: i64, %read_subview_offset: index, %read_subview_size: index, %read_offset: index, %read_end: index, %read_length: index, %scope: !util.buffer, %key1: !util.buffer, %key2: !util.buffer) -> (!stream.resource<constant>, !stream.resource<transient>) {
...
// CHECK-SAME: (%[[PARAM_OFFSET:[a-zA-Z0-9]+]]: i64, %[[LOAD_SIZE:[a-zA-Z0-9]+]]: index, %[[SLICE_START:[a-zA-Z0-9]+]]: index, %[[SLICE_END:[a-zA-Z0-9]+]]: index, %[[SLICE_SIZE:[a-zA-Z0-9]+]]: index, %[[SCOPE:.+]]: !util.buffer, %[[KEY:.+]]: !util.buffer)
util.func private @AsyncParameterLoadSliceThenAwaitElision(%param_offset: i64, %load_size: index, %slice_start: index, %slice_end: index, %slice_size: index, %scope: !util.buffer, %key: !util.buffer) -> !stream.resource<constant> {
