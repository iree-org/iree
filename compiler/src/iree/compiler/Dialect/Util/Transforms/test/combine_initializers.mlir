...
// Tests an initializer followed by non-materializable global do not combine.
...
// Tests that materializable + non-materializable + materializable globals stay
// in separate initializers.

// CHECK: util.global private @g0 = 5 : i32
...
// CHECK-NEXT: util.initializer {
// CHECK-NEXT:   %[[C6:.+]] = arith.constant 6 : i32
// CHECK-NEXT:   util.global.store %[[C6]], @g1
// CHECK-NEXT:   %[[C7:.+]] = arith.constant 7 : i32
// CHECK-NEXT:   util.global.store %[[C7]], @g2
// CHECK-NEXT:   util.return
// CHECK-NEXT: }
util.initializer {
...
// Tests multiple non-materializable globals act as barriers.
