...
#define GEN_PASS_DEF_ATTRBASEDPIPELINESPASS
#include "iree/compiler/Dialect/Util/Transforms/Passes.h.inc" // IWYU pragma: export

namespace {

struct AttrBasedPipelinesPass
    : public impl::AttrBasedPipelinesPassBase<AttrBasedPipelinesPass> {
  using Base::Base;
...
void AttrBasedPipelinesPass::runOnOperation() {
