...
#ifndef THIRD_PARTY_MLIR_EDGE_IREE_HAL_VULKAN_VULKAN_DEVICE_H_
#define THIRD_PARTY_MLIR_EDGE_IREE_HAL_VULKAN_VULKAN_DEVICE_H_
...
#endif  // THIRD_PARTY_MLIR_EDGE_IREE_HAL_VULKAN_VULKAN_DEVICE_H_
