...
#ifndef THIRD_PARTY_MLIR_EDGE_IREE_HAL_DEVICE_INFO_H_
#define THIRD_PARTY_MLIR_EDGE_IREE_HAL_DEVICE_INFO_H_
...
#endif  // THIRD_PARTY_MLIR_EDGE_IREE_HAL_DEVICE_INFO_H_
