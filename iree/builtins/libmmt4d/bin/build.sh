...
#   ./iree/compiler/Dialect/HAL/Target/LLVM/libmmt4d/build.sh
...
function make_arch_bc {
  ...
  local FEATURES=$2
  local SOURCE_FILE=$3
  local FILE_BASENAME="${OUT}/libmmt4d_${ARCH}_${FEATURES}"
...
make_arch_bc "aarch64" "generic" "mmt4d_aarch64.c" \
    --target=aarch64-arm-none-eabi
make_arch_bc "aarch64" "dotprod" "mmt4d_aarch64.c" \
    --target=aarch64-arm-none-eabi \
    -march=armv8.2-a+dotprod

make_arch_bc "wasm32" "generic" "mmt4d_generic.c" \
    --target=wasm32
make_arch_bc "wasm64" "generic" "mmt4d_generic.c" \
    --target=wasm64
