...
func @dot_general_4x384x32x384() -> tensor<4x384x384xf32> attributes { iree.module.export } {
...
func @dot_general_4x384x384x32() -> tensor<4x384x32xf32> attributes { iree.module.export } {
