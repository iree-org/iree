...
func @dot_384x384x512() -> tensor<384x512xf32> {
...
func @dot_384x128x128() -> tensor<384x128xf32> {
...
func @dot_384x128x512() -> tensor<384x512xf32> {
    %lhs = util.unfoldable_constant dense<1.0> : tensor<384x128xf32>
...
func @dot_384x512x128() -> tensor<384x128xf32> {
...
func @dot_384x512x2() -> tensor<384x2xf32> {
    %lhs = util.unfoldable_constant dense<1.0> : tensor<384x512xf32>
...
func @dot_384x384x32() -> tensor<384x32xf32> {
    %lhs = util.unfoldable_constant dense<1.0> : tensor<384x384xf32>
...
func @dot_1x1024x1024() -> tensor<1x1024xf32> {
...
func @dot_1x1024x2048() -> tensor<1x2048xf32> {
    %lhs = util.unfoldable_constant dense<1.0> : tensor<1x1024xf32>
...
func @dot_1x1024x3072() -> tensor<1x3072xf32> {
    %lhs = util.unfoldable_constant dense<1.0> : tensor<1x1024xf32>
...
func @dot_1x1024x512() -> tensor<1x512xf32> {
    %lhs = util.unfoldable_constant dense<1.0> : tensor<1x1024xf32>
...
func @dot_1x128x2() -> tensor<1x2xf32> {
...
func @dot_1x256x512() -> tensor<1x512xf32> {
...
func @dot_1x3072x1024() -> tensor<1x1024xf32> {
...
func @dot_1x3072x512() -> tensor<1x512xf32> {
    %lhs = util.unfoldable_constant dense<1.0> : tensor<1x3072xf32>
...
func @dot_1x512x1024() -> tensor<1x1024xf32> {
...
func @dot_1x512x3072() -> tensor<1x3072xf32> {
    %lhs = util.unfoldable_constant dense<1.0> : tensor<1x512xf32>
...
func @dot_1x512x512() -> tensor<1x512xf32> {
    %lhs = util.unfoldable_constant dense<1.0> : tensor<1x512xf32>
...
func @dot_2x3072x512() -> tensor<2x512xf32> {
...
func @dot_2x512x1024() -> tensor<2x1024xf32> {
...
func @dot_2x512x3072() -> tensor<2x3072xf32> {
    %lhs = util.unfoldable_constant dense<1.0> : tensor<2x512xf32>
    %rhs = util.unfoldable_constant dense<1.0> : tensor<512x3072xf32>
...
func @dot_2x512x512() -> tensor<2x512xf32> {
    %lhs = util.unfoldable_constant dense<1.0> : tensor<2x512xf32>
    %rhs = util.unfoldable_constant dense<1.0> : tensor<512x512xf32>
...
func @dot_2x528x512() -> tensor<2x512xf32> {
...
func @dot_6x513x128() -> tensor<6x128xf32> {
