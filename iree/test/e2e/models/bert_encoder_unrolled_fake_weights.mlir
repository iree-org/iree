...
module {
  ...
  flow.variable @"__iree_flow_cls/squad/output_bias" dense<0.1> : tensor<2xf32> attributes {noinline, sym_visibility = "private"}
  flow.variable @"__iree_flow_cls/squad/output_weights" dense<1.0> : tensor<2x512xf32> attributes {noinline, sym_visibility = "private"}
