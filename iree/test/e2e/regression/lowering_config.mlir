...
func @lowering_config_test() {
  ...
  %d = "mhlo.dot"(%a, %b) {compilation.info = #config1} : (tensor<128x256xf32>, tensor<256x512xf32>) -> tensor<128x512xf32>
  %e = "mhlo.dot"(%a, %c) {compilation.info = #config2} : (tensor<128x256xf32>, tensor<256x1024xf32>) -> tensor<128x1024xf32>
