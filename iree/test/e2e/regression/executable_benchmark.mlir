...
// RUN: iree-translate --iree-hal-target-backends=vmla -iree-flow-export-benchmark-funcs -iree-mlir-to-vm-bytecode-module %s | iree-benchmark-module --driver=vmla --benchmark_list_tests=true | IreeFileCheck %s
...
// CHECK: BM_two_dispatch_ex_dispatch_0_benchmark
// CHECK: BM_two_dispatch_ex_dispatch_1_benchmark
