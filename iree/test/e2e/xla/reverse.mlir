func @xla_reverse() attributes { iree.module.export } {
  ...
  check.expect_eq(%dim0, %expected_dim0) : tensor<2x3xf32>
  ...
  check.expect_eq(%dim1, %expected_dim1) : tensor<2x3xf32>
  ...
  check.expect_eq(%both_dims, %expected_both_dims) : tensor<2x3xf32>
  return
}
