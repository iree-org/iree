func @tensor_i8() attributes { iree.module.export } {
  %0 = iree.unfoldable_constant dense<[[[[1], [2], [3], [4]], [[5], [6], [7], [8]]]]> : tensor<1x2x4x1xi8>
...
func @tensor_i16() attributes { iree.module.export } {
  %0 = iree.unfoldable_constant dense<[[[[1], [2], [3], [4]], [[5], [6], [7], [8]]]]> : tensor<1x2x4x1xi16>
...
func @tensor_i32() attributes { iree.module.export } {
  %0 = iree.unfoldable_constant dense<[[[[1], [2], [3], [4]], [[5], [6], [7], [8]]]]> : tensor<1x2x4x1xi32>
...
func @tensor_f32() attributes { iree.module.export } {
  %0 = iree.unfoldable_constant dense<[[[[1.], [2.], [3.], [4.]], [[5.], [6.], [7.], [8.]]]]> : tensor<1x2x4x1xf32>
