func @pad_1D_test() attributes { iree.module.export } {
    %0 = "tosa.const"() { value = dense<42> : tensor<2xi32> } : ()  -> (tensor<2xi32>)
...
func @pad_2D_test() attributes { iree.module.export } {
    %0 = "tosa.const"() { value = dense<42> : tensor<2x2xi32> } : ()  -> (tensor<2x2xi32>)
