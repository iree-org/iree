func @extract_slice_strided() {
  ...
  %1 = linalg.generic {
      ...
      ^bb0(%arg0 : i32):
        ...
        %4 = index_cast %2 : index to i32
        %c750_i32 = constant 750 : i32
        %5 = muli %4, %c750_i32 : i32
  ...
  %4 = linalg.generic {
      ...
      ^bb0(%arg0 : i32) :
        ...
        %7 = index_cast %6 : index to i32
        %8 = muli %7, %c3_i32 : i32
        %9 = addi %c30_i32, %8 : i32
        %10 = index_cast %5 : index to i32
        %11 = muli %10, %c2_i32 : i32
        %12 = addi %c20_i32, %11 : i32
        %c750_i32 = constant 750 : i32
        %13 = muli %12, %c750_i32 : i32
        %14 = addi %13, %9 : i32
        linalg.yield %14 : i32
     } -> tensor<50x75xi32>
