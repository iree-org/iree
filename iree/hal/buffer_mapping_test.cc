 ...
 public:
  ...
  MOCK_METHOD(Status, FillImpl,
              (device_size_t byte_offset, device_size_t byte_length,
               const void*, device_size_t pattern_length),
              (override));

  MOCK_METHOD(Status, ReadDataImpl,
              (device_size_t source_offset, void*, device_size_t data_length),
              (override));
  MOCK_METHOD(Status, WriteDataImpl,
              (device_size_t target_offset, const void*,
               device_size_t data_length),
              (override));
  MOCK_METHOD(Status, CopyDataImpl,
              (device_size_t target_offset, Buffer*,
