...
// Copies |count| elements of |src_list| starting from |src_offset| to
// |dst_list| beginning with |dst_offset|. Fails if |list_a| and |list_b| have
...
// Swaps the contents of |list_a| with |list_b|.
// Fails if |list_a| and |list_b| have different allocators or either have been
