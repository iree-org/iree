...
static llvm::cl::opt<uint64_t> streamDefaultAlignment(
    "iree-stream-default-alignment",
...
ResourceConfigAttr ResourceConfigAttr::getDefaultHostConstraints(
  ...
  uint64_t minBufferOffsetAlignment = streamDefaultAlignment;
  uint64_t maxBufferRange = UINT32_MAX;
  uint64_t minBufferRangeAlignment = streamDefaultAlignment;
