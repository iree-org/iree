...
//       CHECK:     %[[USED_TILESIZE:.+]] = affine.min #[[MAP]](%[[IV]])[%[[TILESIZE]], %[[D0]]]
//       CHECK:     %[[UPDATE_SLICE:.+]] = tensor.extract_slice %[[UPDATES]][%[[IV]], %[[C0]]]
//  CHECK-SAME:         [%[[USED_TILESIZE]], %[[D1]]]
//       CHECK:     %[[INDEX_SLICE:.+]] = tensor.extract_slice %[[INDICES]][%[[IV]]] [%[[USED_TILESIZE]]]
...
//   CHECK-DAG:     %[[SLICE_D0:.+]] = memref.dim %[[SCATTER_TILE]], %[[C0]]
//   CHECK-DAG:     %[[SLICE_D1:.+]] = memref.dim %[[SCATTER_TILE]], %[[C1]]
//       CHECK:     %[[YIELD:.+]] = tensor.insert_slice %[[SCATTER_TILE]] into %[[INIT]][%[[C0]], %[[C0]]]
...
//       CHECK:     %[[USED_TILESIZE:.+]] = affine.min #[[MAP]](%[[IV]])[%[[TILESIZE]], %[[D0]]]
//       CHECK:     %[[UPDATE_SLICE:.+]] = memref.subview %[[UPDATES]][%[[IV]], %[[C0]]]
//  CHECK-SAME:         [%[[USED_TILESIZE]], %[[D1]]]
//       CHECK:     %[[INDEX_SLICE:.+]] = memref.subview %[[INDICES]][%[[IV]]] [%[[USED_TILESIZE]]]
