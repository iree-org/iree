...
vm.module @my_module {
  vm.import @import_fn(%arg0 : i32, %arg1 : !iree.ref<!hal.buffer>...) -> i32
  vm.func @call_variadic_empty(%arg0 : i32) -> i32 {
    // CHECK: %0 = vm.call.variadic @import_fn(%arg0, []) : (i32, !iree.ref<!hal.buffer>...) -> i32
    %0 = vm.call.variadic @import_fn(%arg0, []) : (i32, !iree.ref<!hal.buffer>...) -> i32
    vm.return %0 : i32
  }
}
...
vm.module @my_module {
  vm.import @import_fn(%arg0 : i32, %arg1 : !iree.ref<!hal.buffer>...) -> i32
  vm.func @call_variadic(%arg0 : i32, %arg1 : !iree.ref<!hal.buffer>) -> i32 {
    // CHECK: %0 = vm.call.variadic @import_fn(%arg0, [%arg1, %arg1]) : (i32, !iree.ref<!hal.buffer>...) -> i32
    %0 = vm.call.variadic @import_fn(%arg0, [%arg1, %arg1]) : (i32, !iree.ref<!hal.buffer>...) -> i32
    vm.return %0 : i32
  }
}
...
vm.module @my_module {
  vm.import @import_fn(%arg0 : i32, %arg1 : !iree.ref<!hal.buffer>...) -> i32
  vm.func @call_variadic_multiple(%arg0 : i32, %arg1 : !iree.ref<!hal.buffer>) -> i32 {
    // CHECK: %0 = vm.call.variadic @import_fn(%arg0, [%arg1, %arg1], [%arg1]) : (i32, !iree.ref<!hal.buffer>..., !iree.ref<!hal.buffer>...) -> i32
    %0 = vm.call.variadic @import_fn(%arg0, [%arg1, %arg1], [%arg1]) : (i32, !iree.ref<!hal.buffer>..., !iree.ref<!hal.buffer>...) -> i32
    vm.return %0 : i32
  }
}
...
vm.module @my_module {
  vm.import @import_fn(%arg0 : i32, %arg1 : !iree.ref<!hal.buffer>...)
  vm.func @call_variadic_no_results(%arg0 : i32, %arg1 : !iree.ref<!hal.buffer>) {
    // CHECK: vm.call.variadic @import_fn(%arg0, [%arg1, %arg1], [%arg1]) : (i32, !iree.ref<!hal.buffer>..., !iree.ref<!hal.buffer>...)
    vm.call.variadic @import_fn(%arg0, [%arg1, %arg1], [%arg1]) : (i32, !iree.ref<!hal.buffer>..., !iree.ref<!hal.buffer>...)
    vm.return
  }
}
