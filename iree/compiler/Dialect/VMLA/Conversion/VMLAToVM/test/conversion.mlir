...
func @shapeExpansion(%src : !iree.ref<!vmla.buffer>, %src_shape : !shape.ranked_shape<4x?x8xi32>, %dst : !iree.ref<!vmla.buffer>) {
  ...
  "vmla.transpose"(%src, %src_shape, %dst) { dims = dense<[1, 2]> : tensor<2xi32>, element_type = i16 } : (!iree.ref<!vmla.buffer>, !shape.ranked_shape<4x?x8xi32>, !iree.ref<!vmla.buffer>) -> ()
  return
}
...
func @matmul(
    ...
    %lhs_shape : !shape.ranked_shape<4x?xi32>,
    %rhs : !iree.ref<!vmla.buffer>,
    %rhs_shape : !shape.ranked_shape<?x4xi32>,
    %dst : !iree.ref<!vmla.buffer>,
    %dst_shape : !shape.ranked_shape<4x4xi32>) {
  ...
  "vmla.matmul"(%lhs, %lhs_shape, %rhs, %rhs_shape, %dst, %dst_shape)
      ...
      (!iree.ref<!vmla.buffer>,
       !shape.ranked_shape<4x?xi32>,
       !iree.ref<!vmla.buffer>,
       !shape.ranked_shape<?x4xi32>,
       !iree.ref<!vmla.buffer>,
       !shape.ranked_shape<4x4xi32>) -> ()
  return
}
