...
func @shapeExpansion(%src : !iree.ref<!vmla.buffer>, %src_shape : !shapex.ranked_shape<[4,?,8],i32>, %dst : !iree.ref<!vmla.buffer>) {
  ...
  "vmla.transpose"(%src, %src_shape, %dst) { dims = dense<[1, 2]> : tensor<2xi32>, element_type = i16 } : (!iree.ref<!vmla.buffer>, !shapex.ranked_shape<[4,?,8],i32>, !iree.ref<!vmla.buffer>) -> ()
  return
}
