...
func @typedImport(%arg0 : !iree.ref<!vmla.buffer>, %arg1 : !iree.ref<!vmla.buffer>) {
  ...
  "vmla.cmp"(%arg0, %arg0, %arg1) { predicate = 1 : i32, element_type = f32 } : (!iree.ref<!vmla.buffer>, !iree.ref<!vmla.buffer>, !iree.ref<!vmla.buffer>) -> ()
  return
}
...
func @sizedImport(%arg0 : !iree.ref<!vmla.buffer>, %arg1 : !iree.ref<!vmla.buffer>) {
  // CHECK-NEXT: vm.call @vmla.select.x32(%arg0, %arg0, %arg0, %arg1)
  "vmla.select"(%arg0, %arg0, %arg0, %arg1) { element_type = f32 } : (!iree.ref<!vmla.buffer>, !iree.ref<!vmla.buffer>, !iree.ref<!vmla.buffer>, !iree.ref<!vmla.buffer>) -> ()
  return
}
...
func @shapeExpansion(%arg0 : !iree.ref<!vmla.buffer>, %arg1 : !shapex.ranked_shape<[4,?,8],i32>, %arg2 : !iree.ref<!vmla.buffer>, %arg3 : !shapex.ranked_shape<[?,4,8],i32>) {
  ...
  "vmla.transpose"(%arg0, %arg1, %arg2, %arg3) { dimensions = dense<[1]> : tensor<1xi32>, element_type = i16 } : (!iree.ref<!vmla.buffer>, !shapex.ranked_shape<[4,?,8],i32>, !iree.ref<!vmla.buffer>, !shapex.ranked_shape<[?,4,8],i32>) -> ()
  return
}
...
func @convert(%arg0 : !iree.ref<!vmla.buffer>, %arg1 : !iree.ref<!vmla.buffer>) {
  // CHECK-NEXT:  vm.call @vmla.convert.f32.i8(%arg0, %arg1)
  "vmla.convert"(%arg0, %arg1) { src_type = f32, dst_type = i8 } : (!iree.ref<!vmla.buffer>, !iree.ref<!vmla.buffer>) -> ()
  return
}
