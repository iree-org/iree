...
struct InterfaceLoadConstantOpConversion
  ...
  LogicalResult matchAndRewrite(
    ...
    IREE::HAL::InterfaceLoadConstantOp::OperandAdaptor newOperands(operands);
...
struct InterfaceLoadTensorOpConversion
  ...
  LogicalResult matchAndRewrite(
    ...
    IREE::HAL::InterfaceLoadTensorOp::OperandAdaptor newOperands(operands);
...
struct InterfaceStoreTensorOpConversion
  ...
  LogicalResult matchAndRewrite(
    ...
    IREE::HAL::InterfaceStoreTensorOp::OperandAdaptor newOperands(operands);
    auto bufferOp = rewriter.create<IREE::VMLA::InterfaceBindingOp>(
