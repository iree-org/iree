...
void populateHLOToVMLAPatterns(MLIRContext *context,
  ...
  // vmla.ifft.pseudo
  patterns.insert<IfftOpConversion>(context, typeConverter);

  // vmla.rfft.pseudo
  patterns.insert<RfftOpConversion>(context, typeConverter);

  // vmla.irfft.pseudo
  patterns.insert<IrfftOpConversion>(context, typeConverter);
