...
func @transpose() -> tensor<24x7x10xf32> attributes { sym_visibility = "private" } {
  ...
  // CHECK-DAG: [[SRC_SHAPE:%.+]] = shapex.const_ranked_shape : !shapex.ranked_shape<[7,24,10],i32>
  // CHECK-DAG: [[DST_SHAPE:%.+]] = shapex.const_ranked_shape : !shapex.ranked_shape<[24,7,10],i32>
