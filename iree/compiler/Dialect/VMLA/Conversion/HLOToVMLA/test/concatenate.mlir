...
func @concatenate_0() -> (tensor<2x5xi32>) attributes { sym_visibility = "private" } {
  ...
  // CHECK: "vmla.copy"(
  // CHECK-SAME: [[ARG0]], %rs2_2_i32, %c0_i32, %c0_i32,
  // CHECK-SAME: [[DST]], %rs2_5_i32, %c0_i32, %c0_i32,
  // CHECK-SAME: %c2_i32, %c2_i32
  // CHECK-SAME: ) {element_type = i32}
  // CHECK: "vmla.copy"(
  // CHECK-SAME: [[ARG1]], %rs2_3_i32, %c0_i32, %c0_i32,
  // CHECK-SAME: [[DST]], %rs2_5_i32, %c0_i32, %c2_i32,
...
func @concatenate_1() -> (tensor<2x5xi32>) attributes { sym_visibility = "private" } {
  ...
  // CHECK: [[DST:%.+]] = "vmla.buffer.alloc"(%c40_i32)
  // CHECK: "vmla.copy"(
  // CHECK-SAME: [[ARG0]], %rs2_3_i32, %c0_i32, %c0_i32,
  // CHECK-SAME: [[DST]], %rs2_5_i32, %c0_i32, %c0_i32,
  // CHECK-SAME: %c2_i32, %c3_i32
  // CHECK-SAME: ) {element_type = i32}
  // CHECK: "vmla.copy"(
  // CHECK-SAME: [[ARG1]], %rs2_2_i32, %c0_i32, %c0_i32,
  // CHECK-SAME: [[DST]], %rs2_5_i32, %c0_i32, %c3_i32,
  // CHECK-SAME: %c2_i32, %c2_i32
  // CHECK-SAME: ) {element_type = i32}
...
func @concatenate_2() -> (tensor<2x7xi32>) attributes { sym_visibility = "private" } {
  ...
  // CHECK: "vmla.copy"(
  // CHECK-SAME: [[ARG0]], %rs2_2_i32, %c0_i32, %c0_i32,
  // CHECK-SAME: [[DST]], %rs2_7_i32, %c0_i32, %c0_i32,
  // CHECK-SAME: %c2_i32, %c2_i32
  // CHECK-SAME: ) {element_type = i32}
  // CHECK: "vmla.copy"(
  // CHECK-SAME: [[ARG1]], %rs2_3_i32, %c0_i32, %c0_i32,
  // CHECK-SAME: [[DST]], %rs2_7_i32, %c0_i32, %c2_i32,
  // CHECK-SAME: %c2_i32, %c3_i32
  // CHECK-SAME: ) {element_type = i32}
  // CHECK: "vmla.copy"(
  // CHECK-SAME: [[ARG2]], %rs2_2_i32, %c0_i32, %c0_i32,
  // CHECK-SAME: [[DST]], %rs2_7_i32, %c0_i32, %c5_i32,
  // CHECK-SAME: %c2_i32, %c2_i32
  // CHECK-SAME: ) {element_type = i32}
...
func @concatenate_3() -> (tensor<4x2xi32>) attributes { sym_visibility = "private" } {
  ...
  // CHECK: "vmla.copy"(
  // CHECK-SAME: [[ARG0]], %rs2_2_i32, %c0_i32, %c0_i32,
  // CHECK-SAME: [[DST]], %rs4_2_i32, %c0_i32, %c0_i32,
  // CHECK-SAME: %c2_i32, %c2_i32
  // CHECK-SAME: ) {element_type = i32}
  // CHECK: "vmla.copy"(
  // CHECK-SAME: [[ARG1]], %rs2_2_i32, %c0_i32, %c0_i32,
  // CHECK-SAME: [[DST]], %rs4_2_i32, %c2_i32, %c0_i32,
  // CHECK-SAME: %c2_i32, %c2_i32
  // CHECK-SAME: ) {element_type = i32}
