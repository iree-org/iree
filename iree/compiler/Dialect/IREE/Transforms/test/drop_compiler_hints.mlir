// RUN: iree-opt -split-input-file -iree-drop-compiler-hints %s | IreeFileCheck --implicit-check-not="ireex.do_not_optimize" %s
...
func @multiple() -> (i32, i32) {
  ...
  %c1 = constant 1 : i32
  %0 = ireex.do_not_optimize(%c1) : i32
  %1 = ireex.do_not_optimize(%0) : i32
  // CHECK-NEXT: [[C2:%.+]] = constant 2
  %c2 = constant 2 : i32
  %2 = ireex.do_not_optimize(%1) : i32
  %3 = ireex.do_not_optimize(%c2) : i32
...
func @multiple_operands() -> (i32, i32) {
  ...
  // CHECK-NEXT: [[C2:%.+]] = constant 2
  %c2 = constant 2 : i32
  %0, %1 = ireex.do_not_optimize(%c1, %c2) : i32, i32
  // CHECK-NEXT: return [[C1]], [[C2]]
  return %0, %1 : i32, i32
}
