// RUN: iree-opt -split-input-file -iree-hal-transformation-pipeline -iree-codegen-linalg-to-llvmgpu-enable-rocm -iree-hal-target-backends=rocm %s | IreeFileCheck %s
