...
func @allocatorAllocate(%arg0 : !iree.ref<!hal.allocator>) -> !iree.ref<!hal.buffer> {
  ...
  %0 = hal.allocator.allocate %arg0, "HostLocal", "All", %c1024 : !iree.ref<!hal.buffer>
...
func @allocatorAllocateConst() -> !iree.ref<!hal.buffer> {
  ...
  // CHECK: %ref = vm.call.variadic @hal.allocator.allocate.const(%0, %c6, %c2, [%c4, %c4_0], %c16777248, %allocatorAllocateConst_const_0) : (!iree.ref<!hal.allocator>, i32, i32, i32..., i32, !iree.byte_buffer_ref) -> !iree.ref<!hal.buffer>
