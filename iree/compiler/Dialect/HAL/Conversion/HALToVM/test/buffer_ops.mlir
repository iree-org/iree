...
func @buffer_view_compute_offset(%arg0 : !iree.ref<!hal.buffer>) -> i32 {
  ...
  // CHECK: %2 = vm.call.variadic @hal.buffer_view.compute_offset(%arg0, [%0#0, %0#1], [%1#0, %1#1], %c4) : (!iree.ref<!hal.buffer>, i32..., i32..., i32) -> i32
...
func @buffer_view_compute_length(%arg0 : !iree.ref<!hal.buffer>) -> i32 {
  %0:2 = "test_hal.shape"() : () -> (i32, i32)
  // CHECK: %1 = vm.call.variadic @hal.buffer_view.compute_length(%arg0, [%0#0, %0#1], %c4) : (!iree.ref<!hal.buffer>, i32..., i32) -> i32
...
func @buffer_view_compute_range(%arg0 : !iree.ref<!hal.buffer>) -> (i32, i32) {
  ...
  // CHECK: %3:2 = vm.call.variadic @hal.buffer_view.compute_range(%arg0, [%0#0, %0#1], [%1#0, %1#1], [%2#0, %2#1], %c4) : (!iree.ref<!hal.buffer>, i32..., i32..., i32..., i32) -> (i32, i32)
...
func @buffer_view_slice(%arg0 : !iree.ref<!hal.buffer>) -> !iree.ref<!hal.buffer> {
  ...
  %1:2 = "test_hal.indices"() : () -> (i32, i32)
  %2:2 = "test_hal.lengths"() : () -> (i32, i32)
  // CHECK: %ref = vm.call.variadic @hal.buffer_view.slice(%arg0, [%0#0, %0#1], [%1#0, %1#1], [%2#0, %2#1], %c4) : (!iree.ref<!hal.buffer>, i32..., i32..., i32..., i32) -> !iree.ref<!hal.buffer>
