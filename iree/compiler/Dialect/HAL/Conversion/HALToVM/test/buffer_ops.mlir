...
func @buffer_subspan() -> !ireex.ref<!hal.buffer> {
  ...
  // CHECK: %ref = vm.call @hal.buffer.subspan(%0, %1, %2) : (!ireex.ref<!hal.buffer>, i32, i32) -> !ireex.ref<!hal.buffer>
...
func @buffer_fill(%arg0 : !ireex.ref<!hal.buffer>) {
  ...
  // CHECK: vm.call @hal.buffer.fill(%arg0, %0, %1, %2) : (!ireex.ref<!hal.buffer>, i32, i32, i32) -> ()
...
func @buffer_read_data(%arg0 : !ireex.ref<!hal.buffer>) {
  ...
  // CHECK: vm.call @hal.buffer.read_data(%arg0, %0, %1, %2, %3) : (!ireex.ref<!hal.buffer>, i32, !ireex.mutable_byte_buffer_ref, i32, i32) -> ()
...
func @buffer_write_data(%arg0 : !ireex.ref<!hal.buffer>) {
  ...
  %2 = "test_hal.device_size"() : () -> i32
  %3 = "test_hal.device_size"() : () -> i32
  // CHECK: vm.call @hal.buffer.write_data(%0, %1, %arg0, %2, %3) : (!ireex.mutable_byte_buffer_ref, i32, !ireex.ref<!hal.buffer>, i32, i32) -> ()
...
func @buffer_copy_data(%arg0 : !ireex.ref<!hal.buffer>, %arg1 : !ireex.ref<!hal.buffer>) {
  ...
  %1 = "test_hal.device_size"() : () -> i32
  %2 = "test_hal.device_size"() : () -> i32
  // CHECK: vm.call @hal.buffer.copy_data(%arg0, %0, %arg1, %1, %2) : (!ireex.ref<!hal.buffer>, i32, !ireex.ref<!hal.buffer>, i32, i32) -> ()
...
func @buffer_load(%arg0 : !ireex.ref<!hal.buffer>) -> (i8, i16, i32) {
  %0 = "test_hal.device_size"() : () -> i32
  // CHECK: %1 = vm.call @hal.buffer.load(%arg0, %0, %c1) : (!ireex.ref<!hal.buffer>, i32, i32) -> i32
  %1 = hal.buffer.load %arg0[%0] : i8
  // CHECK: %2 = vm.call @hal.buffer.load(%arg0, %0, %c2) : (!ireex.ref<!hal.buffer>, i32, i32) -> i32
  %2 = hal.buffer.load %arg0[%0] : i16
  // CHECK: %3 = vm.call @hal.buffer.load(%arg0, %0, %c4) : (!ireex.ref<!hal.buffer>, i32, i32) -> i32
...
func @buffer_store(%arg0 : !ireex.ref<!hal.buffer>, %arg1 : i8, %arg2 : i16, %arg3 : i32) {
  %0 = "test_hal.device_size"() : () -> i32
  // CHECK: vm.call @hal.buffer.store(%arg1, %arg0, %0, %c1) : (i32, !ireex.ref<!hal.buffer>, i32, i32) -> ()
  hal.buffer.store %arg1, %arg0[%0] : i8
  // CHECK: vm.call @hal.buffer.store(%arg2, %arg0, %0, %c2) : (i32, !ireex.ref<!hal.buffer>, i32, i32) -> ()
  hal.buffer.store %arg2, %arg0[%0] : i16
  // CHECK: vm.call @hal.buffer.store(%arg3, %arg0, %0, %c4) : (i32, !ireex.ref<!hal.buffer>, i32, i32) -> ()
...
func @buffer_view_compute_offset(%arg0 : !ireex.ref<!hal.buffer>) -> i32 {
  ...
  // CHECK: %2 = vm.call.variadic @hal.buffer_view.compute_offset(%arg0, [%0#0, %0#1], [%1#0, %1#1], %c4) : (!ireex.ref<!hal.buffer>, i32..., i32..., i32) -> i32
...
func @buffer_view_compute_length(%arg0 : !ireex.ref<!hal.buffer>) -> i32 {
  %0:2 = "test_hal.shape"() : () -> (i32, i32)
  // CHECK: %1 = vm.call.variadic @hal.buffer_view.compute_length(%arg0, [%0#0, %0#1], %c4) : (!ireex.ref<!hal.buffer>, i32..., i32) -> i32
...
func @buffer_view_slice(%arg0 : !ireex.ref<!hal.buffer>) -> !ireex.ref<!hal.buffer> {
  ...
  %1:2 = "test_hal.indices"() : () -> (i32, i32)
  %2:2 = "test_hal.lengths"() : () -> (i32, i32)
  // CHECK: %ref = vm.call.variadic @hal.buffer_view.slice(%arg0, [%0#0, %0#1], [%1#0, %1#1], [%2#0, %2#1], %c4) : (!ireex.ref<!hal.buffer>, i32..., i32..., i32..., i32) -> !ireex.ref<!hal.buffer>
