...
// CHECK-NEXT:   %1 = vm.call.variadic @hal.ex.match_supported_executable_format(%arg0, [%c1230128453, %c1397773893]) : (!ireex.ref<!hal.device>, i32...) -> i32
...
// CHECK-NEXT:   %exe_data_1230128453 = vm.const.ref.rodata @exe_data_1230128453 : !ireex.byte_buffer_ref
// CHECK-NEXT:   %ref = vm.call @hal.ex.cache_executable(%arg0, %3, %exe_data_1230128453) : (!ireex.ref<!hal.device>, i32, !ireex.byte_buffer_ref) -> !ireex.ref<!hal.executable>
...
// CHECK-NEXT:   %exe_data_1397773893 = vm.const.ref.rodata @exe_data_1397773893 : !ireex.byte_buffer_ref
// CHECK-NEXT:   %ref_3 = vm.call @hal.ex.cache_executable(%arg0, %5, %exe_data_1397773893) : (!ireex.ref<!hal.device>, i32, !ireex.byte_buffer_ref) -> !ireex.ref<!hal.executable>
