...
// CHECK-DAG: vm.global.ref @exe_cached mutable : !iree.ref<!hal.executable>
// CHECK-DAG: vm.func @exe(%arg0: !iree.ref<!hal.device>) -> !iree.ref<!hal.executable> {
// CHECK:        %exe_cached = vm.global.load.ref @exe_cached : !iree.ref<!hal.executable>
// CHECK-NEXT:   %rnz = vm.cmp.nz.ref %exe_cached : !iree.ref<!hal.executable>
// CHECK-NEXT:   vm.cond_br %rnz, ^bb1(%exe_cached : !iree.ref<!hal.executable>), ^bb2
// CHECK-NEXT: ^bb1(%0: !iree.ref<!hal.executable>):
// CHECK-NEXT:   vm.return %0 : !iree.ref<!hal.executable>
// CHECK-NEXT: ^bb2:
// CHECK-NEXT:   %c1230128453 = vm.const.i32 1230128453 : i32
// CHECK-NEXT:   %c1397773893 = vm.const.i32 1397773893 : i32
// CHECK-NEXT:   %1 = vm.call.variadic @hal.ex.match_supported_executable_format(%arg0, [%c1230128453, %c1397773893]) : (!iree.ref<!hal.device>, i32...) -> i32
...
// CHECK-NEXT:   vm.return %null : !iree.ref<!hal.executable>
// CHECK-NEXT: }
