...
class VariableLoadIndirectOpConversion
 ...
 public:
  ...
  LogicalResult matchAndRewrite(
      ...
      ConversionPatternRewriter &rewriter) const override {
    IREE::HAL::VariableLoadIndirectOp::OperandAdaptor operands(newOperands);
    if (IREE::VM::RefType::isCompatible(op.getType())) {
...
class VariableStoreOpConversion
 ...
 public:
  ...
  LogicalResult matchAndRewrite(
      ...
      ConversionPatternRewriter &rewriter) const override {
    IREE::HAL::VariableStoreOp::OperandAdaptor operands(newOperands);
...
class VariableStoreIndirectOpConversion
 ...
 public:
  ...
  LogicalResult matchAndRewrite(
      ...
      ConversionPatternRewriter &rewriter) const override {
    IREE::HAL::VariableStoreIndirectOp::OperandAdaptor operands(newOperands);
    if (operands.value().getType().isa<IREE::VM::RefType>()) {
