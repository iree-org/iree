...
//      CHECK: hal.variable @_descriptor_set_layout_0 mutable init(@_descriptor_set_layout_0_initializer) : !hal.descriptor_set_layout
...
// CHECK-NEXT:   %descriptor_set_layout = hal.descriptor_set_layout.create %dev, bindings = [#hal.descriptor_set_layout_binding<0, "StorageBuffer", "Read">, #hal.descriptor_set_layout_binding<1, "StorageBuffer", "Write">] : !hal.descriptor_set_layout
...
func @descriptorSetLayoutLookup(%arg0 : !hal.device) -> !hal.descriptor_set_layout {
  ...
  %0 = hal.descriptor_set_layout.lookup %arg0, bindings = [
...
//      CHECK: hal.variable @_executable_layout_0 mutable init(@_executable_layout_0_initializer) : !hal.executable_layout
...
// CHECK-NEXT:   %dev = hal.ex.shared_device : !hal.device
// CHECK-NEXT:   %executable_layout = hal.executable_layout.create %dev, set_layouts = [%0] : !hal.executable_layout
...
// CHECK-NEXT:   %dev = hal.ex.shared_device : !hal.device
// CHECK-NEXT:   %executable_layout = hal.executable_layout.create %dev, set_layouts = [%0, %1] : !hal.executable_layout
// CHECK-NEXT:   return %executable_layout : !hal.executable_layout
// CHECK-NEXT: }
...
func @exeLookup(%arg0 : !hal.device) -> !hal.executable {
  // CHECK: %[[EXE:.+]] = hal.variable.load @exe : !hal.executable
