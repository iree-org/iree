...
func @runtime_buffer_subspan() {
  // CHECK-NEXT: = hal.constant.subspan @storage0_buffer0[#util.byte_range<0, 1024>] : tensor<4xf32>
  %cst0 = hal.constant.subspan @storage0_buffer0[#util.byte_range<0, 1024>] : tensor<4xf32>
  // CHECK-NEXT: = hal.constant.subspan @storage0_buffer0[#util.byte_range<1024, 2048>] : tensor<4xf32>
  %cst1 = hal.constant.subspan @storage0_buffer0[#util.byte_range<1024, 2048>] : tensor<4xf32>
  return
}
