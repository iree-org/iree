...
// RUN: iree-opt -split-input-file -iree-flow-rematerialize-dispatch-constants %s | FileCheck %s --dump-input=always
...
func @rematerializeSmall(%arg0 : tensor<4x4xf32>) -> tensor<4x4xf32> {
  ...
  // CHECK: %0 = flow.dispatch.region[%cst : tensor<3xi32>](%arg1 = %arg0 : tensor<4x4xf32>) : tensor<4x4xf32> {
  %0 = flow.dispatch.region[%cst : tensor<3xi32>](%arg1 = %arg0 : tensor<4x4xf32>, %arg2 = %small : tensor<4x4xf32>) : tensor<4x4xf32> {
...
func @noRematerializeLarge(%arg0 : tensor<4096x4xf32>) -> tensor<4096x4xf32> {
  ...
  // CHECK-NEXT: %0 = flow.dispatch.region[%cst : tensor<3xi32>](%arg1 = %arg0 : tensor<4096x4xf32>, %arg2 = %cst_0 : tensor<4096x4xf32>) : tensor<4096x4xf32> {
  %0 = flow.dispatch.region[%cst : tensor<3xi32>](%arg1 = %arg0 : tensor<4096x4xf32>, %arg2 = %large : tensor<4096x4xf32>) : tensor<4096x4xf32> {
...
func @noRematerializeIntoDot(%arg0 : tensor<4x4xf32>) -> tensor<4x4xf32> {
  ...
  %small = constant dense<1.23> : tensor<4x4xf32>
  // CHECK-NEXT: %0 = flow.dispatch.region[%cst : tensor<3xi32>](%arg1 = %arg0 : tensor<4x4xf32>, %arg2 = %cst_0 : tensor<4x4xf32>) : tensor<4x4xf32> {
  %0 = flow.dispatch.region[%cst : tensor<3xi32>](%arg1 = %arg0 : tensor<4x4xf32>, %arg2 = %small : tensor<4x4xf32>) : tensor<4x4xf32> {
