...
func @fusedReduction(%arg0 : tensor<5x1xf32>, %arg1 : tensor<5x1xi32>) {
  ...
  // CHECK: %3:2 = flow.reduction.region[%0 : tensor<1xi32>](%arg0, %arg1) : (tensor<5x1xf32>, tensor<5x1xi32>) -> (tensor<1xf32>, tensor<1xi32>)
  ...
  // CHECK-NEXT: } {dimensions = dense<[1, 2]> : tensor<2xi32>}
  %ret:2 = flow.reduction.region[%workload : tensor<1xi32>](%arg0, %arg1) : (tensor<5x1xf32>, tensor<5x1xi32>) -> (tensor<1xf32>, tensor<1xi32>)
      invocation((%i0, %i1) = %initialValueF : tensor<f32>,
