...
func @add_dispatch_0() attributes {cuda_workgroup_size = dense<[32, 1, 1]> : vector<3xi64>} {
  ...
  %0 = hal.interface.binding.subspan @legacy_io::@ro0[%c0] : memref<1024x1024x1024xf32>
  %1 = hal.interface.binding.subspan @legacy_io::@ro1[%c0] : memref<1024x1024x1024xf32>
  %2 = hal.interface.binding.subspan @legacy_io::@wo2[%c0] : memref<1024x1024x1024xf32>
