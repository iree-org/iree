  ...
  hal.executable.target @cuda, filter="cuda" {
    ...
    module  {
      func @dot_dispatch_0() {
        ...
        %c1 = constant 1 : index
        %0 = hal.interface.binding.subspan @legacy_io::@ro0[%c0] : !flow.dispatch.tensor<readonly:1024x1024xf32>
        %1 = hal.interface.binding.subspan @legacy_io::@ro1[%c0] : !flow.dispatch.tensor<readonly:1024x1024xf32>
        %2 = hal.interface.binding.subspan @legacy_io::@wo2[%c0] : !flow.dispatch.tensor<writeonly:1024x1024xf32>
