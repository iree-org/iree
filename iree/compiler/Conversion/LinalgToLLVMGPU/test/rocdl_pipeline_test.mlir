// RUN: iree-opt -split-input-file -iree-codegen-linalg-to-llvmgpu-enable-rocm -pass-pipeline="hal.executable(hal.executable.target(iree-codegen-hlo-to-llvmgpu-pipeline))" %s | IreeFileCheck %s
