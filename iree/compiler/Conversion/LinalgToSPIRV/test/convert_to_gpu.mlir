...
//       CHECK:   %[[INBOUNDZ:.+]] = cmpi "slt", %[[TIDZ]], %{{.+}}
//       CHECK:   %[[INBOUNDY:.+]] = cmpi "slt", %[[TIDY]], %{{.+}}
//       CHECK:   %[[CMP1:.+]] = and %[[INBOUNDZ]], %[[INBOUNDY]]
//       CHECK:   %[[INBOUNDX:.+]] = cmpi "slt", %[[TIDX]], %{{.+}}
//       CHECK:   %[[CMP2:.+]] = and %[[CMP1]], %[[INBOUNDX]]
//       CHECK:   scf.if %[[CMP2]]
//       CHECK:     scf.for
//       CHECK:       scf.for
//       CHECK:         scf.for
...
//       CHECK:   %[[BOFFSETY:.+]] = muli %[[BIDY]], %[[C4]]
//       CHECK:   %[[BOFFSETX:.+]] = muli %[[BIDX]], %[[C32]]
//       CHECK:   %[[SV1:.+]] = subview %[[ARG0]][%[[BOFFSETY]], %[[BOFFSETX]]]
//       CHECK:   %[[SV2:.+]] = subview %[[ARG2]][%[[BOFFSETY]], %[[BOFFSETX]]]
//   CHECK-DAG:   %[[TIDX:.+]] = "gpu.thread_id"() {dimension = "x"}
//   CHECK-DAG:   %[[TIDY:.+]] = "gpu.thread_id"() {dimension = "y"}
//       CHECK:   %[[INBOUNDY:.+]] = cmpi "slt", %[[TIDY]], %{{.+}}
//       CHECK:   %[[INBOUNDX:.+]] = cmpi "slt", %[[TIDX]], %{{.+}}
//       CHECK:   %[[CMP:.+]] = and %[[INBOUNDY]], %[[INBOUNDX]]
//       CHECK:   scf.if %[[CMP]]
//       CHECK:     scf.for
//       CHECK:       scf.for
