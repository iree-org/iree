...
// CHECK-PROMOTED: %[[A_TILE:.+]] = memref.subview %[[ARG0]][%[[WORKGROUP_ID_Y_INDEX]], 0] [64, 128] [1, 1] : memref<128x128xf32> to memref<64x128xf32, #[[MAP1]]>
// CHECK-PROMOTED: %[[WORKGROUP_ID_X_INDEX:.+]] = affine.apply #[[MAP0]]()[%[[WORKGROUP_TILE_X]]]
// CHECK-PROMOTED: %[[B_TILE:.+]] = memref.subview %[[ARG1]][0, %[[WORKGROUP_ID_X_INDEX]]] [128, 64] [1, 1] : memref<128x128xf32> to memref<128x64xf32, #[[MAP1]]>
// CHECK-PROMOTED: %[[C_TILE:.+]] = memref.subview %[[ARG2]][%[[WORKGROUP_ID_Y_INDEX]], %[[WORKGROUP_ID_X_INDEX]]] [64, 64] [1, 1] : memref<128x128xf32> to memref<64x64xf32, #[[MAP1]]>
