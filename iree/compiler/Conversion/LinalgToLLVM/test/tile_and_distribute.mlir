...
// // NOCHECK-DAG: %[[DIM_K:.+]] = memref.dim %[[LHS]], %[[CONST_1]]
...
// //     NOCHECK:     %[[DIM_I:.+]] = memref.dim %[[LHS]], %[[CONST_0]]
// //     NOCHECK:     %[[I_OFFSET:.+]] = affine.min #[[MAP1]]()[%[[THREAD_Y_ID]], %[[DIM_I]]]
// //     NOCHECK:     %[[LHS_SUBVIEW:.+]] = memref.subview %[[LHS]][%[[I]], %[[K]]] [%[[I_OFFSET]], 1] [1, 1]
// //     NOCHECK:     %[[J:.+]] = affine.apply #[[MAP3]]()[%[[THREAD_X_ID]]]
// //     NOCHECK:     %[[DIM_J:.+]] = memref.dim %[[RHS]], %[[CONST_1]]
// //     NOCHECK:     %[[J_OFFSET:.+]] = affine.min #[[MAP4]]()[%[[THREAD_X_ID]], %[[DIM_J]]]
// //     NOCHECK:     %[[RHS_SUBVIEW:.+]] = memref.subview %[[RHS]][%[[K]], %[[J]]] [1, %[[J_OFFSET]]] [1, 1]
// //     NOCHECK:     %[[DIM_I:.+]] = memref.dim %[[RESULT]], %[[CONST_0]]
// //     NOCHECK:     %[[DIM_I_OFFSET:.+]] = affine.min #[[MAP1]]()[%[[THREAD_Y_ID]], %[[DIM_I]]]
// //     NOCHECK:     %[[DIM_J:.+]] = memref.dim %[[RESULT]], %[[CONST_1]]
// //     NOCHECK:     %[[DIM_J_OFFSET:.+]] = affine.min #[[MAP4]]()[%[[THREAD_X_ID]], %[[DIM_J]]]
// //     NOCHECK:     %[[RESULT_SUBVIEW:.+]] = memref.subview %[[RESULT]][%[[I]], %[[J]]] [%[[DIM_I_OFFSET]], %[[DIM_J_OFFSET]]] [1, 1]
...
//     CHECK:    %[[LHS_SUBVIEW:.+]] = memref.subview %[[LHS]][%[[I]], %[[K]]] [2, 1] [1, 1]  : memref<16x4xf32> to memref<2x1xf32, #[[MAP1]]>
//     CHECK:    %[[J:.+]] = affine.apply #[[MAP2]]()[%[[THREAD_X_ID]]]
//     CHECK:    %[[RHS_SUBVIEW:.+]] = memref.subview %[[RHS]][%[[K]], %[[J]]] [1, 4] [1, 1]  : memref<4x8xf32> to memref<1x4xf32, #[[MAP3]]>
//     CHECK:    %[[RESULT_SUBVIEW:.+]] = memref.subview %[[RESULT]][%[[I]], %[[J]]] [2, 4] [1, 1]  : memref<16x8xf32> to memref<2x4xf32, #[[MAP3]]>
//     CHECK:    linalg.matmul
