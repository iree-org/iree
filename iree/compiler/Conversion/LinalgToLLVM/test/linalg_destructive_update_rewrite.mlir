// RUN: iree-opt %s --test-iree-codegen-linalg-rewrite-destructive-update-pattern-inplace -canonicalize -cse -split-input-file | IreeFileCheck %s
...
func @tile_from_pointwise_lhs() {
  ...
  %3 = linalg.generic #trait ins(%1 : tensor<2x3xf32>) {
  ^bb0(%arg0: f32):
