...
func.func @argUI64(%arg: ui64) -> ui64 {
  return %arg : ui64
}

// CHECK-LABEL: func @hloConstantI64
// CHECK-SAME: () -> tensor<1xi32>
func.func @hloConstantI64() -> tensor<1xi64> {
...
func.func @hloConstantUI64() -> tensor<1xui64> {
...
func.func @constantSplatTensorI64() -> tensor<4xi64> {
...
// CHECK-SAME: () -> tensor<4xi32>
func.func @constantDenseTensorI64() -> tensor<4xi64> {
...
func.func @typesI64(%arg0 : i64) -> i64 {
...
func.func @tensorTypesI64(%arg0 : tensor<4x4xi64>) -> tensor<4x4xi64> {
...
func.func @tensorUnrankedArg(%arg0 : tensor<*xi64>) -> tensor<*xi64> {
  return %arg0 : tensor<*xi64>
}

// -----
func.func @tensorUnrankedValue(%arg0 : tensor<4xi64>) -> tensor<4xi64> {
...
func.func @compareI64(%arg0 : tensor<i64>, %arg1 : tensor<i64>) -> (i1, tensor<i64>) {
...
func.func @tensor(%A: tensor<2x3xf32>, %B: tensor<3x4xf32>, %C: tensor<2x4xf32>)  -> tensor<2x4xf32> {
...
func.func @linalg(%A: tensor<2xf32>)  -> tensor<2xf32> {
