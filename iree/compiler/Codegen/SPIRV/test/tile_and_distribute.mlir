...
hal.executable private @conv_2d  {
  ...
  hal.executable.variant @vulkan, target = <"vulkan-spirv", "vulkan-spirv-fb"> {
    ...
    builtin.module {
      func @conv_2d() {
        %c0 = arith.constant 0 : index
        %n = hal.interface.constant.load offset = 0 : index
        %oh = hal.interface.constant.load offset = 1 : index
        %ow = hal.interface.constant.load offset = 2 : index
        %oc = hal.interface.constant.load offset = 3 : index
        %ih = hal.interface.constant.load offset = 4 : index
        %iw = hal.interface.constant.load offset = 5 : index
        %ic = hal.interface.constant.load offset = 6 : index
        %fh = hal.interface.constant.load offset = 7 : index
        %fw = hal.interface.constant.load offset = 8 : index
