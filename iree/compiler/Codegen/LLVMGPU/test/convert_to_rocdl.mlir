...
func @abs_ex_dispatch_0() {
  ...
  %0 = hal.interface.binding.subspan type(storage_buffer) set(0) binding(0) : memref<16xf32>
  %1 = hal.interface.binding.subspan type(storage_buffer) set(0) binding(1) : memref<16xf32>
  %2 = hal.interface.binding.subspan type(storage_buffer) set(0) binding(2) : memref<16xf32>
