...
func @dot() {
  ...
  %0 = hal.interface.binding.subspan type(storage_buffer) set(0) binding(0) : memref<2048x1024xf32>
  %1 = hal.interface.binding.subspan type(storage_buffer) set(0) binding(1) : memref<1024x512xf32>
  %2 = hal.interface.binding.subspan type(storage_buffer) set(0) binding(2) : memref<2048x512xf32>
