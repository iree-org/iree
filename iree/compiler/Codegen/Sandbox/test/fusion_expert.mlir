// RUN: iree-opt -pass-pipeline="builtin.func(linalg-fuse{anchor-func=matmul anchor-op=linalg.generic tile-sizes=10,20,30 vectorize}), canonicalize, cse" -split-input-file %s | IreeFileCheck %s
