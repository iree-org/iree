...
func @fold_reshape() {
  ...
  // CHECK: %[[ARG:.+]] = hal.interface.binding.subspan type(storage_buffer) set(0) binding(0) : !flow.dispatch.tensor<readonly:3x3x96xf32>
  %1 = hal.interface.binding.subspan type(storage_buffer) set(0) binding(0) : !flow.dispatch.tensor<readonly:3x3x1x96xf32>
  %2 = hal.interface.binding.subspan type(storage_buffer) set(0) binding(0) : !flow.dispatch.tensor<writeonly:3x3x96xf32>
...
func @dont_fold_reshape_with_not_full_load() {
  ...
  %1 = hal.interface.binding.subspan type(storage_buffer) set(0) binding(0) : !flow.dispatch.tensor<readonly:6x3x1x96xf32>
  %2 = hal.interface.binding.subspan type(storage_buffer) set(0) binding(0) : !flow.dispatch.tensor<writeonly:3x3x96xf32>
...
func @dont_fold_dynamic_reshape() {
  ...
  %1 = hal.interface.binding.subspan type(storage_buffer) set(0) binding(0) : !flow.dispatch.tensor<readonly:?x?x96xf32>{%dim0, %dim1}
  %2 = hal.interface.binding.subspan type(storage_buffer) set(0) binding(0) : !flow.dispatch.tensor<writeonly:?x12x8xf32>{%dim2}
