...
//       CHECK:       linalg.generic(%[[INIT]], %[[RESULT]])
//       CHECK:       linalg.matmul
...
//       CHECK:       linalg.generic(%[[RESULT1]], %[[RESULT2]])
...
//       CHECK:       linalg.generic(%[[INIT_TILE]], %[[RESULT_TILE]])
//       CHECK:       linalg.matmul
...
//       CHECK:   linalg.generic(%[[RESHAPE]], %[[RET0]])
...
//  CHECK-SAME:     ins(%[[RESHAPE]] : memref<3x4xi32>)
//  CHECK-SAME:     outs(%[[RET0]] : memref<3x4xi32>)
//       CHECK:   linalg.generic(%[[RESHAPE]], %[[RET1]])
...
//       CHECK: linalg.generic(%[[SUBVIEW]], %[[RETURN]])
...
//       CHECK:   linalg.generic(%[[SUBVIEW_INPUT]], %[[SUBVIEW_OUTPUT]])
...
//       CHECK:   linalg.generic(%[[ARG1]], %[[RET0]])
//       CHECK:   %[[SUBVIEW:.+]] = memref.subview %[[RET0]][3, 4] [%[[D0]], %[[D1]]] [1, 1]
//       CHECK:   linalg.generic(%[[ARG0]], %[[SUBVIEW]])
...
//       CHECK:   linalg.generic(%[[IN]], %[[OUT]]) : memref<3x4xi32>, memref<3x4xi32>
...
//       CHECK:   linalg.generic(%[[MEMREF]], %[[RESULT]])
...
//       CHECK: linalg.generic(%[[CAST1]], %[[OUTPUT]])
//       CHECK: linalg.generic
...
//       CHECK:   linalg.generic(%[[ARG]], %[[SUBVIEW]])
...
//         CHECK:   linalg.generic(%[[ARG2V]], %[[RET0V]])
...
//       CHECK:       linalg.generic(%[[ARG0_SV]], %[[ALLOC_ARG0_SV]])
//       CHECK:      linalg.fill(%{{.*}}, %[[ALLOC_ARG1]]
//       CHECK:      linalg.generic(%[[ARG1_SV]]
...
//       CHECK:      linalg.generic(%[[ALLOC_RET0_SV]], %[[RET0_SV]])
...
//        CHECK:            linalg.generic(%[[INIT_WORKGROUP_TILE]], %[[DST_WORKGROUP_TILE]])
...
//   CHECK-DAG:   %[[INPUT:.+]] = hal.interface.binding.subspan set(0) binding(0) type(storage_buffer)
//   CHECK-DAG:   %[[OUTPUT:.+]] = hal.interface.binding.subspan set(0) binding(1) type(storage_buffer)
//       CHECK:   linalg.generic(%[[INPUT]], %[[OUTPUT]])
//       CHECK:   scf.for %[[ARG0:.+]] =
//       CHECK:     scf.for %[[ARG1:.+]] =
...
//       CHECK:       linalg.generic(%[[SRC_VIEW]], %[[DST_VIEW]])
