...
func @bufferize_dynamic() {
  %c0 = arith.constant 0 : index
  %c1 = arith.constant 1 : index
  %4 = hal.interface.constant.load offset = 0 : index
  %5 = hal.interface.constant.load offset = 1 : index
  %6 = hal.interface.constant.load offset = 2 : index
  %7 = hal.interface.constant.load offset = 3 : index
  %8 = hal.interface.constant.load offset = 4 : index
  %9 = hal.interface.constant.load offset = 5 : index
  %10 = hal.interface.constant.load offset = 6 : index
  %11 = hal.interface.constant.load offset = 7 : index
...
//       CHECK:   %[[DIM2:.+]] = hal.interface.constant.load offset = 2 : index
//       CHECK:   %[[DIM3:.+]] = hal.interface.constant.load offset = 3 : index
//       CHECK:   %[[DIM4:.+]] = hal.interface.constant.load offset = 4 : index
//       CHECK:   %[[DIM5:.+]] = hal.interface.constant.load offset = 5 : index
//       CHECK:   %[[DIM6:.+]] = hal.interface.constant.load offset = 6 : index
//       CHECK:   %[[DIM7:.+]] = hal.interface.constant.load offset = 7 : index
...
func @slice() {
  %c0 = arith.constant 0 : index
  %2 = hal.interface.constant.load offset = 0 : index
  %3 = hal.interface.constant.load offset = 1 : index
  %4 = hal.interface.constant.load offset = 2 : index
  %5 = hal.interface.constant.load offset = 3 : index
...
func @slice_multiple_copy() {
  %c0 = arith.constant 0 : index
  %3 = hal.interface.constant.load offset = 0 : index
  %4 = hal.interface.constant.load offset = 1 : index
  %5 = hal.interface.constant.load offset = 2 : index
  %6 = hal.interface.constant.load offset = 3 : index
  %7 = hal.interface.constant.load offset = 4 : index
  %8 = hal.interface.constant.load offset = 5 : index
  %12 = hal.interface.constant.load offset = 6 : index
...
//   CHECK-DAG: %[[SIZE1:.+]] = hal.interface.constant.load offset = 3 : index
//   CHECK-DAG: %[[SIZE2:.+]] = hal.interface.constant.load offset = 4 : index
//   CHECK-DAG: %[[SIZE3:.+]] = hal.interface.constant.load offset = 5 : index
...
func @slice_whole_stride_dispatch_0() {
  ...
  %dim3 = hal.interface.constant.load offset = 3 : index
...
func @subtensor_insert() {
  ...
  %dim2 = hal.interface.constant.load offset = 2 : index
  %dim3 = hal.interface.constant.load offset = 3 : index
  %dim4 = hal.interface.constant.load offset = 4 : index
  %dim5 = hal.interface.constant.load offset = 5 : index
  %0 = hal.interface.binding.subspan type(StorageBuffer) set(0) binding(0) : !flow.dispatch.tensor<readonly:?x?xi32>{%dim0, %dim1}
...
//   CHECK-DAG:   %[[D0:.+]] = hal.interface.constant.load offset = 0 : index
//   CHECK-DAG:   %[[D1:.+]] = hal.interface.constant.load offset = 1 : index
...
func @read_only_subtensor() {
  %c0 = arith.constant 0 : index
  %c1 = arith.constant 1 : index
  %pc0 = hal.interface.constant.load offset = 0 : index
  %pc1 = hal.interface.constant.load offset = 1 : index
  %pc2 = hal.interface.constant.load offset = 2 : index
  %pc3 = hal.interface.constant.load offset = 3 : index
  %pc4 = hal.interface.constant.load offset = 4 : index
  %pc5 = hal.interface.constant.load offset = 5 : index
...
func @multi_result() {
  ...
  %dim4 = hal.interface.constant.load offset = 4 : index
  %dim5 = hal.interface.constant.load offset = 5 : index
  %dim6 = hal.interface.constant.load offset = 6 : index
  %dim7 = hal.interface.constant.load offset = 7 : index
  %0 = hal.interface.binding.subspan type(StorageBuffer) set(0) binding(0) : !flow.dispatch.tensor<readonly:?x?xf32>{%dim0, %dim1}
  ...
  %4 = hal.interface.constant.load offset = 8 : index
  %5 = hal.interface.constant.load offset = 9 : index
  %6 = hal.interface.constant.load offset = 10 : index
  %7 = hal.interface.constant.load offset = 11 : index
...
func @multi_result_reduce() {
  ...
  %d2 = hal.interface.constant.load offset = 2 : index
...
builtin.func @tensor_insert_slice() {
  ...
  %d1 = hal.interface.constant.load offset = 3 : index
  %d2 = hal.interface.constant.load offset = 4 : index
  %d3 = hal.interface.constant.load offset = 5 : index
  %0 = hal.interface.binding.subspan type(StorageBuffer) set(0) binding(0) : !flow.dispatch.tensor<readonly:?x?xi32>{%d0, %d1}
...
//   CHECK-DAG:   %[[OFFSET_Y:.+]] = hal.interface.constant.load offset = 0
//   CHECK-DAG:   %[[OFFSET_X:.+]] = hal.interface.constant.load offset = 1
//       CHECK:   scf.for %[[IV0:.+]] =
//       CHECK:     scf.for %[[IV1:.+]] =
