...
func @load_subspan_with_offset(%offset : index, %i0: index, %i1: index, %i2: index) -> f32 {
  %subspan = hal.interface.binding.subspan type(storage_buffer) set(0) binding(0) offset(%offset) : memref<6x7x8xf32>
...
//      CHECK:   %[[SUBSPAN:.+]] = hal.interface.binding.subspan type(storage_buffer) set(0) binding(0) offset(%[[ZERO]]) : memref<?xf32>{%[[C336]]}
...
func @store_subspan_with_offset(%value: f32, %offset : index, %i0: index, %i1: index, %i2: index) {
  %subspan = hal.interface.binding.subspan type(storage_buffer) set(0) binding(0) offset(%offset) : memref<2x3x4xf32>
...
//      CHECK:   %[[SUBSPAN:.+]] = hal.interface.binding.subspan type(storage_buffer) set(0) binding(0) offset(%[[ZERO]]) : memref<?xf32>{%[[C24]]}
//      CHECK:   %[[INDEX:.+]] = affine.apply #[[MAP]]()[%[[I0]], %[[I1]], %[[I2]], %[[OFFSET]]]
...
func @load_subspan_with_vector_element(%offset : index, %i0: index, %i1: index, %i2: index) -> vector<4xf32> {
  %subspan = hal.interface.binding.subspan type(storage_buffer) set(0) binding(0) offset(%offset) : memref<6x7x8xvector<4xf32>>
...
func @load_subspan_with_16bit_element(%offset : index, %i0: index, %i1: index, %i2: index) -> f16 {
  %subspan = hal.interface.binding.subspan type(storage_buffer) set(0) binding(0) offset(%offset) : memref<6x7x8xf16>
...
func @store_subspan_with_leading_dynamic_dim(%value: f32, %offset : index, %i0: index, %i1: index, %i2: index) {
  ...
  %subspan = hal.interface.binding.subspan type(storage_buffer) set(0) binding(0) offset(%offset) : memref<?x3x4xf32>{%dim}
...
//      CHECK:   %[[DST:.+]] = hal.interface.binding.subspan type(storage_buffer) set(0) binding(0) offset(%[[C0]]) : memref<?xf32>{%[[SIZE]]}
...
func @store_subspan_with_all_dynamic_dim(%value: f32, %offset : index, %i0: index, %i1: index, %i2: index, %i3: index) {
  ...
  %subspan = hal.interface.binding.subspan type(storage_buffer) set(0) binding(0) offset(%offset) : memref<?x?x?x?xf32>{%dim0, %dim1, %dim2, %dim3}
...
func @store_subspan_with_mixed_dynamic_dim(%value: f32, %offset : index, %i0: index, %i1: index, %i2: index, %i3: index) {
  %dim0 = hal.interface.constant.load[0] : index
  %dim1 = hal.interface.constant.load[1] : index
  %subspan = hal.interface.binding.subspan type(storage_buffer) set(0) binding(0) offset(%offset) : memref<?x4x?x8xf32>{%dim0, %dim1}
...
//      CHECK:   %[[C0:.+]] = arith.constant 0 : index
//      CHECK:   %[[SUBSPAN:.+]] = hal.interface.binding.subspan type(storage_buffer) set(0) binding(0) offset(%[[C0]]) : memref<?xf32>
...
func @transfer_read_subspan_with_offset(
  ...
  %subspan = hal.interface.binding.subspan type(storage_buffer) set(0) binding(0) offset(%arg0) : memref<6x7x8xf32>
...
//      CHECK:   %[[MEMREF:.+]] = hal.interface.binding.subspan type(storage_buffer) set(0) binding(0) offset(%[[ARG0]]) : memref<?xf32>
...
func @load_store_rank_zero_subspan_with_offset(%offset : index) {
  %subspan0 = hal.interface.binding.subspan type(storage_buffer) set(0) binding(0) offset(%offset) : memref<f32>
  %subspan1 = hal.interface.binding.subspan type(storage_buffer) set(0) binding(1) offset(%offset) : memref<f32>
...
//      CHECK:   %[[SPAN0:.+]] = hal.interface.binding.subspan type(storage_buffer) set(0) binding(0) offset(%[[C0]]) : memref<?xf32>{%[[C1]]}
//      CHECK:   %[[SPAN1:.+]] = hal.interface.binding.subspan type(storage_buffer) set(0) binding(1) offset(%[[C0]]) : memref<?xf32>{%[[C1]]}
...
func @collapse_shape(%offset : index, %i0 : index, %i1 : index) -> f32 {
  %subspan = hal.interface.binding.subspan type(storage_buffer) set(0) binding(0) offset(%offset) : memref<4x5x6x7xf32>
...
//      CHECK:   %[[SUBSPAN:.+]] = hal.interface.binding.subspan type(storage_buffer) set(0) binding(0) offset(%[[C0]]) : memref<?xf32>{%[[SIZE]]}
...
func @expand_shape(%offset : index, %i0: index, %i1: index, %i2: index, %i3: index) -> f32 {
  %subspan = hal.interface.binding.subspan type(storage_buffer) set(0) binding(0) offset(%offset) : memref<20x42xf32>
