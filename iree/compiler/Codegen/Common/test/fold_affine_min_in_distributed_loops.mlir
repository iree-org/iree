// RUN: iree-opt -split-input-file -iree-codegen-fold-affinemin-in-distributed-loops -mlir-print-local-scope %s | IreeFileCheck %s

// CHECK-LABEL: func @loop_distributed_to_workgroup_x
func @loop_distributed_to_workgroup_x() -> index {
...
func @loop_distributed_to_workgroup_y() -> index {
  %c0 = arith.constant 0 : index
  // CHECK: %[[C32:.+]] = arith.constant 32 : index
  %c32 = arith.constant 32 : index
...
func @loop_distributed_to_workgroup_z() -> index {
  %c0 = arith.constant 0 : index
  // CHECK: %[[C32:.+]] = arith.constant 32 : index
  %c32 = arith.constant 32 : index
...
func @loop_distributed_to_workitem_x() -> index {
  %c0 = arith.constant 0 : index
  // CHECK: %[[C32:.+]] = arith.constant 32 : index
  %c32 = arith.constant 32 : index
...
func @loop_distributed_to_workitem_y() -> index {
  %c0 = arith.constant 0 : index
  // CHECK: %[[C32:.+]] = arith.constant 32 : index
  %c32 = arith.constant 32 : index
...
func @loop_distributed_to_workitem_z() -> index {
  %c0 = arith.constant 0 : index
  // CHECK: %[[C32:.+]] = arith.constant 32 : index
  %c32 = arith.constant 32 : index
...
func @cst_folded_into_affine_map() -> index {
  %c0 = arith.constant 0 : index
  // CHECK: %[[C32:.+]] = arith.constant 32 : index
  %c32 = arith.constant 32 : index
...
func @affine_apply_folded_into_loop() -> index {
  %c0 = arith.constant 0 : index
...
func @mismatched_id_count() -> index {
  %c0 = arith.constant 0 : index
  // CHECK: %[[C32:.+]] = arith.constant 32 : index
  %c32 = arith.constant 32 : index
...
func @cannot_prove_cst_bound() -> index {
  %c0 = arith.constant 0 : index
  %c8 = arith.constant 8 : index
...
func @can_prove_symbolic_bound() -> index {
  %c0 = arith.constant 0 : index
  %c8 = arith.constant 8 : index
  %c9 = arith.constant 9 : index
  %c112 = arith.constant 112 : index
