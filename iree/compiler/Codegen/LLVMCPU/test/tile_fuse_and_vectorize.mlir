...
//      CHECK: %[[LHS:.+]] = hal.interface.binding.subspan type(storage_buffer) set(0) binding(0) : !flow.dispatch.tensor<readonly:384x512xf32>
//      CHECK: %[[RHS:.+]] = hal.interface.binding.subspan type(storage_buffer) set(0) binding(1) : !flow.dispatch.tensor<readonly:512x128xf32>
//      CHECK: %[[DST:.+]] = hal.interface.binding.subspan type(storage_buffer) set(0) binding(2) : !flow.dispatch.tensor<writeonly:384x128xf32>
...
func @matmul_gather() {
  ...
  %c0 = arith.constant 0 : index
  %c64 = arith.constant 64 : index
  %0 = hal.interface.binding.subspan type(storage_buffer) set(0) binding(0) : !flow.dispatch.tensor<readonly:384xi32>
  %1 = hal.interface.binding.subspan type(storage_buffer) set(0) binding(1) : !flow.dispatch.tensor<readonly:384x512xf32>
  %2 = hal.interface.binding.subspan type(storage_buffer) set(0) binding(2) : !flow.dispatch.tensor<readonly:384x384xf32>
  %3 = hal.interface.binding.subspan type(storage_buffer) set(0) binding(3) : !flow.dispatch.tensor<readonly:384x512xf32>
  %4 = hal.interface.binding.subspan type(storage_buffer) set(0) binding(4) offset(%c1835008) : !flow.dispatch.tensor<readonly:2x512xf32>
  %5 = hal.interface.binding.subspan type(storage_buffer) set(0) binding(5) : !flow.dispatch.tensor<writeonly:384x512xf32>
...
func @nonvectorizable_matmul_and_vectorizable_generic() {
  ...
  %0 = hal.interface.binding.subspan type(storage_buffer) set(0) binding(0) offset(%c768) : !flow.dispatch.tensor<readonly:96xf32>
  %1 = hal.interface.binding.subspan type(storage_buffer) set(0) binding(0) offset(%c0) : !flow.dispatch.tensor<readonly:96xf32>
  %2 = hal.interface.binding.subspan type(storage_buffer) set(0) binding(0) offset(%c1152) : !flow.dispatch.tensor<readonly:96xf32>
  %3 = hal.interface.binding.subspan type(storage_buffer) set(0) binding(0) offset(%c384) : !flow.dispatch.tensor<readonly:96xf32>
  %4 = hal.interface.binding.subspan type(storage_buffer) set(0) binding(1) : !flow.dispatch.tensor<readonly:784x24xf32>
  %5 = hal.interface.binding.subspan type(storage_buffer) set(0) binding(2) : !flow.dispatch.tensor<readonly:24x96xf32>
  %6 = hal.interface.binding.subspan type(storage_buffer) set(0) binding(3) : !flow.dispatch.tensor<writeonly:784x96xf32>
  %workgroup_id_x = hal.interface.workgroup.id[0] : index
  %workgroup_count_x = hal.interface.workgroup.count[0] : index
  %workgroup_id_y = hal.interface.workgroup.id[1] : index
  %workgroup_count_y = hal.interface.workgroup.count[1] : index
