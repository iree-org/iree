...
// CHECK-SAME: %[[ARG0:[a-zA-Z0-9$._-]+]]: !spv.ptr<!spv.struct<!spv.array<4 x f32, stride=4> [0]>, StorageBuffer>
// CHECK-SAME: %[[ARG1:[a-zA-Z0-9$._-]+]]: !spv.ptr<!spv.struct<!spv.array<4 x f32, stride=4> [0]>, StorageBuffer>
// CHECK-SAME: %[[ARG2:[a-zA-Z0-9$._-]+]]: !spv.ptr<!spv.struct<!spv.array<4 x f32, stride=4> [0]>, StorageBuffer>
func @mul_1D(%arg0: memref<4xf32>, %arg1: memref<4xf32>, %arg2: memref<4xf32>)
attributes {iree.dispatch_fn_name = "mul_1D"} {
...
attributes {iree.dispatch_fn_name = "frem"} {
  %0 = iree.load_input(%arg0 : memref<4xf32>) : tensor<4xf32>
  %1 = iree.load_input(%arg1 : memref<4xf32>) : tensor<4xf32>
  // CHECK: spv.FRem
...
attributes {iree.dispatch_fn_name = "srem"} {
