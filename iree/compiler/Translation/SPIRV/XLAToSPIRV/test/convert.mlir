...
module {
  ...
  attributes {iree.dispatch_fn_name = "convert_f2f_nop"} {
...
module {
  ...
  attributes {iree.dispatch_fn_name = "convert_f2f"} {
    %0 = iree.load_input(%arg0 : memref<12xf32>) : tensor<12xf32>
...
module {
  ...
  attributes {iree.dispatch_fn_name = "convert_i2i_nop"} {
...
module {
  ...
  attributes {iree.dispatch_fn_name = "convert_i2i"} {
    %0 = iree.load_input(%arg0 : memref<12xi32>) : tensor<12xi32>
...
module {
  ...
  attributes {iree.dispatch_fn_name = "convert_i2f"} {
    %0 = iree.load_input(%arg0 : memref<12xi32>) : tensor<12xi32>
...
module {
  ...
  attributes {iree.dispatch_fn_name = "convert_f2i_nop"} {
    %0 = iree.load_input(%arg0 : memref<12xf32>) : tensor<12xf32>
...
module {
  ...
  attributes {iree.dispatch_fn_name = "convert_b2i"} {
