...
func @fold_memref_to_memref(%arg0 : memref<i32>) -> memref<i32> {
  ...
  %0 = iree_interp.memref_to_scalar(%arg0 : memref<i32>) : i32
  %1 = iree_interp.scalar_to_memref(%0 : i32) : memref<i32>
  return %1 : memref<i32>
}
...
func @fold_scalar_to_scalar(%arg0 : i32) -> i32 {
  // CHECK-NEXT: return [[ARG]]
  %0 = iree_interp.scalar_to_memref(%arg0 : i32) : memref<i32>
  %1 = iree_interp.memref_to_scalar(%0 : memref<i32>) : i32
  return %1 : i32
}
