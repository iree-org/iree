...
func @fold_memref_to_memref(%arg0 : memref<i32>) -> memref<i32> {
  ...
  %0 = iree_interp.memref_to_tensor(%arg0 : memref<i32>) : tensor<i32>
  %1 = iree_interp.tensor_to_memref(%0 : tensor<i32>) : memref<i32>
  return %1 : memref<i32>
}
...
func @fold_tensor_to_tensor(%arg0 : tensor<i32>) -> tensor<i32> {
  // CHECK-NEXT: return [[ARG]]
  %0 = iree_interp.tensor_to_memref(%arg0 : tensor<i32>) : memref<i32>
  %1 = iree_interp.memref_to_tensor(%0 : memref<i32>) : tensor<i32>
  return %1 : tensor<i32>
}
