...
// Adds rewrite patterns for lowering standard ops to IREE ops.
void populateLowerStdToIreePatterns(OwningRewritePatternList &patterns,
                                    MLIRContext *ctx);

// Adds rewrite patterns for lowering xla_hlo ops to IREE ops.
void populateLowerXlaToIreePatterns(OwningRewritePatternList &patterns,
                                    MLIRContext *ctx);

// Adds rewrite patterns for lowering standard ops to IREE interpreter ops.
void populateLowerStdToInterpreterPatterns(OwningRewritePatternList &patterns,
                                           MLIRContext *ctx);

// Adds rewrite patterns for lowering xla_hlo ops to IREE interpreter ops.
