...
#ifndef IREE_COMPILER_TRANSLATION_LLVM_TRANSFORMS_PASSES_H
#define IREE_COMPILER_TRANSLATION_LLVM_TRANSFORMS_PASSES_H
...
#endif  // IREE_COMPILER_TRANSLATION_LLVM_TRANSFORMS_PASSES_H
