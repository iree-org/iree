// RUN: iree-translate -split-input-file -print-ir-after=iree-hal-serialize-executables -iree-mlir-to-hal-executable -iree-hal-target-backends=vmvx %s -o=dummy.vmfb 2>&1 | IreeFileCheck %s
