// RUN: ireec -split-input-file -print-ir-after=iree-hal-serialize-executables -iree-mlir-to-hal-executable -iree-hal-target-backends=vmvx %s -o=/dev/null 2>&1 | FileCheck %s
