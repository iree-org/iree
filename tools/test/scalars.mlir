...
// RUN: iree-compile --iree-hal-target-backends=vmvx %s | iree-benchmark-module --driver=local-task --entry_function=scalar --function_input=42 | FileCheck --check-prefix=BENCHMARK %s
