...
class LogBuffer:
    ...
    def __init__(
        self,
        log_content: str,
        strip_formats: Optional[List[str]] = None,
    ...
    def _get_compiled_pattern(self, pattern: Union[str, Pattern]) -> Pattern:
    ...
    def find_previous_match(
        self, start_offset: int, pattern: Union[str, Pattern], max_lines: int = 50
    ) -> Optional[Match]:
    ...
    def find_all_matches(self, pattern: Union[str, Pattern]) -> List[tuple[int, Match]]:
