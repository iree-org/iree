...
class MLIRCompilerIssue(Issue):
    ...
    operation: Optional[str] = None  # "linalg.generic", "tensor.extract_slice"
    ...
    test_target: Optional[str] = None  # "tests/e2e/linalg/argmax.mlir"
    compile_command: Optional[str] = None  # "iree-compile ... -o foo.vmfb"
...
class MissingDependencyIssue(Issue):
    ...
    suggested_dep: Optional[str] = None
...
class GPUDriverIssue(Issue):
    ...
    error_code: str = ""
    error_type: str = ""
    test_passed_before_crash: Optional[bool] = None
    rocclr_file: Optional[str] = None
...
class CodeQLIssue(Issue):
    ...
    found_language: Optional[str] = None
