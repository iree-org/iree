...
class GitHubClient:
    ...
    def get_runs_for_pr(
        self, pr_number: int, status: Optional[str] = None, limit: int = 10
    ) -> List[WorkflowRun]:
    ...
    def get_runs_for_commit(
        self, commit_sha: str, status: Optional[str] = None, limit: int = 10
    ) -> List[WorkflowRun]:
    ...
    def get_job_log(self, run_id: str, job_id: str) -> Optional[str]:
