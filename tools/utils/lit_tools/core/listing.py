...
from lit_tools.core import formatting, test_file


def get_cases(file_path: Path) -> list[test_file.TestCase]:
    ...
    """
    return test_file.parse_test_file(file_path)


def build_json_payload(file_path: Path, cases: list[test_file.TestCase]) -> dict:
...
def format_names(cases: list[test_file.TestCase]) -> str:
...
def count_cases(cases: list[test_file.TestCase]) -> int:
    """Count test cases.
