...
#ifndef THIRD_PARTY_MLIR_EDGE_IREE_BASE_WAIT_HANDLE_H_
#define THIRD_PARTY_MLIR_EDGE_IREE_BASE_WAIT_HANDLE_H_
...
#endif  // THIRD_PARTY_MLIR_EDGE_IREE_BASE_WAIT_HANDLE_H_
