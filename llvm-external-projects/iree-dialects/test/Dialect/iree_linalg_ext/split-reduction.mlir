...
// SINGLE-SAME:                                       %[[VAL_1:.*]]: tensor<3xf32>,
// SINGLE-SAME:                                       %[[VAL_2:.*]]: tensor<3xi32>) -> (tensor<3xf32>, tensor<3xi32>) {
// SINGLE:           %[[VAL_3:.*]] = arith.constant 0xFF800000 : f32
// SINGLE:           %[[VAL_4:.*]] = arith.constant 2147483647 : i32
// SINGLE:           %[[VAL_5:.*]] = arith.constant 3 : i32
// SINGLE:           %[[VAL_6:.*]] = tensor.expand_shape %[[VAL_0]] {{\[\[}}0, 1]] : tensor<30xf32> into tensor<3x10xf32>
// SINGLE:           %[[VAL_7:.*]] = linalg.init_tensor [3, 3] : tensor<3x3xf32>
// SINGLE:           %[[VAL_8:.*]] = linalg.init_tensor [3, 3] : tensor<3x3xi32>
// SINGLE:           %[[VAL_9:.*]] = linalg.fill ins(%[[VAL_3]] : f32) outs(%[[VAL_7]] : tensor<3x3xf32>) -> tensor<3x3xf32>
// SINGLE:           %[[VAL_10:.*]] = linalg.fill ins(%[[VAL_4]] : i32) outs(%[[VAL_8]] : tensor<3x3xi32>) -> tensor<3x3xi32>
// SINGLE:           %[[VAL_11:.*]]:2 = iree_linalg_ext.topk {__internal_linalg_transform__ = "SPLIT_REDUCTION"} dimension(1) ins(%[[VAL_6]] : tensor<3x10xf32>) outs(%[[VAL_9]], %[[VAL_10]] : tensor<3x3xf32>, tensor<3x3xi32>) {
// SINGLE:           ^bb0(%[[VAL_12:.*]]: f32, %[[VAL_13:.*]]: f32):
// SINGLE:             %[[VAL_14:.*]] = arith.cmpf ogt, %[[VAL_12]], %[[VAL_13]] : f32
// SINGLE:             iree_linalg_ext.yield %[[VAL_14]] : i1
// SINGLE:           } -> tensor<3x3xf32>, tensor<3x3xi32>
// SINGLE:           %[[VAL_15:.*]] = linalg.generic {indexing_maps = [#map], iterator_types = ["parallel", "parallel"]} outs(%[[VAL_16:.*]]#1 : tensor<3x3xi32>) {
// SINGLE:           ^bb0(%[[VAL_17:.*]]: i32):
// SINGLE:             %[[VAL_18:.*]] = linalg.index 0 : index
// SINGLE:             %[[VAL_19:.*]] = arith.index_cast %[[VAL_18]] : index to i32
// SINGLE:             %[[VAL_20:.*]] = arith.muli %[[VAL_19]], %[[VAL_5]] : i32
// SINGLE:             %[[VAL_21:.*]] = arith.addi %[[VAL_20]], %[[VAL_17]] : i32
// SINGLE:             linalg.yield %[[VAL_21]] : i32
// SINGLE:           } -> tensor<3x3xi32>
// SINGLE:           %[[VAL_22:.*]] = tensor.collapse_shape %[[VAL_23:.*]]#0 {{\[\[}}0, 1]] : tensor<3x3xf32> into tensor<9xf32>
// SINGLE:           %[[VAL_24:.*]] = tensor.collapse_shape %[[VAL_25:.*]] {{\[\[}}0, 1]] : tensor<3x3xi32> into tensor<9xi32>
// SINGLE:           %[[VAL_26:.*]]:2 = iree_linalg_ext.topk {__internal_linalg_transform__ = "SPLIT_REDUCTION"} dimension(0) ins(%[[VAL_22]], %[[VAL_24]] : tensor<9xf32>, tensor<9xi32>) outs(%[[VAL_1]], %[[VAL_2]] : tensor<3xf32>, tensor<3xi32>) {
// SINGLE:           ^bb0(%[[VAL_27:.*]]: f32, %[[VAL_28:.*]]: f32):
// SINGLE:             %[[VAL_29:.*]] = arith.cmpf ogt, %[[VAL_27]], %[[VAL_28]] : f32
// SINGLE:             iree_linalg_ext.yield %[[VAL_29]] : i1
// SINGLE:           } -> tensor<3xf32>, tensor<3xi32>
// SINGLE:           return %[[VAL_30:.*]]#0, %[[VAL_30]]#1 : tensor<3xf32>, tensor<3xi32>
// SINGLE:         }
