...
func.func @pad_pack(%src: tensor<16641x16xf32>) -> tensor<2082x1x8x32xf32> {
  ...
  %pack = iree_linalg_ext.pack %padded padding_value(%cst : f32) inner_dims_pos = [0, 1] inner_tiles = [8, 32] into %empty : (tensor<16656x16xf32> tensor<2082x1x8x32xf32>) -> tensor<2082x1x8x32xf32>
...
// CHECK:         %[[PACK:.+]] = iree_linalg_ext.pack %[[SRC]]
...
func.func @pad_pack_different_padding_value(%src: tensor<16641x16xf32>) -> tensor<2082x1x8x32xf32> {
  ...
  %empty = tensor.empty() : tensor<2082x1x8x32xf32>
  %pack = iree_linalg_ext.pack %padded padding_value(%cst1 : f32) inner_dims_pos = [0, 1] inner_tiles = [8, 32] into %empty : (tensor<16656x16xf32> tensor<2082x1x8x32xf32>) -> tensor<2082x1x8x32xf32>
  return %pack : tensor<2082x1x8x32xf32>
}
