...
^bb0(%arg0: !pdl.operation):
  ...
  transform.structured.interchange %0 iterator_interchange = [1, 1] : (!pdl.operation) -> !pdl.operation
}
...
^bb0(%arg0: !pdl.operation):
  ...
  transform.structured.fuse %0 {tile_sizes=[0, 1], tile_interchange = [1, 1]} : (!pdl.operation) -> !pdl.operation
}
