...
#ifndef THIRD_PARTY_MLIR_EDGE_IREE_VM_STACK_FRAME_H_
#define THIRD_PARTY_MLIR_EDGE_IREE_VM_STACK_FRAME_H_
...
#endif  // THIRD_PARTY_MLIR_EDGE_IREE_VM_STACK_FRAME_H_
